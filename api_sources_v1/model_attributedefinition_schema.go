...
// checks if the AttributedefinitionSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttributedefinitionSchema{}
...
func (o *AttributedefinitionSchema) UnmarshalJSON(data []byte) (err error) {
	varAttributedefinitionSchema := _AttributedefinitionSchema{}

	err = json.Unmarshal(data, &varAttributedefinitionSchema)
