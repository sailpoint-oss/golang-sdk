...
slug: /tools/sdk/go/sourcesv1/methods/sources
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_sources_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_sources_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.SourcesV1.SourcesAPI.CreateProvisioningPolicyV1(context.Background(), sourceId).Provisioningpolicydto(provisioningpolicydto).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.CreateProvisioningPolicyV1(context.Background(), sourceId).Provisioningpolicydto(provisioningpolicydto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.CreateSourceScheduleV1(context.Background(), sourceId).Schedule3(schedule3).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.CreateSourceScheduleV1(context.Background(), sourceId).Schedule3(schedule3).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.CreateSourceSchemaV1(context.Background(), sourceId).Schema(schema).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.CreateSourceSchemaV1(context.Background(), sourceId).Schema(schema).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.CreateSourceV1(context.Background()).Source(source).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.CreateSourceV1(context.Background()).Source(source).ProvisionAsCsv(provisionAsCsv).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.DeleteAccountsAsyncV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.DeleteAccountsAsyncV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.SourcesV1.SourcesAPI.DeleteNativeChangeDetectionConfigV1(context.Background(), sourceId).Execute()
	  //r, err := apiClient.SourcesV1.SourcesAPI.DeleteNativeChangeDetectionConfigV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.SourcesV1.SourcesAPI.DeleteProvisioningPolicyV1(context.Background(), sourceId, usageType).Execute()
	  //r, err := apiClient.SourcesV1.SourcesAPI.DeleteProvisioningPolicyV1(context.Background(), sourceId, usageType).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.SourcesV1.SourcesAPI.DeleteSourceScheduleV1(context.Background(), sourceId, scheduleType).Execute()
	  //r, err := apiClient.SourcesV1.SourcesAPI.DeleteSourceScheduleV1(context.Background(), sourceId, scheduleType).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.SourcesV1.SourcesAPI.DeleteSourceSchemaV1(context.Background(), sourceId, schemaId).Execute()
	  //r, err := apiClient.SourcesV1.SourcesAPI.DeleteSourceSchemaV1(context.Background(), sourceId, schemaId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.DeleteSourceV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.DeleteSourceV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetAccountDeleteApprovalConfigV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetAccountDeleteApprovalConfigV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.SourcesV1.SourcesAPI.GetAccountsSchemaV1(context.Background(), id).Execute()
	  //r, err := apiClient.SourcesV1.SourcesAPI.GetAccountsSchemaV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetCorrelationConfigV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetCorrelationConfigV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.SourcesV1.SourcesAPI.GetEntitlementsSchemaV1(context.Background(), id).Execute()
	  //r, err := apiClient.SourcesV1.SourcesAPI.GetEntitlementsSchemaV1(context.Background(), id).SchemaName(schemaName).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetMachineAccountDeletionApprovalConfigBySourceV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetMachineAccountDeletionApprovalConfigBySourceV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetNativeChangeDetectionConfigV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetNativeChangeDetectionConfigV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetProvisioningPolicyV1(context.Background(), sourceId, usageType).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetProvisioningPolicyV1(context.Background(), sourceId, usageType).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceAttrSyncConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceAttrSyncConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceConfigV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceConfigV1(context.Background(), id).Locale(locale).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceConnectionsV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceConnectionsV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceEntitlementRequestConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceEntitlementRequestConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceHealthV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceHealthV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceScheduleV1(context.Background(), sourceId, scheduleType).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceScheduleV1(context.Background(), sourceId, scheduleType).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceSchedulesV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceSchedulesV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceSchemaV1(context.Background(), sourceId, schemaId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceSchemaV1(context.Background(), sourceId, schemaId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceSchemasV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceSchemasV1(context.Background(), sourceId).IncludeTypes(includeTypes).IncludeNames(includeNames).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.GetSourceV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportAccountsSchemaV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportAccountsSchemaV1(context.Background(), id).File(file).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportAccountsV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportAccountsV1(context.Background(), id).File(file).DisableOptimization(disableOptimization).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportConnectorFileV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportConnectorFileV1(context.Background(), sourceId).File(file).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportEntitlementsSchemaV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportEntitlementsSchemaV1(context.Background(), id).SchemaName(schemaName).File(file).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportEntitlementsV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportEntitlementsV1(context.Background(), sourceId).File(file).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportUncorrelatedAccountsV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.ImportUncorrelatedAccountsV1(context.Background(), id).File(file).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.ListPasswordPolicyHoldersOnSourceV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.ListPasswordPolicyHoldersOnSourceV1(context.Background(), sourceId).Offset(offset).Limit(limit).Count(count).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.ListProvisioningPoliciesV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.ListProvisioningPoliciesV1(context.Background(), sourceId).Offset(offset).Limit(limit).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.ListSourcesV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.ListSourcesV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).ForSubadmin(forSubadmin).IncludeIDNSource(includeIDNSource).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.PingClusterV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.PingClusterV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.PutCorrelationConfigV1(context.Background(), id).Correlationconfig(correlationconfig).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.PutCorrelationConfigV1(context.Background(), id).Correlationconfig(correlationconfig).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.PutNativeChangeDetectionConfigV1(context.Background(), sourceId).Nativechangedetectionconfig(nativechangedetectionconfig).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.PutNativeChangeDetectionConfigV1(context.Background(), sourceId).Nativechangedetectionconfig(nativechangedetectionconfig).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.PutProvisioningPolicyV1(context.Background(), sourceId, usageType).Provisioningpolicydto(provisioningpolicydto).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.PutProvisioningPolicyV1(context.Background(), sourceId, usageType).Provisioningpolicydto(provisioningpolicydto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.PutSourceAttrSyncConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Attrsyncsourceconfig(attrsyncsourceconfig).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.PutSourceAttrSyncConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Attrsyncsourceconfig(attrsyncsourceconfig).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.PutSourceSchemaV1(context.Background(), sourceId, schemaId).Schema(schema).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.PutSourceSchemaV1(context.Background(), sourceId, schemaId).Schema(schema).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.PutSourceV1(context.Background(), id).Source(source).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.PutSourceV1(context.Background(), id).Source(source).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.SearchResourceObjectsV1(context.Background(), sourceId).Resourceobjectsrequest(resourceobjectsrequest).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.SearchResourceObjectsV1(context.Background(), sourceId).Resourceobjectsrequest(resourceobjectsrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.SyncAttributesForSourceV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.SyncAttributesForSourceV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.TestSourceConfigurationV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.TestSourceConfigurationV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.TestSourceConnectionV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.TestSourceConnectionV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateAccountDeletionApprovalConfigV1(context.Background(), sourceId).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateAccountDeletionApprovalConfigV1(context.Background(), sourceId).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateMachineAccountDeletionApprovalConfigV1(context.Background(), sourceId).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateMachineAccountDeletionApprovalConfigV1(context.Background(), sourceId).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdatePasswordPolicyHoldersV1(context.Background(), sourceId).PasswordpolicyholdersdtoInner(passwordpolicyholdersdtoInner).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdatePasswordPolicyHoldersV1(context.Background(), sourceId).PasswordpolicyholdersdtoInner(passwordpolicyholdersdtoInner).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateProvisioningPoliciesInBulkV1(context.Background(), sourceId).Provisioningpolicydto(provisioningpolicydto).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateProvisioningPoliciesInBulkV1(context.Background(), sourceId).Provisioningpolicydto(provisioningpolicydto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateProvisioningPolicyV1(context.Background(), sourceId, usageType).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateProvisioningPolicyV1(context.Background(), sourceId, usageType).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateSourceEntitlementRequestConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Sourceentitlementrequestconfig(sourceentitlementrequestconfig).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateSourceEntitlementRequestConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Sourceentitlementrequestconfig(sourceentitlementrequestconfig).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateSourceScheduleV1(context.Background(), sourceId, scheduleType).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateSourceScheduleV1(context.Background(), sourceId, scheduleType).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateSourceSchemaV1(context.Background(), sourceId, schemaId).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateSourceSchemaV1(context.Background(), sourceId, schemaId).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateSourceV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.SourcesV1.SourcesAPI.UpdateSourceV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
