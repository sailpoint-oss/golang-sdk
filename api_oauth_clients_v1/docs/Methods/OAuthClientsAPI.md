...
slug: /tools/sdk/go/oauthclientsv1/methods/o-auth-clients
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_oauth_clients_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_oauth_clients_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.OauthClientsV1.OAuthClientsAPI.CreateOauthClientV1(context.Background()).Createoauthclientrequest(createoauthclientrequest).Execute()
	  //resp, r, err := apiClient.OauthClientsV1.OAuthClientsAPI.CreateOauthClientV1(context.Background()).Createoauthclientrequest(createoauthclientrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.OauthClientsV1.OAuthClientsAPI.DeleteOauthClientV1(context.Background(), id).Execute()
	  //r, err := apiClient.OauthClientsV1.OAuthClientsAPI.DeleteOauthClientV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.OauthClientsV1.OAuthClientsAPI.GetOauthClientV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.OauthClientsV1.OAuthClientsAPI.GetOauthClientV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.OauthClientsV1.OAuthClientsAPI.ListOauthClientsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.OauthClientsV1.OAuthClientsAPI.ListOauthClientsV1(context.Background()).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.OauthClientsV1.OAuthClientsAPI.PatchOauthClientV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.OauthClientsV1.OAuthClientsAPI.PatchOauthClientV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
