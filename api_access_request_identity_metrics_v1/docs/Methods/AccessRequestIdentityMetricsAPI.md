...
slug: /tools/sdk/go/accessrequestidentitymetricsv1/methods/access-request-identity-metrics
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_access_request_identity_metrics_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.AccessRequestIdentityMetricsV1.AccessRequestIdentityMetricsAPI.GetAccessRequestIdentityMetricsV1(context.Background(), identityId, requestedObjectId, type_).Execute()
	  //resp, r, err := apiClient.AccessRequestIdentityMetricsV1.AccessRequestIdentityMetricsAPI.GetAccessRequestIdentityMetricsV1(context.Background(), identityId, requestedObjectId, type_).Execute()
    if err != nil {
