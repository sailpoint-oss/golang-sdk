...
keywords: ['go', 'Golang', 'sdk', 'IAIPeerGroupStrategies', 'V1IAIPeerGroupStrategies'] 
slug: /tools/sdk/go/iaipeergroupstrategiesv1/methods/iai-peer-group-strategies
...
Other parameters are passed through a pointer to a apiGetPeerGroupOutliersV1Request struct via the builder pattern
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_iai_peer_group_strategies_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.IaiPeerGroupStrategiesV1.IAIPeerGroupStrategiesAPI.GetPeerGroupOutliersV1(context.Background(), strategy).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.IaiPeerGroupStrategiesV1.IAIPeerGroupStrategiesAPI.GetPeerGroupOutliersV1(context.Background(), strategy).XSailPointExperimental(xSailPointExperimental).Limit(limit).Offset(offset).Count(count).Execute()
    if err != nil {
