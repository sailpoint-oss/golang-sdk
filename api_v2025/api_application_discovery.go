...
type ApiStartApplicationDiscoveryRequest struct {
	ctx context.Context
	ApiService *ApplicationDiscoveryAPIService
...
func (r ApiStartApplicationDiscoveryRequest) XSailPointExperimental(xSailPointExperimental string) ApiStartApplicationDiscoveryRequest {
	r.xSailPointExperimental = &xSailPointExperimental
	return r
}

func (r ApiStartApplicationDiscoveryRequest) ApplicationDiscoveryRequest(applicationDiscoveryRequest ApplicationDiscoveryRequest) ApiStartApplicationDiscoveryRequest {
	r.applicationDiscoveryRequest = &applicationDiscoveryRequest
	return r
}

func (r ApiStartApplicationDiscoveryRequest) Execute() (*ApplicationDiscoveryResponse, *http.Response, error) {
	return r.ApiService.StartApplicationDiscoveryExecute(r)
}

/*
StartApplicationDiscovery Start Application Discovery

Use this API to discover applications.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiStartApplicationDiscoveryRequest
*/
func (a *ApplicationDiscoveryAPIService) StartApplicationDiscovery(ctx context.Context) ApiStartApplicationDiscoveryRequest {
	return ApiStartApplicationDiscoveryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ApplicationDiscoveryAPIService) StartApplicationDiscoveryExecute(r ApiStartApplicationDiscoveryRequest) (*ApplicationDiscoveryResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationDiscoveryAPIService.StartApplicationDiscovery")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/sources/{sourceId}/discover-applications"
