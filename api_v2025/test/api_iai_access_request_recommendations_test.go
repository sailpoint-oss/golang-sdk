...
func Test_api_v2025_IAIAccessRequestRecommendationsAPIService(t *testing.T) {
	...
	t.Run("Test IAIAccessRequestRecommendationsAPIService GetAccessRequestRecommendationsConfig", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.IAIAccessRequestRecommendationsAPI.GetAccessRequestRecommendationsConfig(context.Background()).Execute()
	...
	t.Run("Test IAIAccessRequestRecommendationsAPIService SetAccessRequestRecommendationsConfig", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.IAIAccessRequestRecommendationsAPI.SetAccessRequestRecommendationsConfig(context.Background()).Execute()
