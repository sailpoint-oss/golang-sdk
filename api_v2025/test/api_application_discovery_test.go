...
func Test_api_v2025_ApplicationDiscoveryAPIService(t *testing.T) {
	...
	t.Run("Test ApplicationDiscoveryAPIService StartApplicationDiscovery", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.ApplicationDiscoveryAPI.StartApplicationDiscovery(context.Background()).Execute()
