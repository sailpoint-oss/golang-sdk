...
```go
auth := context.WithValue(context.Background(), api_v2025.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, api_v2025.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
