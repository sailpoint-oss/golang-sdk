...
func (r ApiDeleteIdentityRequest) XSailPointExperimental(xSailPointExperimental string) ApiDeleteIdentityRequest {
...
type ApiListEntitlementsByIdentityRequest struct {
	ctx context.Context
	ApiService *IdentitiesAPIService
	id string
	limit *int32
...
func (r ApiListEntitlementsByIdentityRequest) Limit(limit int32) ApiListEntitlementsByIdentityRequest {
	r.limit = &limit
	return r
}

// Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
func (r ApiListEntitlementsByIdentityRequest) Offset(offset int32) ApiListEntitlementsByIdentityRequest {
	r.offset = &offset
	return r
}

// If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count&#x3D;true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
func (r ApiListEntitlementsByIdentityRequest) Count(count bool) ApiListEntitlementsByIdentityRequest {
	r.count = &count
	return r
}

func (r ApiListEntitlementsByIdentityRequest) Execute() ([]IdentityEntitlements, *http.Response, error) {
	return r.ApiService.ListEntitlementsByIdentityExecute(r)
}

/*
ListEntitlementsByIdentity List of entitlements by identity.
...
The API returns a list of all entitlements assigned to an identity, either directly or through the role or access profile. A token with ORG_ADMIN or API authority is required to call this API.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id Identity Id
 @return ApiListEntitlementsByIdentityRequest
*/
func (a *IdentitiesAPIService) ListEntitlementsByIdentity(ctx context.Context, id string) ApiListEntitlementsByIdentityRequest {
	return ApiListEntitlementsByIdentityRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *IdentitiesAPIService) ListEntitlementsByIdentityExecute(r ApiListEntitlementsByIdentityRequest) ([]IdentityEntitlements, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IdentitiesAPIService.ListEntitlementsByIdentity")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/entitlements/identities/{id}/entitlements"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
// Use this header to enable this experimental API.
func (r ApiSendIdentityVerificationAccountTokenRequest) XSailPointExperimental(xSailPointExperimental string) ApiSendIdentityVerificationAccountTokenRequest {
	r.xSailPointExperimental = &xSailPointExperimental
	return r
}

func (r ApiSendIdentityVerificationAccountTokenRequest) SendAccountVerificationRequest(sendAccountVerificationRequest SendAccountVerificationRequest) ApiSendIdentityVerificationAccountTokenRequest {
	r.sendAccountVerificationRequest = &sendAccountVerificationRequest
	return r
}

func (r ApiSendIdentityVerificationAccountTokenRequest) Execute() (*http.Response, error) {
	return r.ApiService.SendIdentityVerificationAccountTokenExecute(r)
}

/*
SendIdentityVerificationAccountToken Send password reset email
...
// Execute executes the request
func (a *IdentitiesAPIService) SendIdentityVerificationAccountTokenExecute(r ApiSendIdentityVerificationAccountTokenRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IdentitiesAPIService.SendIdentityVerificationAccountToken")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiStartIdentitiesInviteRequest) Execute() (*TaskStatus, *http.Response, error) {
	return r.ApiService.StartIdentitiesInviteExecute(r)
}

/*
StartIdentitiesInvite Invite identities to register
...
The executed task status can be checked by Task Management > [Get task status by ID](https://developer.sailpoint.com/docs/api/beta/get-task-status).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiStartIdentitiesInviteRequest
*/
func (a *IdentitiesAPIService) StartIdentitiesInvite(ctx context.Context) ApiStartIdentitiesInviteRequest {
	return ApiStartIdentitiesInviteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return TaskStatus
func (a *IdentitiesAPIService) StartIdentitiesInviteExecute(r ApiStartIdentitiesInviteRequest) (*TaskStatus, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IdentitiesAPIService.StartIdentitiesInvite")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/identities/invite"
...
// Use this header to enable this experimental API.
func (r ApiStartIdentityProcessingRequest) XSailPointExperimental(xSailPointExperimental string) ApiStartIdentityProcessingRequest {
	r.xSailPointExperimental = &xSailPointExperimental
	return r
}
...
// Use this header to enable this experimental API.
func (r ApiSynchronizeAttributesForIdentityRequest) XSailPointExperimental(xSailPointExperimental string) ApiSynchronizeAttributesForIdentityRequest {
	r.xSailPointExperimental = &xSailPointExperimental
	return r
}
