...
// checks if the BackupOptions1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupOptions1{}

// BackupOptions1 Backup options control what will be included in the backup.
type BackupOptions1 struct {
...
type _BackupOptions1 BackupOptions1
...
func (o BackupOptions1) MarshalJSON() ([]byte, error) {
...
func (o BackupOptions1) ToMap() (map[string]interface{}, error) {
...
func (o *BackupOptions1) UnmarshalJSON(data []byte) (err error) {
	varBackupOptions1 := _BackupOptions1{}

	err = json.Unmarshal(data, &varBackupOptions1)

	if err != nil {
		return err
	}

	*o = BackupOptions1(varBackupOptions1)
...
type NullableBackupOptions1 struct {
	value *BackupOptions1
	isSet bool
}

func (v NullableBackupOptions1) Get() *BackupOptions1 {
	return v.value
}

func (v *NullableBackupOptions1) Set(val *BackupOptions1) {
	v.value = val
	v.isSet = true
}

func (v NullableBackupOptions1) IsSet() bool {
	return v.isSet
}

func (v *NullableBackupOptions1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBackupOptions1(val *BackupOptions1) *NullableBackupOptions1 {
	return &NullableBackupOptions1{value: val, isSet: true}
}

func (v NullableBackupOptions1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBackupOptions1) UnmarshalJSON(src []byte) error {
	v.isSet = true
