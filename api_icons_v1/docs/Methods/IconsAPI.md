...
slug: /tools/sdk/go/iconsv1/methods/icons
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_icons_v1"
)
...
func main() {
    ...
    r, err := apiClient.IconsV1.IconsAPI.DeleteIconV1(context.Background(), objectType, objectId).XSailPointExperimental(xSailPointExperimental).Execute()
	  //r, err := apiClient.IconsV1.IconsAPI.DeleteIconV1(context.Background(), objectType, objectId).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IconsV1.IconsAPI.SetIconV1(context.Background(), objectType, objectId).XSailPointExperimental(xSailPointExperimental).Image(image).Execute()
	  //resp, r, err := apiClient.IconsV1.IconsAPI.SetIconV1(context.Background(), objectType, objectId).XSailPointExperimental(xSailPointExperimental).Image(image).Execute()
    if err != nil {
