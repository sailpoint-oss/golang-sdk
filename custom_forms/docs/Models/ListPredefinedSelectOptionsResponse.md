---
id: v1-list-predefined-select-options-response
...
keywords: ['go', 'Golang', 'sdk', 'ListPredefinedSelectOptionsResponse', 'V1ListPredefinedSelectOptionsResponse'] 
slug: /tools/sdk/go/customforms/models/list-predefined-select-options-response
