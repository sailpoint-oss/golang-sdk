...
// checks if the AccessRequestDynamicApproverRequestedItemsInnerForm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessRequestDynamicApproverRequestedItemsInnerForm{}

// AccessRequestDynamicApproverRequestedItemsInnerForm struct for AccessRequestDynamicApproverRequestedItemsInnerForm
type AccessRequestDynamicApproverRequestedItemsInnerForm struct {
...
type _AccessRequestDynamicApproverRequestedItemsInnerForm AccessRequestDynamicApproverRequestedItemsInnerForm
...
func NewAccessRequestDynamicApproverRequestedItemsInnerForm() *AccessRequestDynamicApproverRequestedItemsInnerForm {
	this := AccessRequestDynamicApproverRequestedItemsInnerForm{}
	return &this
}
...
func (o *AccessRequestDynamicApproverRequestedItemsInnerForm) SetFormDefinitionIdNil() {
...
func (o *AccessRequestDynamicApproverRequestedItemsInnerForm) SetFormInstanceIdNil() {
...
func (o AccessRequestDynamicApproverRequestedItemsInnerForm) MarshalJSON() ([]byte, error) {
...
func (o AccessRequestDynamicApproverRequestedItemsInnerForm) ToMap() (map[string]interface{}, error) {
...
func (o *AccessRequestDynamicApproverRequestedItemsInnerForm) UnmarshalJSON(data []byte) (err error) {
	varAccessRequestDynamicApproverRequestedItemsInnerForm := _AccessRequestDynamicApproverRequestedItemsInnerForm{}

	err = json.Unmarshal(data, &varAccessRequestDynamicApproverRequestedItemsInnerForm)

	if err != nil {
		return err
	}

	*o = AccessRequestDynamicApproverRequestedItemsInnerForm(varAccessRequestDynamicApproverRequestedItemsInnerForm)
...
type NullableAccessRequestDynamicApproverRequestedItemsInnerForm struct {
	value *AccessRequestDynamicApproverRequestedItemsInnerForm
	isSet bool
}

func (v NullableAccessRequestDynamicApproverRequestedItemsInnerForm) Get() *AccessRequestDynamicApproverRequestedItemsInnerForm {
	return v.value
}

func (v *NullableAccessRequestDynamicApproverRequestedItemsInnerForm) Set(val *AccessRequestDynamicApproverRequestedItemsInnerForm) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessRequestDynamicApproverRequestedItemsInnerForm) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessRequestDynamicApproverRequestedItemsInnerForm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessRequestDynamicApproverRequestedItemsInnerForm(val *AccessRequestDynamicApproverRequestedItemsInnerForm) *NullableAccessRequestDynamicApproverRequestedItemsInnerForm {
	return &NullableAccessRequestDynamicApproverRequestedItemsInnerForm{value: val, isSet: true}
}

func (v NullableAccessRequestDynamicApproverRequestedItemsInnerForm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessRequestDynamicApproverRequestedItemsInnerForm) UnmarshalJSON(src []byte) error {
	v.isSet = true
