---
id: v1-va-cluster-status-change-event-previous-health-check-result
...
slug: /tools/sdk/go/triggers/models/va-cluster-status-change-event-previous-health-check-result
