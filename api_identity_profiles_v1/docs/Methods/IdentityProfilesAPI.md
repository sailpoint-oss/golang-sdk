...
slug: /tools/sdk/go/identityprofilesv1/methods/identity-profiles
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_identity_profiles_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_identity_profiles_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.CreateIdentityProfileV1(context.Background()).Identityprofile(identityprofile).Execute()
	  //resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.CreateIdentityProfileV1(context.Background()).Identityprofile(identityprofile).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.DeleteIdentityProfileV1(context.Background(), identityProfileId).Execute()
	  //resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.DeleteIdentityProfileV1(context.Background(), identityProfileId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.DeleteIdentityProfilesV1(context.Background()).RequestBody(requestBody).Execute()
	  //resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.DeleteIdentityProfilesV1(context.Background()).RequestBody(requestBody).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.ExportIdentityProfilesV1(context.Background()).Execute()
	  //resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.ExportIdentityProfilesV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.GenerateIdentityPreviewV1(context.Background()).Identitypreviewrequest(identitypreviewrequest).Execute()
	  //resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.GenerateIdentityPreviewV1(context.Background()).Identitypreviewrequest(identitypreviewrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.GetDefaultIdentityAttributeConfigV1(context.Background(), identityProfileId).Execute()
	  //resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.GetDefaultIdentityAttributeConfigV1(context.Background(), identityProfileId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.GetIdentityProfileV1(context.Background(), identityProfileId).Execute()
	  //resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.GetIdentityProfileV1(context.Background(), identityProfileId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.ImportIdentityProfilesV1(context.Background()).Identityprofileexportedobject(identityprofileexportedobject).Execute()
	  //resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.ImportIdentityProfilesV1(context.Background()).Identityprofileexportedobject(identityprofileexportedobject).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.ListIdentityProfilesV1(context.Background()).Execute()
	  //resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.ListIdentityProfilesV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.SyncIdentityProfileV1(context.Background(), identityProfileId).Execute()
	  //resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.SyncIdentityProfileV1(context.Background(), identityProfileId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.UpdateIdentityProfileV1(context.Background(), identityProfileId).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.IdentityProfilesV1.IdentityProfilesAPI.UpdateIdentityProfileV1(context.Background(), identityProfileId).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
