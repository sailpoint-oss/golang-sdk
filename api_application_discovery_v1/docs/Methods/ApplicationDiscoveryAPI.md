...
slug: /tools/sdk/go/applicationdiscoveryv1/methods/application-discovery
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_application_discovery_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.ApplicationDiscoveryV1.ApplicationDiscoveryAPI.GetDiscoveredApplicationsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ApplicationDiscoveryV1.ApplicationDiscoveryAPI.GetDiscoveredApplicationsV1(context.Background()).Limit(limit).Offset(offset).Detail(detail).Filter(filter).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ApplicationDiscoveryV1.ApplicationDiscoveryAPI.GetManualDiscoverApplicationsCsvTemplateV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ApplicationDiscoveryV1.ApplicationDiscoveryAPI.GetManualDiscoverApplicationsCsvTemplateV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ApplicationDiscoveryV1.ApplicationDiscoveryAPI.SendManualDiscoverApplicationsCsvTemplateV1(context.Background()).File(file).Execute()
	  //r, err := apiClient.ApplicationDiscoveryV1.ApplicationDiscoveryAPI.SendManualDiscoverApplicationsCsvTemplateV1(context.Background()).File(file).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_application_discovery_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_application_discovery_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ApplicationDiscoveryV1.ApplicationDiscoveryAPI.StartApplicationDiscoveryV1(context.Background(), sourceId).XSailPointExperimental(xSailPointExperimental).Applicationdiscoveryrequest(applicationdiscoveryrequest).Execute()
	  //resp, r, err := apiClient.ApplicationDiscoveryV1.ApplicationDiscoveryAPI.StartApplicationDiscoveryV1(context.Background(), sourceId).XSailPointExperimental(xSailPointExperimental).Applicationdiscoveryrequest(applicationdiscoveryrequest).Execute()
    if err != nil {
