...
// checks if the Applicationdiscoveryresponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Applicationdiscoveryresponse{}

// Applicationdiscoveryresponse struct for Applicationdiscoveryresponse
type Applicationdiscoveryresponse struct {
	...
	Target *ApplicationdiscoveryresponseTarget `json:"target,omitempty"`
...
type _Applicationdiscoveryresponse Applicationdiscoveryresponse
...
func NewApplicationdiscoveryresponse() *Applicationdiscoveryresponse {
	this := Applicationdiscoveryresponse{}
	return &this
}
...
func (o *Applicationdiscoveryresponse) SetParentNameNil() {
...
func (o *Applicationdiscoveryresponse) GetTarget() ApplicationdiscoveryresponseTarget {
	if o == nil || IsNil(o.Target) {
		var ret ApplicationdiscoveryresponseTarget
		return ret
	}
	return *o.Target
}
...
// SetTarget gets a reference to the given ApplicationdiscoveryresponseTarget and assigns it to the Target field.
...
func (o *Applicationdiscoveryresponse) SetLaunchedNil() {
	o.Launched.Set(nil)
}
...
func (o *Applicationdiscoveryresponse) SetCompletedNil() {
	o.Completed.Set(nil)
}
...
func (o *Applicationdiscoveryresponse) SetCompletionStatusNil() {
...
func (o *Applicationdiscoveryresponse) SetProgressNil() {
	o.Progress.Set(nil)
}
...
func (o Applicationdiscoveryresponse) MarshalJSON() ([]byte, error) {
...
func (o Applicationdiscoveryresponse) ToMap() (map[string]interface{}, error) {
...
func (o *Applicationdiscoveryresponse) UnmarshalJSON(data []byte) (err error) {
	varApplicationdiscoveryresponse := _Applicationdiscoveryresponse{}

	err = json.Unmarshal(data, &varApplicationdiscoveryresponse)

	if err != nil {
		return err
	}

	*o = Applicationdiscoveryresponse(varApplicationdiscoveryresponse)
...
type NullableApplicationdiscoveryresponse struct {
	value *Applicationdiscoveryresponse
	isSet bool
}

func (v NullableApplicationdiscoveryresponse) Get() *Applicationdiscoveryresponse {
	return v.value
}

func (v *NullableApplicationdiscoveryresponse) Set(val *Applicationdiscoveryresponse) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationdiscoveryresponse) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationdiscoveryresponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationdiscoveryresponse(val *Applicationdiscoveryresponse) *NullableApplicationdiscoveryresponse {
	return &NullableApplicationdiscoveryresponse{value: val, isSet: true}
}

func (v NullableApplicationdiscoveryresponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationdiscoveryresponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
