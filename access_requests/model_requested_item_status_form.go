...
// checks if the RequestedItemStatusForm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestedItemStatusForm{}

// RequestedItemStatusForm struct for RequestedItemStatusForm
type RequestedItemStatusForm struct {
...
type _RequestedItemStatusForm RequestedItemStatusForm
...
func (o *RequestedItemStatusForm) SetFormDefinitionIdNil() {
...
func (o *RequestedItemStatusForm) SetFormInstanceIdNil() {
...
func (o RequestedItemStatusForm) MarshalJSON() ([]byte, error) {
...
func (o RequestedItemStatusForm) ToMap() (map[string]interface{}, error) {
...
func (o *RequestedItemStatusForm) UnmarshalJSON(data []byte) (err error) {
	varRequestedItemStatusForm := _RequestedItemStatusForm{}

	err = json.Unmarshal(data, &varRequestedItemStatusForm)

	if err != nil {
		return err
	}

	*o = RequestedItemStatusForm(varRequestedItemStatusForm)
...
type NullableRequestedItemStatusForm struct {
	value *RequestedItemStatusForm
	isSet bool
}

func (v NullableRequestedItemStatusForm) Get() *RequestedItemStatusForm {
	return v.value
}

func (v *NullableRequestedItemStatusForm) Set(val *RequestedItemStatusForm) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestedItemStatusForm) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestedItemStatusForm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestedItemStatusForm(val *RequestedItemStatusForm) *NullableRequestedItemStatusForm {
	return &NullableRequestedItemStatusForm{value: val, isSet: true}
}

func (v NullableRequestedItemStatusForm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestedItemStatusForm) UnmarshalJSON(src []byte) error {
	v.isSet = true
