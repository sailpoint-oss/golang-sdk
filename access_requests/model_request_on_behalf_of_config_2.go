...
// checks if the RequestOnBehalfOfConfig2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestOnBehalfOfConfig2{}

// RequestOnBehalfOfConfig2 struct for RequestOnBehalfOfConfig2
type RequestOnBehalfOfConfig2 struct {
...
type _RequestOnBehalfOfConfig2 RequestOnBehalfOfConfig2
...
func (o RequestOnBehalfOfConfig2) ToMap() (map[string]interface{}, error) {
...
func (o *RequestOnBehalfOfConfig2) UnmarshalJSON(data []byte) (err error) {
	varRequestOnBehalfOfConfig2 := _RequestOnBehalfOfConfig2{}

	err = json.Unmarshal(data, &varRequestOnBehalfOfConfig2)

	if err != nil {
		return err
	}

	*o = RequestOnBehalfOfConfig2(varRequestOnBehalfOfConfig2)
...
type NullableRequestOnBehalfOfConfig2 struct {
	value *RequestOnBehalfOfConfig2
	isSet bool
}

func (v NullableRequestOnBehalfOfConfig2) Get() *RequestOnBehalfOfConfig2 {
	return v.value
}

func (v *NullableRequestOnBehalfOfConfig2) Set(val *RequestOnBehalfOfConfig2) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestOnBehalfOfConfig2) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestOnBehalfOfConfig2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestOnBehalfOfConfig2(val *RequestOnBehalfOfConfig2) *NullableRequestOnBehalfOfConfig2 {
	return &NullableRequestOnBehalfOfConfig2{value: val, isSet: true}
}

func (v NullableRequestOnBehalfOfConfig2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestOnBehalfOfConfig2) UnmarshalJSON(src []byte) error {
	v.isSet = true
