...
slug: /tools/sdk/go/accessrequests/models/entitlement-approval-scheme
...
**ApproverId** | Pointer to **NullableString** | Id of the specific approver, used only when approverType is GOVERNANCE_GROUP or WORKFLOW. For WORKFLOW this is the ID of the workflow to run. | [optional] 
