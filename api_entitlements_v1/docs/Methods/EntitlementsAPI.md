...
slug: /tools/sdk/go/entitlementsv1/methods/entitlements
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_entitlements_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.CreateAccessModelMetadataForEntitlementV1(context.Background(), id, attributeKey, attributeValue).Execute()
	  //resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.CreateAccessModelMetadataForEntitlementV1(context.Background(), id, attributeKey, attributeValue).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.EntitlementsV1.EntitlementsAPI.DeleteAccessModelMetadataFromEntitlementV1(context.Background(), id, attributeKey, attributeValue).Execute()
	  //r, err := apiClient.EntitlementsV1.EntitlementsAPI.DeleteAccessModelMetadataFromEntitlementV1(context.Background(), id, attributeKey, attributeValue).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.GetEntitlementRequestConfigV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.GetEntitlementRequestConfigV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.GetEntitlementV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.GetEntitlementV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ImportEntitlementsBySourceV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ImportEntitlementsBySourceV1(context.Background(), id).CsvFile(csvFile).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ListEntitlementChildrenV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ListEntitlementChildrenV1(context.Background(), id).Limit(limit).Offset(offset).Count(count).SearchAfter(searchAfter).Sorters(sorters).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ListEntitlementParentsV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ListEntitlementParentsV1(context.Background(), id).Limit(limit).Offset(offset).Count(count).SearchAfter(searchAfter).Sorters(sorters).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ListEntitlementsByAccountV1(context.Background(), accountId).Execute()
	  //resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ListEntitlementsByAccountV1(context.Background(), accountId).Limit(limit).Offset(offset).Count(count).SearchAfter(searchAfter).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ListEntitlementsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ListEntitlementsV1(context.Background()).SegmentedForIdentity(segmentedForIdentity).ForSegmentIds(forSegmentIds).IncludeUnsegmented(includeUnsegmented).Offset(offset).Limit(limit).Count(count).SearchAfter(searchAfter).Sorters(sorters).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.PatchEntitlementV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.PatchEntitlementV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_entitlements_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_entitlements_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.PutEntitlementRequestConfigV1(context.Background(), id).Entitlementrequestconfig(entitlementrequestconfig).Execute()
	  //resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.PutEntitlementRequestConfigV1(context.Background(), id).Entitlementrequestconfig(entitlementrequestconfig).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ResetSourceEntitlementsV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.EntitlementsV1.EntitlementsAPI.ResetSourceEntitlementsV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.EntitlementsV1.EntitlementsAPI.UpdateEntitlementsInBulkV1(context.Background()).Entitlementbulkupdaterequest(entitlementbulkupdaterequest).Execute()
	  //r, err := apiClient.EntitlementsV1.EntitlementsAPI.UpdateEntitlementsInBulkV1(context.Background()).Entitlementbulkupdaterequest(entitlementbulkupdaterequest).Execute()
    if err != nil {
