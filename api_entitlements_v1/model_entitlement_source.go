...
type _EntitlementSource EntitlementSource
...
func (v NullableEntitlementSource) Get() *EntitlementSource {
	return v.value
}

func (v *NullableEntitlementSource) Set(val *EntitlementSource) {
	v.value = val
	v.isSet = true
}
...
func NewNullableEntitlementSource(val *EntitlementSource) *NullableEntitlementSource {
	return &NullableEntitlementSource{value: val, isSet: true}
}
