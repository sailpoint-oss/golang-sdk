---
id: v1-machine-account-create-access-dto-subtypes-inner
...
keywords: ['go', 'Golang', 'sdk', 'MachineAccountCreateAccessDtoSubtypesInner', 'V1MachineAccountCreateAccessDtoSubtypesInner'] 
slug: /tools/sdk/go/machineaccountcreationrequest/models/machine-account-create-access-dto-subtypes-inner
tags: ['SDK', 'Software Development Kit', 'MachineAccountCreateAccessDtoSubtypesInner', 'V1MachineAccountCreateAccessDtoSubtypesInner']
---
...
------------ | ------------- | ------------- | -------------
**SubtypeId** | Pointer to **string** | Subtype ID. | [optional] 
**EntitlementId** | Pointer to **string** | Entitlement ID. | [optional] 
**SubtypeDisplayName** | Pointer to **string** | Subtype display name. | [optional] 
**SubtypeTechnicalName** | Pointer to **string** | Subtype technical name. | [optional] 
...
GetSubtypeDisplayNameOk returns a tuple with the SubtypeDisplayName field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
GetSubtypeTechnicalNameOk returns a tuple with the SubtypeTechnicalName field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
