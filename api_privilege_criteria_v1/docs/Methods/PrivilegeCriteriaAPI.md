...
slug: /tools/sdk/go/privilegecriteriav1/methods/privilege-criteria
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_privilege_criteria_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_privilege_criteria_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.PrivilegeCriteriaV1.PrivilegeCriteriaAPI.CreateCustomPrivilegeCriteriaV1(context.Background()).Createprivilegecriteriarequest(createprivilegecriteriarequest).Execute()
	  //resp, r, err := apiClient.PrivilegeCriteriaV1.PrivilegeCriteriaAPI.CreateCustomPrivilegeCriteriaV1(context.Background()).Createprivilegecriteriarequest(createprivilegecriteriarequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.PrivilegeCriteriaV1.PrivilegeCriteriaAPI.DeleteCustomPrivilegeCriteriaV1(context.Background(), criteriaId).Execute()
	  //r, err := apiClient.PrivilegeCriteriaV1.PrivilegeCriteriaAPI.DeleteCustomPrivilegeCriteriaV1(context.Background(), criteriaId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.PrivilegeCriteriaV1.PrivilegeCriteriaAPI.GetPrivilegeCriteriaV1(context.Background(), criteriaId).Execute()
	  //resp, r, err := apiClient.PrivilegeCriteriaV1.PrivilegeCriteriaAPI.GetPrivilegeCriteriaV1(context.Background(), criteriaId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.PrivilegeCriteriaV1.PrivilegeCriteriaAPI.ListPrivilegeCriteriaV1(context.Background()).Filters(filters).Execute()
	  //resp, r, err := apiClient.PrivilegeCriteriaV1.PrivilegeCriteriaAPI.ListPrivilegeCriteriaV1(context.Background()).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.PrivilegeCriteriaV1.PrivilegeCriteriaAPI.PutCustomPrivilegeCriteriaValueV1(context.Background(), criteriaId).Privilegecriteriadto(privilegecriteriadto).Execute()
	  //resp, r, err := apiClient.PrivilegeCriteriaV1.PrivilegeCriteriaAPI.PutCustomPrivilegeCriteriaValueV1(context.Background(), criteriaId).Privilegecriteriadto(privilegecriteriadto).Execute()
    if err != nil {
