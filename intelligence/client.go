...
// APIClient manages communication with the Identity Security Cloud API - Intelligence API vv1
...
type APIClient struct {
	...
	IntelligenceAPI *IntelligenceAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.IntelligenceAPI = (*IntelligenceAPIService)(&c.common)
