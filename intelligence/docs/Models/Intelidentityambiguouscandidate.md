...
------------ | ------------- | ------------- | -------------
**Id** | **string** | Identity Security Cloud identifier for a matching candidate. | 
**DisplayName** | Pointer to **string** | Human-facing label when available; omitted when empty upstream. | [optional] 
