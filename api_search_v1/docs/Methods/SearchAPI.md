...
slug: /tools/sdk/go/searchv1/methods/search
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_search_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_search_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.SearchV1.SearchAPI.SearchAggregateV1(context.Background()).Search(search).Execute()
	  //resp, r, err := apiClient.SearchV1.SearchAPI.SearchAggregateV1(context.Background()).Search(search).Offset(offset).Limit(limit).Count(count).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.SearchV1.SearchAPI.SearchCountV1(context.Background()).Search(search).Execute()
	  //r, err := apiClient.SearchV1.SearchAPI.SearchCountV1(context.Background()).Search(search).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SearchV1.SearchAPI.SearchGetV1(context.Background(), index, id).Execute()
	  //resp, r, err := apiClient.SearchV1.SearchAPI.SearchGetV1(context.Background(), index, id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SearchV1.SearchAPI.SearchPostV1(context.Background()).Search(search).Execute()
	  //resp, r, err := apiClient.SearchV1.SearchAPI.SearchPostV1(context.Background()).Search(search).Offset(offset).Limit(limit).Count(count).Execute()
    if err != nil {
