...
slug: /tools/sdk/go/scheduledsearchv1/methods/scheduled-search
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_scheduled_search_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_scheduled_search_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.CreateScheduledSearchV1(context.Background()).CreateScheduledSearchV1Request(createScheduledSearchV1Request).Execute()
	  //resp, r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.CreateScheduledSearchV1(context.Background()).CreateScheduledSearchV1Request(createScheduledSearchV1Request).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.DeleteScheduledSearchV1(context.Background(), id).Execute()
	  //r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.DeleteScheduledSearchV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.GetScheduledSearchV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.GetScheduledSearchV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.ListScheduledSearchV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.ListScheduledSearchV1(context.Background()).Offset(offset).Limit(limit).Count(count).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.UnsubscribeScheduledSearchV1(context.Background(), id).Typedreference(typedreference).Execute()
	  //r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.UnsubscribeScheduledSearchV1(context.Background(), id).Typedreference(typedreference).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.UpdateScheduledSearchV1(context.Background(), id).Scheduledsearch(scheduledsearch).Execute()
	  //resp, r, err := apiClient.ScheduledSearchV1.ScheduledSearchAPI.UpdateScheduledSearchV1(context.Background(), id).Scheduledsearch(scheduledsearch).Execute()
    if err != nil {
