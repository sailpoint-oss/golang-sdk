...
keywords: ['go', 'Golang', 'sdk', 'CertificationSummaries', 'V1CertificationSummaries'] 
slug: /tools/sdk/go/certificationsummariesv1/methods/certification-summaries
...
Other parameters are passed through a pointer to a apiGetIdentityAccessSummariesV1Request struct via the builder pattern
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_certification_summaries_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.CertificationSummariesV1.CertificationSummariesAPI.GetIdentityAccessSummariesV1(context.Background(), id, type_).Execute()
	  //resp, r, err := apiClient.CertificationSummariesV1.CertificationSummariesAPI.GetIdentityAccessSummariesV1(context.Background(), id, type_).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiGetIdentityDecisionSummaryV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CertificationSummariesV1.CertificationSummariesAPI.GetIdentityDecisionSummaryV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.CertificationSummariesV1.CertificationSummariesAPI.GetIdentityDecisionSummaryV1(context.Background(), id).Filters(filters).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiGetIdentitySummariesV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CertificationSummariesV1.CertificationSummariesAPI.GetIdentitySummariesV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.CertificationSummariesV1.CertificationSummariesAPI.GetIdentitySummariesV1(context.Background(), id).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiGetIdentitySummaryV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CertificationSummariesV1.CertificationSummariesAPI.GetIdentitySummaryV1(context.Background(), id, identitySummaryId).Execute()
	  //resp, r, err := apiClient.CertificationSummariesV1.CertificationSummariesAPI.GetIdentitySummaryV1(context.Background(), id, identitySummaryId).Execute()
    if err != nil {
