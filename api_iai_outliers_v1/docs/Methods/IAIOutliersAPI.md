...
keywords: ['go', 'Golang', 'sdk', 'IAIOutliers', 'V1IAIOutliers'] 
slug: /tools/sdk/go/iaioutliersv1/methods/iai-outliers
...
Other parameters are passed through a pointer to a apiExportOutliersZipV1Request struct via the builder pattern
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_iai_outliers_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.ExportOutliersZipV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.ExportOutliersZipV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Type_(type_).Execute()
    if err != nil {
	    fmt.Fprintf(os.Stderr, "Error when calling `IAIOutliersAPI.ExportOutliersZipV1``: %v\n", err)
	    fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ExportOutliersZipV1`: *os.File
    fmt.Fprintf(os.Stdout, "Response from `IAIOutliersAPI.ExportOutliersZipV1`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetIdentityOutlierSnapshotsV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.GetIdentityOutlierSnapshotsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.GetIdentityOutlierSnapshotsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Limit(limit).Offset(offset).Type_(type_).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiGetIdentityOutliersV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.GetIdentityOutliersV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.GetIdentityOutliersV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Limit(limit).Offset(offset).Count(count).Type_(type_).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
	    fmt.Fprintf(os.Stderr, "Error when calling `IAIOutliersAPI.GetIdentityOutliersV1``: %v\n", err)
	    fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetIdentityOutliersV1`: []Outlier
    fmt.Fprintf(os.Stdout, "Response from `IAIOutliersAPI.GetIdentityOutliersV1`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetLatestIdentityOutlierSnapshotsV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.GetLatestIdentityOutlierSnapshotsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.GetLatestIdentityOutlierSnapshotsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Type_(type_).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiGetOutlierContributingFeatureSummaryV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.GetOutlierContributingFeatureSummaryV1(context.Background(), outlierFeatureId).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.GetOutlierContributingFeatureSummaryV1(context.Background(), outlierFeatureId).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiGetPeerGroupOutliersContributingFeaturesV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.GetPeerGroupOutliersContributingFeaturesV1(context.Background(), outlierId).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.GetPeerGroupOutliersContributingFeaturesV1(context.Background(), outlierId).XSailPointExperimental(xSailPointExperimental).Limit(limit).Offset(offset).Count(count).IncludeTranslationMessages(includeTranslationMessages).Sorters(sorters).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiIgnoreIdentityOutliersV1Request struct via the builder pattern
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_iai_outliers_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_iai_outliers_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.IgnoreIdentityOutliersV1(context.Background()).XSailPointExperimental(xSailPointExperimental).RequestBody(requestBody).Execute()
	  //r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.IgnoreIdentityOutliersV1(context.Background()).XSailPointExperimental(xSailPointExperimental).RequestBody(requestBody).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiListOutliersContributingFeatureAccessItemsV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.ListOutliersContributingFeatureAccessItemsV1(context.Background(), outlierId, contributingFeatureName).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.ListOutliersContributingFeatureAccessItemsV1(context.Background(), outlierId, contributingFeatureName).XSailPointExperimental(xSailPointExperimental).Limit(limit).Offset(offset).Count(count).AccessType(accessType).Sorters(sorters).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiUnIgnoreIdentityOutliersV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.UnIgnoreIdentityOutliersV1(context.Background()).XSailPointExperimental(xSailPointExperimental).RequestBody(requestBody).Execute()
	  //r, err := apiClient.IaiOutliersV1.IAIOutliersAPI.UnIgnoreIdentityOutliersV1(context.Background()).XSailPointExperimental(xSailPointExperimental).RequestBody(requestBody).Execute()
    if err != nil {
