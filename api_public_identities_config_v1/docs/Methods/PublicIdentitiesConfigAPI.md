...
slug: /tools/sdk/go/publicidentitiesconfigv1/methods/public-identities-config
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_public_identities_config_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.PublicIdentitiesConfigV1.PublicIdentitiesConfigAPI.GetPublicIdentityConfigV1(context.Background()).Execute()
	  //resp, r, err := apiClient.PublicIdentitiesConfigV1.PublicIdentitiesConfigAPI.GetPublicIdentityConfigV1(context.Background()).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_public_identities_config_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_public_identities_config_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.PublicIdentitiesConfigV1.PublicIdentitiesConfigAPI.UpdatePublicIdentityConfigV1(context.Background()).Publicidentityconfig(publicidentityconfig).Execute()
	  //resp, r, err := apiClient.PublicIdentitiesConfigV1.PublicIdentitiesConfigAPI.UpdatePublicIdentityConfigV1(context.Background()).Publicidentityconfig(publicidentityconfig).Execute()
    if err != nil {
