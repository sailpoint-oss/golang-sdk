...
type ApiDisableMachineAccountsInBulkV1Request struct {
	ctx context.Context
	ApiService *MachineAccountsAPIService
	xSailPointExperimental *string
...
// Use this header to enable this experimental API.
func (r ApiDisableMachineAccountsInBulkV1Request) XSailPointExperimental(xSailPointExperimental string) ApiDisableMachineAccountsInBulkV1Request {
	r.xSailPointExperimental = &xSailPointExperimental
	return r
}

func (r ApiDisableMachineAccountsInBulkV1Request) Misbulkrequest(misbulkrequest Misbulkrequest) ApiDisableMachineAccountsInBulkV1Request {
	r.misbulkrequest = &misbulkrequest
	return r
}

func (r ApiDisableMachineAccountsInBulkV1Request) Execute() (*Accountrequestasyncresult, *http.Response, error) {
	return r.ApiService.DisableMachineAccountsInBulkV1Execute(r)
}

/*
DisableMachineAccountsInBulkV1 Bulk disable machine accounts
...
Callers without the **idn:mis-account:disable** right may still disable accounts they own. Non-owned IDs are excluded from the task.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDisableMachineAccountsInBulkV1Request
*/
func (a *MachineAccountsAPIService) DisableMachineAccountsInBulkV1(ctx context.Context) ApiDisableMachineAccountsInBulkV1Request {
	return ApiDisableMachineAccountsInBulkV1Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MachineAccountsAPIService) DisableMachineAccountsInBulkV1Execute(r ApiDisableMachineAccountsInBulkV1Request) (*Accountrequestasyncresult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MachineAccountsAPIService.DisableMachineAccountsInBulkV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/machine-accounts/v1/bulk-disable"
...
type ApiEnableMachineAccountsInBulkV1Request struct {
	ctx context.Context
	ApiService *MachineAccountsAPIService
	xSailPointExperimental *string
	misbulkrequest *Misbulkrequest
...
// Use this header to enable this experimental API.
func (r ApiEnableMachineAccountsInBulkV1Request) XSailPointExperimental(xSailPointExperimental string) ApiEnableMachineAccountsInBulkV1Request {
	r.xSailPointExperimental = &xSailPointExperimental
	return r
}

func (r ApiEnableMachineAccountsInBulkV1Request) Misbulkrequest(misbulkrequest Misbulkrequest) ApiEnableMachineAccountsInBulkV1Request {
	r.misbulkrequest = &misbulkrequest
	return r
}

func (r ApiEnableMachineAccountsInBulkV1Request) Execute() (*Accountrequestasyncresult, *http.Response, error) {
	return r.ApiService.EnableMachineAccountsInBulkV1Execute(r)
}

/*
EnableMachineAccountsInBulkV1 Bulk enable machine accounts
...
Callers without the **idn:mis-account:enable** right may still enable accounts they own. Non-owned IDs are excluded from the task.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiEnableMachineAccountsInBulkV1Request
*/
func (a *MachineAccountsAPIService) EnableMachineAccountsInBulkV1(ctx context.Context) ApiEnableMachineAccountsInBulkV1Request {
	return ApiEnableMachineAccountsInBulkV1Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Accountrequestasyncresult
func (a *MachineAccountsAPIService) EnableMachineAccountsInBulkV1Execute(r ApiEnableMachineAccountsInBulkV1Request) (*Accountrequestasyncresult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MachineAccountsAPIService.EnableMachineAccountsInBulkV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/machine-accounts/v1/bulk-enable"
...
type ApiReloadMachineAccountsInBulkV1Request struct {
	ctx context.Context
	ApiService *MachineAccountsAPIService
	xSailPointExperimental *string
	misbulkrequest *Misbulkrequest
...
// Use this header to enable this experimental API.
func (r ApiReloadMachineAccountsInBulkV1Request) XSailPointExperimental(xSailPointExperimental string) ApiReloadMachineAccountsInBulkV1Request {
	r.xSailPointExperimental = &xSailPointExperimental
	return r
}

func (r ApiReloadMachineAccountsInBulkV1Request) Misbulkrequest(misbulkrequest Misbulkrequest) ApiReloadMachineAccountsInBulkV1Request {
	r.misbulkrequest = &misbulkrequest
	return r
}

func (r ApiReloadMachineAccountsInBulkV1Request) Execute() ([]Misbulkresponse, *http.Response, error) {
	return r.ApiService.ReloadMachineAccountsInBulkV1Execute(r)
}

/*
ReloadMachineAccountsInBulkV1 Bulk reload machine accounts
...
Callers without the **idn:mis-account:reload** right may still reload accounts they own.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiReloadMachineAccountsInBulkV1Request
*/
func (a *MachineAccountsAPIService) ReloadMachineAccountsInBulkV1(ctx context.Context) ApiReloadMachineAccountsInBulkV1Request {
	return ApiReloadMachineAccountsInBulkV1Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MachineAccountsAPIService) ReloadMachineAccountsInBulkV1Execute(r ApiReloadMachineAccountsInBulkV1Request) ([]Misbulkresponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MachineAccountsAPIService.ReloadMachineAccountsInBulkV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/machine-accounts/v1/bulk-reload"
...
type ApiUpdateMachineAccountsInBulkV1Request struct {
	ctx context.Context
	ApiService *MachineAccountsAPIService
	xSailPointExperimental *string
...
// Use this header to enable this experimental API.
func (r ApiUpdateMachineAccountsInBulkV1Request) XSailPointExperimental(xSailPointExperimental string) ApiUpdateMachineAccountsInBulkV1Request {
	r.xSailPointExperimental = &xSailPointExperimental
	return r
}

func (r ApiUpdateMachineAccountsInBulkV1Request) Misbulkupdaterequest(misbulkupdaterequest Misbulkupdaterequest) ApiUpdateMachineAccountsInBulkV1Request {
	r.misbulkupdaterequest = &misbulkupdaterequest
	return r
}

func (r ApiUpdateMachineAccountsInBulkV1Request) Execute() ([]Misbulkresponse, *http.Response, error) {
	return r.ApiService.UpdateMachineAccountsInBulkV1Execute(r)
}

/*
UpdateMachineAccountsInBulkV1 Bulk update machine accounts
...
Patchable fields include **description**, **subtype**, **environment**, **machineIdentity**, **ownerIdentity**, and **manuallyEdited** only.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUpdateMachineAccountsInBulkV1Request
*/
func (a *MachineAccountsAPIService) UpdateMachineAccountsInBulkV1(ctx context.Context) ApiUpdateMachineAccountsInBulkV1Request {
	return ApiUpdateMachineAccountsInBulkV1Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []Misbulkresponse
func (a *MachineAccountsAPIService) UpdateMachineAccountsInBulkV1Execute(r ApiUpdateMachineAccountsInBulkV1Request) ([]Misbulkresponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MachineAccountsAPIService.UpdateMachineAccountsInBulkV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/machine-accounts/v1/bulk-update"
