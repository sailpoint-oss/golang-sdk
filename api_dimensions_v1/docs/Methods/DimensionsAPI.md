...
slug: /tools/sdk/go/dimensionsv1/methods/dimensions
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_dimensions_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_dimensions_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.DimensionsV1.DimensionsAPI.CreateDimensionV1(context.Background(), roleId).Dimension(dimension).Execute()
	  //resp, r, err := apiClient.DimensionsV1.DimensionsAPI.CreateDimensionV1(context.Background(), roleId).Dimension(dimension).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DimensionsV1.DimensionsAPI.DeleteBulkDimensionsV1(context.Background(), roleId).Dimensionbulkdeleterequest(dimensionbulkdeleterequest).Execute()
	  //resp, r, err := apiClient.DimensionsV1.DimensionsAPI.DeleteBulkDimensionsV1(context.Background(), roleId).Dimensionbulkdeleterequest(dimensionbulkdeleterequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.DimensionsV1.DimensionsAPI.DeleteDimensionV1(context.Background(), roleId, dimensionId).Execute()
	  //r, err := apiClient.DimensionsV1.DimensionsAPI.DeleteDimensionV1(context.Background(), roleId, dimensionId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DimensionsV1.DimensionsAPI.GetDimensionEntitlementsV1(context.Background(), roleId, dimensionId).Execute()
	  //resp, r, err := apiClient.DimensionsV1.DimensionsAPI.GetDimensionEntitlementsV1(context.Background(), roleId, dimensionId).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DimensionsV1.DimensionsAPI.GetDimensionV1(context.Background(), roleId, dimensionId).Execute()
	  //resp, r, err := apiClient.DimensionsV1.DimensionsAPI.GetDimensionV1(context.Background(), roleId, dimensionId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DimensionsV1.DimensionsAPI.ListDimensionAccessProfilesV1(context.Background(), roleId, dimensionId).Execute()
	  //resp, r, err := apiClient.DimensionsV1.DimensionsAPI.ListDimensionAccessProfilesV1(context.Background(), roleId, dimensionId).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DimensionsV1.DimensionsAPI.ListDimensionsV1(context.Background(), roleId).Execute()
	  //resp, r, err := apiClient.DimensionsV1.DimensionsAPI.ListDimensionsV1(context.Background(), roleId).ForSubadmin(forSubadmin).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DimensionsV1.DimensionsAPI.PatchDimensionV1(context.Background(), roleId, dimensionId).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.DimensionsV1.DimensionsAPI.PatchDimensionV1(context.Background(), roleId, dimensionId).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
