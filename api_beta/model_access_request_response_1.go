...
// checks if the AccessRequestResponse1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessRequestResponse1{}

// AccessRequestResponse1 struct for AccessRequestResponse1
type AccessRequestResponse1 struct {
	// the requester Id
...
type _AccessRequestResponse1 AccessRequestResponse1
...
func (o AccessRequestResponse1) MarshalJSON() ([]byte, error) {
...
func (o AccessRequestResponse1) ToMap() (map[string]interface{}, error) {
...
func (o *AccessRequestResponse1) UnmarshalJSON(data []byte) (err error) {
	varAccessRequestResponse1 := _AccessRequestResponse1{}

	err = json.Unmarshal(data, &varAccessRequestResponse1)

	if err != nil {
		return err
	}

	*o = AccessRequestResponse1(varAccessRequestResponse1)
...
type NullableAccessRequestResponse1 struct {
	value *AccessRequestResponse1
	isSet bool
}

func (v NullableAccessRequestResponse1) Get() *AccessRequestResponse1 {
	return v.value
}

func (v *NullableAccessRequestResponse1) Set(val *AccessRequestResponse1) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessRequestResponse1) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessRequestResponse1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessRequestResponse1(val *AccessRequestResponse1) *NullableAccessRequestResponse1 {
	return &NullableAccessRequestResponse1{value: val, isSet: true}
}

func (v NullableAccessRequestResponse1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessRequestResponse1) UnmarshalJSON(src []byte) error {
	v.isSet = true
