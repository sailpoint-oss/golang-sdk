...
------------- | ------------- | ------------- | ------------- | ------------- 
 Body  | domainAddress | [**DomainAddress**](DomainAddress.md) | True  | 
...
Param Type | Name | Data Type | Required  | Description
------------- | ------------- | ------------- | ------------- | ------------- 
 Body  | templateDto | [**TemplateDto**](TemplateDto.md) | True  | 
...
Param Type | Name | Data Type | Required  | Description
------------- | ------------- | ------------- | ------------- | ------------- 
 Body  | emailStatusDto | [**EmailStatusDto**](EmailStatusDto.md) | True  | 
...
Param Type | Name | Data Type | Required  | Description
------------- | ------------- | ------------- | ------------- | ------------- 
 Body  | templateBulkDeleteDto | [**[]TemplateBulkDeleteDto**](TemplateBulkDeleteDto.md) | True  | 
...
Param Type | Name | Data Type | Required  | Description
------------- | ------------- | ------------- | ------------- | ------------- 
 Body  | mailFromAttributesDto | [**MailFromAttributesDto**](MailFromAttributesDto.md) | True  | 
...
------------- | ------------- | ------------- | ------------- | ------------- 
Path   | key | **string** | True  | The notification key.
 Body  | preferencesDto | [**PreferencesDto**](PreferencesDto.md) | True  | 
...
Param Type | Name | Data Type | Required  | Description
------------- | ------------- | ------------- | ------------- | ------------- 
 Body  | sendTestNotificationRequestDto | [**SendTestNotificationRequestDto**](SendTestNotificationRequestDto.md) | True  | 
