...
------------- | ------------- | ------------- | ------------- | ------------- 
 Body  | connectorRuleCreateRequest | [**ConnectorRuleCreateRequest**](ConnectorRuleCreateRequest.md) | True  | The connector rule to create
...
Path   | id | **string** | True  | ID of the connector rule to update
 Body  | connectorRuleUpdateRequest | [**ConnectorRuleUpdateRequest**](ConnectorRuleUpdateRequest.md) |   (optional) | The connector rule with updated data
...
Param Type | Name | Data Type | Required  | Description
------------- | ------------- | ------------- | ------------- | ------------- 
 Body  | sourceCode | [**SourceCode**](SourceCode.md) | True  | The code to validate
