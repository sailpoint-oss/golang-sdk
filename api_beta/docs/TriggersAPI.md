...
Path   | id | **string** | True  | The ID of the invocation to complete.
 Body  | completeInvocation | [**CompleteInvocation**](CompleteInvocation.md) | True  | 
...
Param Type | Name | Data Type | Required  | Description
------------- | ------------- | ------------- | ------------- | ------------- 
 Body  | subscriptionPostRequest | [**SubscriptionPostRequest**](SubscriptionPostRequest.md) | True  | 
...
Path   | id | **string** | True  | ID of the Subscription to patch
 Body  | subscriptionPatchRequestInner | [**[]SubscriptionPatchRequestInner**](SubscriptionPatchRequestInner.md) | True  | 
...
Param Type | Name | Data Type | Required  | Description
------------- | ------------- | ------------- | ------------- | ------------- 
 Body  | testInvocation | [**TestInvocation**](TestInvocation.md) | True  | 
...
Param Type | Name | Data Type | Required  | Description
------------- | ------------- | ------------- | ------------- | ------------- 
 Body  | validateFilterInputDto | [**ValidateFilterInputDto**](ValidateFilterInputDto.md) | True  | 
...
------------- | ------------- | ------------- | ------------- | ------------- 
Path   | id | **string** | True  | Subscription ID
 Body  | subscriptionPutRequest | [**SubscriptionPutRequest**](SubscriptionPutRequest.md) | True  | 
