...
Path   | id | **string** | True  | ID of the Managed Client Status to get
  Query | type_ | [**ManagedClientType**](ManagedClientType.md) | True  | Type of the Managed Client Status to get
...
Path   | id | **string** | True  | ID of the Managed Client Status to update
 Body  | managedClientStatus | [**ManagedClientStatus**](ManagedClientStatus.md) | True  | 

	
### Return type

[**ManagedClientStatusAggResponse**](ManagedClientStatusAggResponse)
