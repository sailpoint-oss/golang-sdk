...
*/
func (a *TenantAPIService) GetTenant(ctx context.Context) ApiGetTenantRequest {
	return ApiGetTenantRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return Tenant
func (a *TenantAPIService) GetTenantExecute(r ApiGetTenantRequest) (*Tenant, *http.Response, error) {
	var (
