...
// checks if the CompletedApprovalReviewedBy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompletedApprovalReviewedBy{}

// CompletedApprovalReviewedBy Identity who reviewed the access item request.
type CompletedApprovalReviewedBy struct {
...
type _CompletedApprovalReviewedBy CompletedApprovalReviewedBy
...
func NewCompletedApprovalReviewedBy() *CompletedApprovalReviewedBy {
	this := CompletedApprovalReviewedBy{}
	return &this
}
...
func (o CompletedApprovalReviewedBy) MarshalJSON() ([]byte, error) {
...
func (o CompletedApprovalReviewedBy) ToMap() (map[string]interface{}, error) {
...
func (o *CompletedApprovalReviewedBy) UnmarshalJSON(data []byte) (err error) {
	varCompletedApprovalReviewedBy := _CompletedApprovalReviewedBy{}

	err = json.Unmarshal(data, &varCompletedApprovalReviewedBy)
...
type NullableCompletedApprovalReviewedBy struct {
	value *CompletedApprovalReviewedBy
	isSet bool
}

func (v NullableCompletedApprovalReviewedBy) Get() *CompletedApprovalReviewedBy {
	return v.value
}

func (v *NullableCompletedApprovalReviewedBy) Set(val *CompletedApprovalReviewedBy) {
	v.value = val
	v.isSet = true
}

func (v NullableCompletedApprovalReviewedBy) IsSet() bool {
	return v.isSet
}

func (v *NullableCompletedApprovalReviewedBy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompletedApprovalReviewedBy(val *CompletedApprovalReviewedBy) *NullableCompletedApprovalReviewedBy {
	return &NullableCompletedApprovalReviewedBy{value: val, isSet: true}
}

func (v NullableCompletedApprovalReviewedBy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompletedApprovalReviewedBy) UnmarshalJSON(src []byte) error {
	v.isSet = true
