...
// DiscoveredApplicationsAPIService DiscoveredApplicationsAPI service
type DiscoveredApplicationsAPIService service

type ApiGetDiscoveredApplicationsRequest struct {
	ctx context.Context
	ApiService *DiscoveredApplicationsAPIService
	limit *int32
	offset *int32
	filter *string
	sorters *string
...
*/
func (a *DiscoveredApplicationsAPIService) GetDiscoveredApplications(ctx context.Context) ApiGetDiscoveredApplicationsRequest {
	return ApiGetDiscoveredApplicationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DiscoveredApplicationsAPIService) GetDiscoveredApplicationsExecute(r ApiGetDiscoveredApplicationsRequest) ([][]DiscoveredApplicationsInner, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DiscoveredApplicationsAPIService.GetDiscoveredApplications")
	if err != nil {
