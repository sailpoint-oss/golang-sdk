...
// checks if the SlimAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SlimAccount{}
...
func (o *SlimAccount) SetDescriptionNil() {
...
func (o SlimAccount) ToMap() (map[string]interface{}, error) {
...
func (o *SlimAccount) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSlimAccount)
