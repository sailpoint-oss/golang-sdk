...
func (dst *WorkflowTriggerAttributes) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into ExternalAttributes
	err = newStrictDecoder(data).Decode(&dst.ExternalAttributes)
	if err == nil {
...
func (obj *WorkflowTriggerAttributes) GetActualInstance() (interface{}) {
	...
	if obj.ExternalAttributes != nil {
		return obj.ExternalAttributes
	}
