...
func (o *FullcampaignAllOfSourcesWithOrphanEntitlements) UnmarshalJSON(data []byte) (err error) {
	varFullcampaignAllOfSourcesWithOrphanEntitlements := _FullcampaignAllOfSourcesWithOrphanEntitlements{}

	err = json.Unmarshal(data, &varFullcampaignAllOfSourcesWithOrphanEntitlements)
