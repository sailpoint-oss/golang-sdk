...
func (r ApiSendDuoVerifyRequestRequest) DuoVerificationRequest(duoVerificationRequest DuoVerificationRequest) ApiSendDuoVerifyRequestRequest {
	r.duoVerificationRequest = &duoVerificationRequest
	return r
}

func (r ApiSendDuoVerifyRequestRequest) Execute() (*VerificationResponse, *http.Response, error) {
	return r.ApiService.SendDuoVerifyRequestExecute(r)
}
...
func (a *MFAControllerAPIService) SendDuoVerifyRequestExecute(r ApiSendDuoVerifyRequestRequest) (*VerificationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mfa/duo-web/verify"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.duoVerificationRequest == nil {
		return localVarReturnValue, nil, reportError("duoVerificationRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.duoVerificationRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiSendOktaVerifyRequestRequest) OktaVerificationRequest(oktaVerificationRequest OktaVerificationRequest) ApiSendOktaVerifyRequestRequest {
	r.oktaVerificationRequest = &oktaVerificationRequest
	return r
}

func (r ApiSendOktaVerifyRequestRequest) Execute() (*VerificationResponse, *http.Response, error) {
	return r.ApiService.SendOktaVerifyRequestExecute(r)
}
...
func (a *MFAControllerAPIService) SendOktaVerifyRequestExecute(r ApiSendOktaVerifyRequestRequest) (*VerificationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mfa/okta-verify/verify"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.oktaVerificationRequest == nil {
		return localVarReturnValue, nil, reportError("oktaVerificationRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.oktaVerificationRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
