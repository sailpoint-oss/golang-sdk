...
// checks if the AccessItemOwnerDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessItemOwnerDto{}

// AccessItemOwnerDto Access item owner's identity.
type AccessItemOwnerDto struct {
...
type _AccessItemOwnerDto AccessItemOwnerDto
...
func (o AccessItemOwnerDto) MarshalJSON() ([]byte, error) {
...
func (o AccessItemOwnerDto) ToMap() (map[string]interface{}, error) {
...
func (o *AccessItemOwnerDto) UnmarshalJSON(data []byte) (err error) {
	varAccessItemOwnerDto := _AccessItemOwnerDto{}

	err = json.Unmarshal(data, &varAccessItemOwnerDto)
...
type NullableAccessItemOwnerDto struct {
	value *AccessItemOwnerDto
	isSet bool
}

func (v NullableAccessItemOwnerDto) Get() *AccessItemOwnerDto {
	return v.value
}

func (v *NullableAccessItemOwnerDto) Set(val *AccessItemOwnerDto) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessItemOwnerDto) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessItemOwnerDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessItemOwnerDto(val *AccessItemOwnerDto) *NullableAccessItemOwnerDto {
	return &NullableAccessItemOwnerDto{value: val, isSet: true}
}

func (v NullableAccessItemOwnerDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessItemOwnerDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
