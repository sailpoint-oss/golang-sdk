...
func (r ApiGetAccountActivityRequest) Execute() (*CancelableAccountActivity, *http.Response, error) {
...
func (r ApiListAccountActivitiesRequest) Type_(type_ string) ApiListAccountActivitiesRequest {
	r.type_ = &type_
	return r
}
...
func (r ApiListAccountActivitiesRequest) Execute() ([]CancelableAccountActivity, *http.Response, error) {
