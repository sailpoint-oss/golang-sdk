...
func (r ApiGetSedBatchesRequest) Execute() ([]Sed, *http.Response, error) {
...
// Execute executes the request
//  @return []Sed
func (a *SuggestedEntitlementDescriptionAPIService) GetSedBatchesExecute(r ApiGetSedBatchesRequest) ([]Sed, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
