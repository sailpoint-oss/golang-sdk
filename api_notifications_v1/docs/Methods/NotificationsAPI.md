...
slug: /tools/sdk/go/notificationsv1/methods/notifications
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_notifications_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_notifications_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.CreateDomainDkimV1(context.Background()).Domainaddress(domainaddress).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.CreateDomainDkimV1(context.Background()).Domainaddress(domainaddress).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.CreateNotificationTemplateV1(context.Background()).Templatedto(templatedto).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.CreateNotificationTemplateV1(context.Background()).Templatedto(templatedto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.CreateVerifiedFromAddressV1(context.Background()).Emailstatusdto(emailstatusdto).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.CreateVerifiedFromAddressV1(context.Background()).Emailstatusdto(emailstatusdto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.NotificationsV1.NotificationsAPI.DeleteNotificationTemplatesInBulkV1(context.Background()).Templatebulkdeletedto(templatebulkdeletedto).Execute()
	  //r, err := apiClient.NotificationsV1.NotificationsAPI.DeleteNotificationTemplatesInBulkV1(context.Background()).Templatebulkdeletedto(templatebulkdeletedto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.NotificationsV1.NotificationsAPI.DeleteVerifiedFromAddressV1(context.Background(), id).Execute()
	  //r, err := apiClient.NotificationsV1.NotificationsAPI.DeleteVerifiedFromAddressV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetDkimAttributesV1(context.Background()).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetDkimAttributesV1(context.Background()).Limit(limit).Offset(offset).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetMailFromAttributesV1(context.Background(), identity).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetMailFromAttributesV1(context.Background(), identity).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetNotificationPreferencesV1(context.Background(), key).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetNotificationPreferencesV1(context.Background(), key).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetNotificationTemplateV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetNotificationTemplateV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetNotificationTemplateVariablesV1(context.Background(), key, medium).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetNotificationTemplateVariablesV1(context.Background(), key, medium).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetNotificationsTemplateContextV1(context.Background()).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.GetNotificationsTemplateContextV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.ListFromAddressesV1(context.Background()).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.ListFromAddressesV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.ListNotificationTemplateDefaultsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.ListNotificationTemplateDefaultsV1(context.Background()).Limit(limit).Offset(offset).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.ListNotificationTemplatesV1(context.Background()).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.ListNotificationTemplatesV1(context.Background()).Limit(limit).Offset(offset).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.NotificationsV1.NotificationsAPI.PutMailFromAttributesV1(context.Background()).Mailfromattributesdto(mailfromattributesdto).Execute()
	  //resp, r, err := apiClient.NotificationsV1.NotificationsAPI.PutMailFromAttributesV1(context.Background()).Mailfromattributesdto(mailfromattributesdto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.NotificationsV1.NotificationsAPI.SendTestNotificationV1(context.Background()).Sendtestnotificationrequestdto(sendtestnotificationrequestdto).Execute()
	  //r, err := apiClient.NotificationsV1.NotificationsAPI.SendTestNotificationV1(context.Background()).Sendtestnotificationrequestdto(sendtestnotificationrequestdto).Execute()
    if err != nil {
