...
slug: /tools/sdk/go/configurationhubv1/methods/configuration-hub
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_configuration_hub_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_configuration_hub_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.CreateDeployV1(context.Background()).Deployrequest(deployrequest).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.CreateDeployV1(context.Background()).Deployrequest(deployrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.CreateObjectMappingV1(context.Background(), sourceOrg).Objectmappingrequest(objectmappingrequest).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.CreateObjectMappingV1(context.Background(), sourceOrg).Objectmappingrequest(objectmappingrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.CreateObjectMappingsV1(context.Background(), sourceOrg).Objectmappingbulkcreaterequest(objectmappingbulkcreaterequest).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.CreateObjectMappingsV1(context.Background(), sourceOrg).Objectmappingbulkcreaterequest(objectmappingbulkcreaterequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.CreateScheduledActionV1(context.Background()).Scheduledactionpayload(scheduledactionpayload).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.CreateScheduledActionV1(context.Background()).Scheduledactionpayload(scheduledactionpayload).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.CreateUploadedConfigurationV1(context.Background()).Data(data).Name(name).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.CreateUploadedConfigurationV1(context.Background()).Data(data).Name(name).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.DeleteBackupV1(context.Background(), id).Execute()
	  //r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.DeleteBackupV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.DeleteDraftV1(context.Background(), id).Execute()
	  //r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.DeleteDraftV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.DeleteObjectMappingV1(context.Background(), sourceOrg, objectMappingId).Execute()
	  //r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.DeleteObjectMappingV1(context.Background(), sourceOrg, objectMappingId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.DeleteScheduledActionV1(context.Background(), id).Execute()
	  //r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.DeleteScheduledActionV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.DeleteUploadedConfigurationV1(context.Background(), id).Execute()
	  //r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.DeleteUploadedConfigurationV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.GetDeployV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.GetDeployV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.GetObjectMappingsV1(context.Background(), sourceOrg).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.GetObjectMappingsV1(context.Background(), sourceOrg).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.GetUploadedConfigurationV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.GetUploadedConfigurationV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.ListBackupsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.ListBackupsV1(context.Background()).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.ListDeploysV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.ListDeploysV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.ListDraftsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.ListDraftsV1(context.Background()).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.ListScheduledActionsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.ListScheduledActionsV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.ListUploadedConfigurationsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.ListUploadedConfigurationsV1(context.Background()).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.UpdateObjectMappingsV1(context.Background(), sourceOrg).Objectmappingbulkpatchrequest(objectmappingbulkpatchrequest).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.UpdateObjectMappingsV1(context.Background(), sourceOrg).Objectmappingbulkpatchrequest(objectmappingbulkpatchrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.UpdateScheduledActionV1(context.Background(), id).Jsonpatch(jsonpatch).Execute()
	  //resp, r, err := apiClient.ConfigurationHubV1.ConfigurationHubAPI.UpdateScheduledActionV1(context.Background(), id).Jsonpatch(jsonpatch).Execute()
    if err != nil {
