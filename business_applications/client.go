...
// APIClient manages communication with the Identity Security Cloud API - Business Applications API vv1
...
type APIClient struct {
	...
	BusinessApplicationsAPI *BusinessApplicationsAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BusinessApplicationsAPI = (*BusinessApplicationsAPIService)(&c.common)
