...
slug: /tools/sdk/go/taskmanagementv1/methods/task-management
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_task_management_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.TaskManagementV1.TaskManagementAPI.GetTaskStatusListV1(context.Background()).Execute()
	  //resp, r, err := apiClient.TaskManagementV1.TaskManagementAPI.GetTaskStatusListV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TaskManagementV1.TaskManagementAPI.GetTaskStatusV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.TaskManagementV1.TaskManagementAPI.GetTaskStatusV1(context.Background(), id).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_task_management_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_task_management_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TaskManagementV1.TaskManagementAPI.UpdateTaskStatusV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.TaskManagementV1.TaskManagementAPI.UpdateTaskStatusV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
