...
slug: /tools/sdk/go/transformsv1/methods/transforms
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_transforms_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_transforms_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.TransformsV1.TransformsAPI.CreateTransformV1(context.Background()).Transform(transform).Execute()
	  //resp, r, err := apiClient.TransformsV1.TransformsAPI.CreateTransformV1(context.Background()).Transform(transform).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.TransformsV1.TransformsAPI.DeleteTransformV1(context.Background(), id).Execute()
	  //r, err := apiClient.TransformsV1.TransformsAPI.DeleteTransformV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TransformsV1.TransformsAPI.GetTransformV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.TransformsV1.TransformsAPI.GetTransformV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TransformsV1.TransformsAPI.ListTransformsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.TransformsV1.TransformsAPI.ListTransformsV1(context.Background()).Offset(offset).Limit(limit).Count(count).Name(name).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TransformsV1.TransformsAPI.UpdateTransformV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.TransformsV1.TransformsAPI.UpdateTransformV1(context.Background(), id).Transform(transform).Execute()
    if err != nil {
