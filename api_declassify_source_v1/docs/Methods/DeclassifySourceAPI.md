...
slug: /tools/sdk/go/declassifysourcev1/methods/declassify-source
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_declassify_source_v1"
)
...
func main() {
    ...
    r, err := apiClient.DeclassifySourceV1.DeclassifySourceAPI.SendDeclassifyMachineAccountFromSourceV1(context.Background(), sourceId).Execute()
	  //r, err := apiClient.DeclassifySourceV1.DeclassifySourceAPI.SendDeclassifyMachineAccountFromSourceV1(context.Background(), sourceId).Execute()
    if err != nil {
