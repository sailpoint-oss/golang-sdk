...
func main() {
    createformrequestJson := []byte(``) // CreateFormRequest | 

    var createFormRequest nerm.CreateFormRequest
    if err := json.Unmarshal(createformrequestJson, &createFormRequest); err != nil {
...
func main() {
    id := `1246d8b3-ac29-4015-8154-dea4434a73fa` // string | ID of the object to retrieve, update, or delete # string | ID of the object to retrieve, update, or delete
    updateformbyidrequestJson := []byte(``) // UpdateFormByIdRequest | 

    var updateFormByIdRequest nerm.UpdateFormByIdRequest
    if err := json.Unmarshal(updateformbyidrequestJson, &updateFormByIdRequest); err != nil {
      fmt.Println("Error:", err)
      return
    }
