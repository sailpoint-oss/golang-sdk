...
func Test_sailpointbetasdk_CustomPasswordInstructionsApiService(t *testing.T) {
	...
	t.Run("Test CustomPasswordInstructionsApiService DeleteCustomPasswordInstructions", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.CustomPasswordInstructionsApi.DeleteCustomPasswordInstructions(context.Background(), pageId).Execute()
