...
func Test_sailpointbetasdk_CertificationsApiService(t *testing.T) {
	...
	t.Run("Test CertificationsApiService ReassignIdentityCertsAsync", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.CertificationsApi.ReassignIdentityCertsAsync(context.Background(), id).Execute()
