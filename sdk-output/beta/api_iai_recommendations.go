...
type ApiGetMessageCatalogsRequest222 struct {
	ctx context.Context
	ApiService *IAIRecommendationsApiService
	catalogId string
}

func (r ApiGetMessageCatalogsRequest222) Execute() ([]MessageCatalogDto, *http.Response, error) {
...
The getMessageCatalogs API returns message catalog based on the language headers in the requested object.
 ...
 @return ApiGetMessageCatalogsRequest222
*/
func (a *IAIRecommendationsApiService) GetMessageCatalogs(ctx context.Context, catalogId string) ApiGetMessageCatalogsRequest222 {
	return ApiGetMessageCatalogsRequest222{
		ApiService: a,
		ctx: ctx,
		catalogId: catalogId,
...
func (a *IAIRecommendationsApiService) GetMessageCatalogsExecute(r ApiGetMessageCatalogsRequest222) ([]MessageCatalogDto, *http.Response, error) {
	var (
