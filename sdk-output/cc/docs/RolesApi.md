...
------------- | ------------- | -------------
[**GetRole**](RolesApi.md#GetRole) | **Get** /cc/api/role/get/{id} | Get Role
[**ListRoles**](RolesApi.md#ListRoles) | **Get** /cc/api/role/list | List Roles



## GetRole

> GetRole(ctx, id).Execute()
