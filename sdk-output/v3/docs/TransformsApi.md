...
func main() {
    transform := *openapiclient.NewTransform("Timestamp To Date", "dateFormat") // Transform | The transform to be created.
...
func main() {
    ...
    transform := *openapiclient.NewTransform("Timestamp To Date", "dateFormat") // Transform | The updated transform object (must include \"name\", \"type\", and \"attributes\" fields). (optional)
