...
slug: /tools/sdk/go/workreassignmentv1/methods/work-reassignment
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_work_reassignment_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_work_reassignment_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.CreateReassignmentConfigurationV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Configurationitemrequest(configurationitemrequest).Execute()
	  //resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.CreateReassignmentConfigurationV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Configurationitemrequest(configurationitemrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.DeleteReassignmentConfigurationV1(context.Background(), identityId, configType).XSailPointExperimental(xSailPointExperimental).Execute()
	  //r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.DeleteReassignmentConfigurationV1(context.Background(), identityId, configType).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.GetEvaluateReassignmentConfigurationV1(context.Background(), identityId, configType).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.GetEvaluateReassignmentConfigurationV1(context.Background(), identityId, configType).XSailPointExperimental(xSailPointExperimental).ExclusionFilters(exclusionFilters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.GetReassignmentConfigTypesV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.GetReassignmentConfigTypesV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.GetReassignmentConfigurationV1(context.Background(), identityId).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.GetReassignmentConfigurationV1(context.Background(), identityId).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.GetTenantConfigConfigurationV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.GetTenantConfigConfigurationV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.ListReassignmentConfigurationsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.ListReassignmentConfigurationsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.PutReassignmentConfigV1(context.Background(), identityId).XSailPointExperimental(xSailPointExperimental).Configurationitemrequest(configurationitemrequest).Execute()
	  //resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.PutReassignmentConfigV1(context.Background(), identityId).XSailPointExperimental(xSailPointExperimental).Configurationitemrequest(configurationitemrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.PutTenantConfigurationV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Tenantconfigurationrequest(tenantconfigurationrequest).Execute()
	  //resp, r, err := apiClient.WorkReassignmentV1.WorkReassignmentAPI.PutTenantConfigurationV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Tenantconfigurationrequest(tenantconfigurationrequest).Execute()
    if err != nil {
