...
slug: /tools/sdk/go/spconfigv1/methods/sp-config
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_sp_config_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_sp_config_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.SpConfigV1.SPConfigAPI.ExportSpConfigV1(context.Background()).Exportpayload(exportpayload).Execute()
	  //resp, r, err := apiClient.SpConfigV1.SPConfigAPI.ExportSpConfigV1(context.Background()).Exportpayload(exportpayload).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SpConfigV1.SPConfigAPI.GetSpConfigExportStatusV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SpConfigV1.SPConfigAPI.GetSpConfigExportStatusV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SpConfigV1.SPConfigAPI.GetSpConfigExportV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SpConfigV1.SPConfigAPI.GetSpConfigExportV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SpConfigV1.SPConfigAPI.GetSpConfigImportStatusV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SpConfigV1.SPConfigAPI.GetSpConfigImportStatusV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SpConfigV1.SPConfigAPI.GetSpConfigImportV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SpConfigV1.SPConfigAPI.GetSpConfigImportV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SpConfigV1.SPConfigAPI.ImportSpConfigV1(context.Background()).Data(data).Execute()
	  //resp, r, err := apiClient.SpConfigV1.SPConfigAPI.ImportSpConfigV1(context.Background()).Data(data).Preview(preview).Options(options).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SpConfigV1.SPConfigAPI.ListSpConfigObjectsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SpConfigV1.SPConfigAPI.ListSpConfigObjectsV1(context.Background()).Execute()
    if err != nil {
