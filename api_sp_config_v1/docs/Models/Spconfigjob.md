...
slug: /tools/sdk/go/spconfigv1/models/spconfigjob
...
`func NewSpconfigjob(jobId string, status string, type_ string, created time.Time, modified time.Time, ) *Spconfigjob`
