...
slug: /tools/sdk/go/spconfigv1/models/spconfigexportjob
...
`func NewSpconfigexportjob(jobId string, status string, type_ string, created time.Time, modified time.Time, ) *Spconfigexportjob`
