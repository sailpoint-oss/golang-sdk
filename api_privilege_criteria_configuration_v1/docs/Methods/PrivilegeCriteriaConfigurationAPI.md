...
slug: /tools/sdk/go/privilegecriteriaconfigurationv1/methods/privilege-criteria-configuration
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_privilege_criteria_configuration_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.PrivilegeCriteriaConfigurationV1.PrivilegeCriteriaConfigurationAPI.GetPrivilegeCriteriaConfigV1(context.Background(), criteriaConfigId).Execute()
	  //resp, r, err := apiClient.PrivilegeCriteriaConfigurationV1.PrivilegeCriteriaConfigurationAPI.GetPrivilegeCriteriaConfigV1(context.Background(), criteriaConfigId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.PrivilegeCriteriaConfigurationV1.PrivilegeCriteriaConfigurationAPI.ListPrivilegeCriteriaConfigV1(context.Background()).Filters(filters).Execute()
	  //resp, r, err := apiClient.PrivilegeCriteriaConfigurationV1.PrivilegeCriteriaConfigurationAPI.ListPrivilegeCriteriaConfigV1(context.Background()).Filters(filters).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_privilege_criteria_configuration_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_privilege_criteria_configuration_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.PrivilegeCriteriaConfigurationV1.PrivilegeCriteriaConfigurationAPI.PatchPrivilegeCriteriaConfigV1(context.Background(), criteriaConfigId).RequestBody(requestBody).Execute()
	  //resp, r, err := apiClient.PrivilegeCriteriaConfigurationV1.PrivilegeCriteriaConfigurationAPI.PatchPrivilegeCriteriaConfigV1(context.Background(), criteriaConfigId).RequestBody(requestBody).Execute()
    if err != nil {
