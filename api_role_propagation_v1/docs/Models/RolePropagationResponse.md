...
keywords: ['go', 'Golang', 'sdk', 'RolePropagationResponse', 'V1RolePropagationResponse'] 
slug: /tools/sdk/go/rolepropagationv1/models/role-propagation-response
...
GetRolePropagationIdOk returns a tuple with the RolePropagationId field if it's non-nil, zero value otherwise
