...
func main() {
    ...
    r, err := apiClient.ReportsDataExtraction.ReportsDataExtractionAPI.CancelReportV1(context.Background(), id).Execute()
	  //r, err := apiClient.ReportsDataExtraction.ReportsDataExtractionAPI.CancelReportV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ReportsDataExtraction.ReportsDataExtractionAPI.GetReportResultV1(context.Background(), taskResultId).Execute()
	  //resp, r, err := apiClient.ReportsDataExtraction.ReportsDataExtractionAPI.GetReportResultV1(context.Background(), taskResultId).Completed(completed).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ReportsDataExtraction.ReportsDataExtractionAPI.GetReportV1(context.Background(), taskResultId).FileFormat(fileFormat).Execute()
	  //resp, r, err := apiClient.ReportsDataExtraction.ReportsDataExtractionAPI.GetReportV1(context.Background(), taskResultId).FileFormat(fileFormat).Name(name).Auditable(auditable).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ReportsDataExtraction.ReportsDataExtractionAPI.StartReportV1(context.Background()).Reportdetails(reportdetails).Execute()
	  //resp, r, err := apiClient.ReportsDataExtraction.ReportsDataExtractionAPI.StartReportV1(context.Background()).Reportdetails(reportdetails).Execute()
    if err != nil {
