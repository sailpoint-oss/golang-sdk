...
slug: /tools/sdk/go/rolesv1/methods/roles
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_roles_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_roles_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.RolesV1.RolesAPI.CreateRoleV1(context.Background()).Role(role).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.CreateRoleV1(context.Background()).Role(role).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.DeleteBulkRolesV1(context.Background()).Rolebulkdeleterequest(rolebulkdeleterequest).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.DeleteBulkRolesV1(context.Background()).Rolebulkdeleterequest(rolebulkdeleterequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.RolesV1.RolesAPI.DeleteMetadataFromRoleByKeyAndValueV1(context.Background(), id, attributeKey, attributeValue).Execute()
	  //r, err := apiClient.RolesV1.RolesAPI.DeleteMetadataFromRoleByKeyAndValueV1(context.Background(), id, attributeKey, attributeValue).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.RolesV1.RolesAPI.DeleteRoleV1(context.Background(), id).Execute()
	  //r, err := apiClient.RolesV1.RolesAPI.DeleteRoleV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.GetBulkUpdateStatusByIdV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.GetBulkUpdateStatusByIdV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.GetBulkUpdateStatusV1(context.Background()).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.GetBulkUpdateStatusV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.GetRoleAssignedIdentitiesV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.GetRoleAssignedIdentitiesV1(context.Background(), id).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.GetRoleEntitlementsV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.GetRoleEntitlementsV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.GetRoleV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.GetRoleV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.ListRolesV1(context.Background()).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.ListRolesV1(context.Background()).ForSubadmin(forSubadmin).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).ForSegmentIds(forSegmentIds).IncludeUnsegmented(includeUnsegmented).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.PatchRoleV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.PatchRoleV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.SearchRolesByFilterV1(context.Background()).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.SearchRolesByFilterV1(context.Background()).ForSubadmin(forSubadmin).Limit(limit).Offset(offset).Count(count).Sorters(sorters).ForSegmentIds(forSegmentIds).IncludeUnsegmented(includeUnsegmented).Rolelistfilterdto(rolelistfilterdto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.UpdateAttributeKeyAndValueToRoleV1(context.Background(), id, attributeKey, attributeValue).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.UpdateAttributeKeyAndValueToRoleV1(context.Background(), id, attributeKey, attributeValue).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.UpdateRolesMetadataByFilterV1(context.Background()).Rolemetadatabulkupdatebyfilterrequest(rolemetadatabulkupdatebyfilterrequest).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.UpdateRolesMetadataByFilterV1(context.Background()).Rolemetadatabulkupdatebyfilterrequest(rolemetadatabulkupdatebyfilterrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.UpdateRolesMetadataByIdsV1(context.Background()).Rolemetadatabulkupdatebyidrequest(rolemetadatabulkupdatebyidrequest).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.UpdateRolesMetadataByIdsV1(context.Background()).Rolemetadatabulkupdatebyidrequest(rolemetadatabulkupdatebyidrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.RolesV1.RolesAPI.UpdateRolesMetadataByQueryV1(context.Background()).Rolemetadatabulkupdatebyqueryrequest(rolemetadatabulkupdatebyqueryrequest).Execute()
	  //resp, r, err := apiClient.RolesV1.RolesAPI.UpdateRolesMetadataByQueryV1(context.Background()).Rolemetadatabulkupdatebyqueryrequest(rolemetadatabulkupdatebyqueryrequest).Execute()
    if err != nil {
