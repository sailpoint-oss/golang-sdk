...
slug: /tools/sdk/go/intelligencepackagev1/methods/intelligence-package
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_intelligence_package_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.IntelligencePackageV1.IntelligencePackageAPI.GetIntelIdentityAccessHistoryV1(context.Background(), identityID).Execute()
	  //resp, r, err := apiClient.IntelligencePackageV1.IntelligencePackageAPI.GetIntelIdentityAccessHistoryV1(context.Background(), identityID).Limit(limit).Offset(offset).Count(count).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IntelligencePackageV1.IntelligencePackageAPI.GetIntelIdentityAccessV1(context.Background(), identityID).Execute()
	  //resp, r, err := apiClient.IntelligencePackageV1.IntelligencePackageAPI.GetIntelIdentityAccessV1(context.Background(), identityID).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.IntelligencePackageV1.IntelligencePackageAPI.SearchIntelIdentitiesV1(context.Background()).Filters(filters).Execute()
	  //resp, r, err := apiClient.IntelligencePackageV1.IntelligencePackageAPI.SearchIntelIdentitiesV1(context.Background()).Filters(filters).Execute()
    if err != nil {
