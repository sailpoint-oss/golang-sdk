...
keywords: ['go', 'Golang', 'sdk', 'Intelmachine', 'V1Intelmachine'] 
slug: /tools/sdk/go/intelligencepackagev1/models/intelmachine
tags: ['SDK', 'Software Development Kit', 'Intelmachine', 'V1Intelmachine']
---
...
**Source** | Pointer to [**Intelmachinesource**](intelmachinesource) | Correlated source summary for the machine identity when available. | [optional] 
