...
keywords: ['go', 'Golang', 'sdk', 'DataSegmentation', 'V1DataSegmentation'] 
slug: /tools/sdk/go/datasegmentationv1/methods/data-segmentation
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_data_segmentation_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_data_segmentation_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.CreateDataSegmentV1(context.Background()).DataSegment(dataSegment).Execute()
	  //resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.CreateDataSegmentV1(context.Background()).DataSegment(dataSegment).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.DeleteDataSegmentV1(context.Background(), segmentId).XSailPointExperimental(xSailPointExperimental).Execute()
	  //r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.DeleteDataSegmentV1(context.Background(), segmentId).XSailPointExperimental(xSailPointExperimental).Published(published).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.GetDataSegmentIdentityMembershipV1(context.Background(), identityId).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.GetDataSegmentIdentityMembershipV1(context.Background(), identityId).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.GetDataSegmentV1(context.Background(), segmentId).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.GetDataSegmentV1(context.Background(), segmentId).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.GetDataSegmentationEnabledForUserV1(context.Background(), identityId).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.GetDataSegmentationEnabledForUserV1(context.Background(), identityId).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.ListDataSegmentsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.ListDataSegmentsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Enabled(enabled).Unique(unique).Published(published).Limit(limit).Offset(offset).Count(count).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.PatchDataSegmentV1(context.Background(), segmentId).XSailPointExperimental(xSailPointExperimental).RequestBody(requestBody).Execute()
	  //resp, r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.PatchDataSegmentV1(context.Background(), segmentId).XSailPointExperimental(xSailPointExperimental).RequestBody(requestBody).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.PublishDataSegmentV1(context.Background(), segmentId).XSailPointExperimental(xSailPointExperimental).RequestBody(requestBody).Execute()
	  //r, err := apiClient.DataSegmentationV1.DataSegmentationAPI.PublishDataSegmentV1(context.Background(), segmentId).XSailPointExperimental(xSailPointExperimental).RequestBody(requestBody).PublishAll(publishAll).Execute()
    if err != nil {
