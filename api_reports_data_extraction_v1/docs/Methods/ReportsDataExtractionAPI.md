...
slug: /tools/sdk/go/reportsdataextractionv1/methods/reports-data-extraction
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_reports_data_extraction_v1"
)
...
func main() {
    ...
    r, err := apiClient.ReportsDataExtractionV1.ReportsDataExtractionAPI.CancelReportV1(context.Background(), id).Execute()
	  //r, err := apiClient.ReportsDataExtractionV1.ReportsDataExtractionAPI.CancelReportV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ReportsDataExtractionV1.ReportsDataExtractionAPI.GetReportResultV1(context.Background(), taskResultId).Execute()
	  //resp, r, err := apiClient.ReportsDataExtractionV1.ReportsDataExtractionAPI.GetReportResultV1(context.Background(), taskResultId).Completed(completed).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ReportsDataExtractionV1.ReportsDataExtractionAPI.GetReportV1(context.Background(), taskResultId).FileFormat(fileFormat).Execute()
	  //resp, r, err := apiClient.ReportsDataExtractionV1.ReportsDataExtractionAPI.GetReportV1(context.Background(), taskResultId).FileFormat(fileFormat).Name(name).Auditable(auditable).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_reports_data_extraction_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_reports_data_extraction_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ReportsDataExtractionV1.ReportsDataExtractionAPI.StartReportV1(context.Background()).Reportdetails(reportdetails).Execute()
	  //resp, r, err := apiClient.ReportsDataExtractionV1.ReportsDataExtractionAPI.StartReportV1(context.Background()).Reportdetails(reportdetails).Execute()
    if err != nil {
