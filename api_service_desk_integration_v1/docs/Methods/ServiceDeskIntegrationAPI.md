...
slug: /tools/sdk/go/servicedeskintegrationv1/methods/service-desk-integration
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_service_desk_integration_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_service_desk_integration_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.CreateServiceDeskIntegrationV1(context.Background()).Servicedeskintegrationdto(servicedeskintegrationdto).Execute()
	  //resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.CreateServiceDeskIntegrationV1(context.Background()).Servicedeskintegrationdto(servicedeskintegrationdto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.DeleteServiceDeskIntegrationV1(context.Background(), id).Execute()
	  //r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.DeleteServiceDeskIntegrationV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.GetServiceDeskIntegrationTemplateV1(context.Background(), scriptName).Execute()
	  //resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.GetServiceDeskIntegrationTemplateV1(context.Background(), scriptName).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.GetServiceDeskIntegrationTypesV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.GetServiceDeskIntegrationTypesV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.GetServiceDeskIntegrationV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.GetServiceDeskIntegrationV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.GetServiceDeskIntegrationsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.GetServiceDeskIntegrationsV1(context.Background()).Offset(offset).Limit(limit).Sorters(sorters).Filters(filters).Count(count).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.GetStatusCheckDetailsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.GetStatusCheckDetailsV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.PatchServiceDeskIntegrationV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.PatchServiceDeskIntegrationV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.PutServiceDeskIntegrationV1(context.Background(), id).Servicedeskintegrationdto(servicedeskintegrationdto).Execute()
	  //resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.PutServiceDeskIntegrationV1(context.Background(), id).Servicedeskintegrationdto(servicedeskintegrationdto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.UpdateStatusCheckDetailsV1(context.Background()).Queuedcheckconfigdetails(queuedcheckconfigdetails).Execute()
	  //resp, r, err := apiClient.ServiceDeskIntegrationV1.ServiceDeskIntegrationAPI.UpdateStatusCheckDetailsV1(context.Background()).Queuedcheckconfigdetails(queuedcheckconfigdetails).Execute()
    if err != nil {
