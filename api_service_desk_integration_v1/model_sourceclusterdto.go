...
// checks if the Sourceclusterdto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Sourceclusterdto{}
...
type _Sourceclusterdto Sourceclusterdto
...
func (o *Sourceclusterdto) UnmarshalJSON(data []byte) (err error) {
	varSourceclusterdto := _Sourceclusterdto{}

	err = json.Unmarshal(data, &varSourceclusterdto)
...
type NullableSourceclusterdto struct {
	value *Sourceclusterdto
	isSet bool
}

func (v NullableSourceclusterdto) Get() *Sourceclusterdto {
	return v.value
}

func (v *NullableSourceclusterdto) Set(val *Sourceclusterdto) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSourceclusterdto(val *Sourceclusterdto) *NullableSourceclusterdto {
	return &NullableSourceclusterdto{value: val, isSet: true}
}
