---
id: v1-appaccessprofileselector-account-match-config
...
keywords: ['go', 'Golang', 'sdk', 'AppaccessprofileselectorAccountMatchConfig', 'V1AppaccessprofileselectorAccountMatchConfig'] 
slug: /tools/sdk/go/appsv1/models/appaccessprofileselector-account-match-config
tags: ['SDK', 'Software Development Kit', 'AppaccessprofileselectorAccountMatchConfig', 'V1AppaccessprofileselectorAccountMatchConfig']
---
...
------------ | ------------- | ------------- | -------------
**MatchExpression** | Pointer to [**AppaccessprofileselectorAccountMatchConfigMatchExpression**](appaccessprofileselector-account-match-config-match-expression) |  | [optional] 
