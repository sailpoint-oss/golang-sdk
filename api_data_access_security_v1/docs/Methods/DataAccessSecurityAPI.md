...
slug: /tools/sdk/go/dataaccesssecurityv1/methods/data-access-security
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_data_access_security_v1"
)
...
func main() {
    ...
    r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.CancelTaskV1(context.Background(), id).Execute()
	  //r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.CancelTaskV1(context.Background(), id).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_data_access_security_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_data_access_security_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.CreateApplicationV1(context.Background()).Basecreateapplicationrequest(basecreateapplicationrequest).Execute()
	  //r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.CreateApplicationV1(context.Background()).Basecreateapplicationrequest(basecreateapplicationrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.CreateScheduleV1(context.Background()).Createschedulerequest(createschedulerequest).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.CreateScheduleV1(context.Background()).Createschedulerequest(createschedulerequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DasV1OwnersAssignPost(context.Background()).Assignresourceownerrequest(assignresourceownerrequest).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DasV1OwnersAssignPost(context.Background()).Assignresourceownerrequest(assignresourceownerrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DasV1OwnersOwnerIdentityIdResourcesGet(context.Background(), ownerIdentityId).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DasV1OwnersOwnerIdentityIdResourcesGet(context.Background(), ownerIdentityId).Limit(limit).Offset(offset).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DasV1OwnersReelectPost(context.Background()).Reelectrequest(reelectrequest).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DasV1OwnersReelectPost(context.Background()).Reelectrequest(reelectrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DasV1OwnersResourcesResourceIdGet(context.Background(), resourceId).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DasV1OwnersResourcesResourceIdGet(context.Background(), resourceId).Limit(limit).Offset(offset).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DasV1OwnersSourceIdentityIdReassignDestinationIdentityIdPost(context.Background(), sourceIdentityId, destinationIdentityId).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DasV1OwnersSourceIdentityIdReassignDestinationIdentityIdPost(context.Background(), sourceIdentityId, destinationIdentityId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DeleteApplicationV1(context.Background(), id).Execute()
	  //r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DeleteApplicationV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DeleteScheduleV1(context.Background(), id).Execute()
	  //r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DeleteScheduleV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DeleteTaskV1(context.Background(), id).Execute()
	  //r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.DeleteTaskV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetApplicationV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetApplicationV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetApplicationsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetApplicationsV1(context.Background()).Filters(filters).Limit(limit).Offset(offset).Count(count).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetOwnersV1(context.Background(), appId).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetOwnersV1(context.Background(), appId).Limit(limit).Offset(offset).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetScheduleV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetScheduleV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetSchedulesV1(context.Background()).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetSchedulesV1(context.Background()).Filters(filters).Limit(limit).Offset(offset).Count(count).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetTaskV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetTaskV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetTasksV1(context.Background()).Execute()
	  //resp, r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.GetTasksV1(context.Background()).Filters(filters).Limit(limit).Offset(offset).Count(count).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.PutApplicationV1(context.Background(), id).Basecreateapplicationrequest(basecreateapplicationrequest).Execute()
	  //r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.PutApplicationV1(context.Background(), id).Basecreateapplicationrequest(basecreateapplicationrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.PutScheduleV1(context.Background(), id).Updateschedulerequest(updateschedulerequest).Execute()
	  //r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.PutScheduleV1(context.Background(), id).Updateschedulerequest(updateschedulerequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.StartTaskRerunV1(context.Background(), id).Execute()
	  //r, err := apiClient.DataAccessSecurityV1.DataAccessSecurityAPI.StartTaskRerunV1(context.Background(), id).Execute()
    if err != nil {
