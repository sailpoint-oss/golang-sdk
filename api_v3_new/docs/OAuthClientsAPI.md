...
------------- | ------------- | -------------
[**CreateOauthClient**](OAuthClientsAPI.md#create-oauth-client) | **Post** /oauth-clients | Create OAuth Client
[**DeleteOauthClient**](OAuthClientsAPI.md#delete-oauth-client) | **Delete** /oauth-clients/{id} | Delete OAuth Client
[**GetOauthClient**](OAuthClientsAPI.md#get-oauth-client) | **Get** /oauth-clients/{id} | Get OAuth Client
[**ListOauthClients**](OAuthClientsAPI.md#list-oauth-clients) | **Get** /oauth-clients | List OAuth Clients
[**PatchOauthClient**](OAuthClientsAPI.md#patch-oauth-client) | **Patch** /oauth-clients/{id} | Patch OAuth Client
