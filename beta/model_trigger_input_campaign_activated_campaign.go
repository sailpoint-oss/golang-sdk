...
// checks if the TriggerInputCampaignActivatedCampaign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputCampaignActivatedCampaign{}
...
func (o TriggerInputCampaignActivatedCampaign) ToMap() (map[string]interface{}, error) {
