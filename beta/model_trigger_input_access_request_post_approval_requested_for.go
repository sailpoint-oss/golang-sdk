...
// checks if the TriggerInputAccessRequestPostApprovalRequestedFor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputAccessRequestPostApprovalRequestedFor{}
...
func (o TriggerInputAccessRequestPostApprovalRequestedFor) ToMap() (map[string]interface{}, error) {
