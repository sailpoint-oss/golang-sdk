...
// checks if the TriggerInputAccessRequestPreApproval type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputAccessRequestPreApproval{}
...
func (o TriggerInputAccessRequestPreApproval) ToMap() (map[string]interface{}, error) {
