...
type ApiDeleteNonEmployeeRecordInBulkRequest struct {
	ctx context.Context
	ApiService *NonEmployeeLifecycleManagementApiService
	deleteNonEmployeeRecordInBulkRequest *DeleteNonEmployeeRecordInBulkRequest
}

// Non-Employee bulk delete request body.
func (r ApiDeleteNonEmployeeRecordInBulkRequest) DeleteNonEmployeeRecordInBulkRequest(deleteNonEmployeeRecordInBulkRequest DeleteNonEmployeeRecordInBulkRequest) ApiDeleteNonEmployeeRecordInBulkRequest {
	r.deleteNonEmployeeRecordInBulkRequest = &deleteNonEmployeeRecordInBulkRequest
	return r
}

func (r ApiDeleteNonEmployeeRecordInBulkRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteNonEmployeeRecordInBulkExecute(r)
}

/*
DeleteNonEmployeeRecordInBulk Delete Multiple Non-Employee Records
...
func (a *NonEmployeeLifecycleManagementApiService) DeleteNonEmployeeRecordInBulkExecute(r ApiDeleteNonEmployeeRecordInBulkRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NonEmployeeLifecycleManagementApiService.DeleteNonEmployeeRecordInBulk")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.deleteNonEmployeeRecordInBulkRequest == nil {
		return nil, reportError("deleteNonEmployeeRecordInBulkRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.deleteNonEmployeeRecordInBulkRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
func (r ApiGetNonEmployeeApprovalRequest) IncludeDetail(includeDetail string) ApiGetNonEmployeeApprovalRequest {
...
func (a *NonEmployeeLifecycleManagementApiService) GetNonEmployeeApprovalExecute(r ApiGetNonEmployeeApprovalRequest) (*NonEmployeeApprovalItemDetail, *http.Response, error) {
	...
	if r.includeDetail != nil {
		parameterAddToQuery(localVarQueryParams, "include-detail", r.includeDetail, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiListNonEmployeeApprovalRequest struct {
	ctx context.Context
	ApiService *NonEmployeeLifecycleManagementApiService
	requestedFor *string
	limit *int32
...
func (r ApiListNonEmployeeApprovalRequest) RequestedFor(requestedFor string) ApiListNonEmployeeApprovalRequest {
	r.requestedFor = &requestedFor
	return r
}

// Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
func (r ApiListNonEmployeeApprovalRequest) Limit(limit int32) ApiListNonEmployeeApprovalRequest {
	r.limit = &limit
	return r
}

// Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
func (r ApiListNonEmployeeApprovalRequest) Offset(offset int32) ApiListNonEmployeeApprovalRequest {
	r.offset = &offset
	return r
}

// If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count&#x3D;true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
func (r ApiListNonEmployeeApprovalRequest) Count(count bool) ApiListNonEmployeeApprovalRequest {
	r.count = &count
	return r
}
...
func (r ApiListNonEmployeeApprovalRequest) Filters(filters string) ApiListNonEmployeeApprovalRequest {
	r.filters = &filters
	return r
}
...
func (r ApiListNonEmployeeApprovalRequest) Sorters(sorters string) ApiListNonEmployeeApprovalRequest {
	r.sorters = &sorters
	return r
}

func (r ApiListNonEmployeeApprovalRequest) Execute() ([]NonEmployeeApprovalItem, *http.Response, error) {
	return r.ApiService.ListNonEmployeeApprovalExecute(r)
}
...
func (a *NonEmployeeLifecycleManagementApiService) ListNonEmployeeApprovalExecute(r ApiListNonEmployeeApprovalRequest) ([]NonEmployeeApprovalItem, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NonEmployeeLifecycleManagementApiService.ListNonEmployeeApproval")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *NonEmployeeLifecycleManagementApiService) ListNonEmployeeSourcesExecute(r ApiListNonEmployeeSourcesRequest) ([]NonEmployeeSourceWithNECount, *http.Response, error) {
	...
	parameterAddToQuery(localVarQueryParams, "requested-for", r.requestedFor, "")
	parameterAddToQuery(localVarQueryParams, "non-employee-count", r.nonEmployeeCount, "")
	if r.sorters != nil {
		parameterAddToQuery(localVarQueryParams, "sorters", r.sorters, "")
	}
	// to determine the Content-Type header
