...
// checks if the TriggerInputSourceAccountDeleted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputSourceAccountDeleted{}
...
func (o TriggerInputSourceAccountDeleted) ToMap() (map[string]interface{}, error) {
