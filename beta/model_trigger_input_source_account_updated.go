...
// checks if the TriggerInputSourceAccountUpdated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputSourceAccountUpdated{}

// TriggerInputSourceAccountUpdated struct for TriggerInputSourceAccountUpdated
type TriggerInputSourceAccountUpdated struct {
...
type _TriggerInputSourceAccountUpdated TriggerInputSourceAccountUpdated
...
func NewTriggerInputSourceAccountUpdated(id string, nativeIdentifier string, sourceId string, sourceName string, identityId string, identityName string, attributes map[string]interface{}) *TriggerInputSourceAccountUpdated {
	this := TriggerInputSourceAccountUpdated{}
	this.Id = id
...
func (o TriggerInputSourceAccountUpdated) MarshalJSON() ([]byte, error) {
...
func (o TriggerInputSourceAccountUpdated) ToMap() (map[string]interface{}, error) {
...
func (o *TriggerInputSourceAccountUpdated) UnmarshalJSON(bytes []byte) (err error) {
	varTriggerInputSourceAccountUpdated := _TriggerInputSourceAccountUpdated{}

	if err = json.Unmarshal(bytes, &varTriggerInputSourceAccountUpdated); err == nil {
		*o = TriggerInputSourceAccountUpdated(varTriggerInputSourceAccountUpdated)
	}
...
type NullableTriggerInputSourceAccountUpdated struct {
	value *TriggerInputSourceAccountUpdated
	isSet bool
}

func (v NullableTriggerInputSourceAccountUpdated) Get() *TriggerInputSourceAccountUpdated {
	return v.value
}

func (v *NullableTriggerInputSourceAccountUpdated) Set(val *TriggerInputSourceAccountUpdated) {
	v.value = val
	v.isSet = true
}

func (v NullableTriggerInputSourceAccountUpdated) IsSet() bool {
	return v.isSet
}

func (v *NullableTriggerInputSourceAccountUpdated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTriggerInputSourceAccountUpdated(val *TriggerInputSourceAccountUpdated) *NullableTriggerInputSourceAccountUpdated {
	return &NullableTriggerInputSourceAccountUpdated{value: val, isSet: true}
}

func (v NullableTriggerInputSourceAccountUpdated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTriggerInputSourceAccountUpdated) UnmarshalJSON(src []byte) error {
	v.isSet = true
