...
// checks if the TriggerInputAccountAggregationCompleted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputAccountAggregationCompleted{}
...
func (o TriggerInputAccountAggregationCompleted) ToMap() (map[string]interface{}, error) {
