...
// checks if the TriggerInputIdentityAttributesChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputIdentityAttributesChanged{}
...
func (o TriggerInputIdentityAttributesChanged) ToMap() (map[string]interface{}, error) {
