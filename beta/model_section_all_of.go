...
// checks if the SectionAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SectionAllOf{}
...
func (o SectionAllOf) ToMap() (map[string]interface{}, error) {
