...
// checks if the ServiceDeskIntegrationDtoAllOfClusterRef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDeskIntegrationDtoAllOfClusterRef{}
...
func (o ServiceDeskIntegrationDtoAllOfClusterRef) ToMap() (map[string]interface{}, error) {
