...
// checks if the TriggerInputSourceDeleted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputSourceDeleted{}
...
func (o TriggerInputSourceDeleted) ToMap() (map[string]interface{}, error) {
