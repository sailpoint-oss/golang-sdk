...
// AccountAttributesChangedIdentity The identity whose account attributes changed.
...
func (o *AccountAttributesChangedIdentity) UnmarshalJSON(bytes []byte) (err error) {
	varAccountAttributesChangedIdentity := _AccountAttributesChangedIdentity{}

	if err = json.Unmarshal(bytes, &varAccountAttributesChangedIdentity); err == nil {
