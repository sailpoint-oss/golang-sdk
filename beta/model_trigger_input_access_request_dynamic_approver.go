...
// checks if the TriggerInputAccessRequestDynamicApprover type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputAccessRequestDynamicApprover{}
...
func (o TriggerInputAccessRequestDynamicApprover) ToMap() (map[string]interface{}, error) {
