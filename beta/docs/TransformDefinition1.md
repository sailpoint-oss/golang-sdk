...
**Attributes** | Pointer to [**map[string]TransformDefinition1AttributesValue**](TransformDefinition1AttributesValue.md) | Arbitrary key-value pairs to store any metadata for the object | [optional] 
