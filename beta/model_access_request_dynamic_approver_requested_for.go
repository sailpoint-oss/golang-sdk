...
type _AccessRequestDynamicApproverRequestedFor AccessRequestDynamicApproverRequestedFor
...
func NewAccessRequestDynamicApproverRequestedFor() *AccessRequestDynamicApproverRequestedFor {
	this := AccessRequestDynamicApproverRequestedFor{}
	return &this
}
...
func (o AccessRequestDynamicApproverRequestedFor) MarshalJSON() ([]byte, error) {
...
func (o AccessRequestDynamicApproverRequestedFor) ToMap() (map[string]interface{}, error) {
...
func (o *AccessRequestDynamicApproverRequestedFor) UnmarshalJSON(bytes []byte) (err error) {
	varAccessRequestDynamicApproverRequestedFor := _AccessRequestDynamicApproverRequestedFor{}

	if err = json.Unmarshal(bytes, &varAccessRequestDynamicApproverRequestedFor); err == nil {
		*o = AccessRequestDynamicApproverRequestedFor(varAccessRequestDynamicApproverRequestedFor)
	}
...
type NullableAccessRequestDynamicApproverRequestedFor struct {
	value *AccessRequestDynamicApproverRequestedFor
	isSet bool
}

func (v NullableAccessRequestDynamicApproverRequestedFor) Get() *AccessRequestDynamicApproverRequestedFor {
	return v.value
}

func (v *NullableAccessRequestDynamicApproverRequestedFor) Set(val *AccessRequestDynamicApproverRequestedFor) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessRequestDynamicApproverRequestedFor) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessRequestDynamicApproverRequestedFor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessRequestDynamicApproverRequestedFor(val *AccessRequestDynamicApproverRequestedFor) *NullableAccessRequestDynamicApproverRequestedFor {
	return &NullableAccessRequestDynamicApproverRequestedFor{value: val, isSet: true}
}

func (v NullableAccessRequestDynamicApproverRequestedFor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessRequestDynamicApproverRequestedFor) UnmarshalJSON(src []byte) error {
	v.isSet = true
