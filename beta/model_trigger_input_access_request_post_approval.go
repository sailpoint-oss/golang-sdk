...
// checks if the TriggerInputAccessRequestPostApproval type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputAccessRequestPostApproval{}
...
func (o TriggerInputAccessRequestPostApproval) ToMap() (map[string]interface{}, error) {
