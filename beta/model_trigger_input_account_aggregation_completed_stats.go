...
// checks if the TriggerInputAccountAggregationCompletedStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputAccountAggregationCompletedStats{}
...
func (o TriggerInputAccountAggregationCompletedStats) ToMap() (map[string]interface{}, error) {
