...
// checks if the TriggerInputAccountCorrelatedSource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputAccountCorrelatedSource{}
...
func (o TriggerInputAccountCorrelatedSource) ToMap() (map[string]interface{}, error) {
