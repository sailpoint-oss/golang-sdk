...
// checks if the TriggerInputSourceAccountCreated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputSourceAccountCreated{}
...
func (o TriggerInputSourceAccountCreated) ToMap() (map[string]interface{}, error) {
