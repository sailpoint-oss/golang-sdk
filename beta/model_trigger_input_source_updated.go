...
// checks if the TriggerInputSourceUpdated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInputSourceUpdated{}
...
func (o TriggerInputSourceUpdated) ToMap() (map[string]interface{}, error) {
