...
slug: /tools/sdk/go/sodpoliciesv1/methods/sod-policies
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_sod_policies_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_sod_policies_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.CreateSodPolicyV1(context.Background()).Sodpolicy(sodpolicy).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.CreateSodPolicyV1(context.Background()).Sodpolicy(sodpolicy).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.DeleteSodPolicyScheduleV1(context.Background(), id).Execute()
	  //r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.DeleteSodPolicyScheduleV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.DeleteSodPolicyV1(context.Background(), id).Execute()
	  //r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.DeleteSodPolicyV1(context.Background(), id).Logical(logical).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetCustomViolationReportV1(context.Background(), reportResultId, fileName).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetCustomViolationReportV1(context.Background(), reportResultId, fileName).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetDefaultViolationReportV1(context.Background(), reportResultId).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetDefaultViolationReportV1(context.Background(), reportResultId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetSodAllReportRunStatusV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetSodAllReportRunStatusV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetSodPolicyScheduleV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetSodPolicyScheduleV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetSodPolicyV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetSodPolicyV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetSodViolationReportRunStatusV1(context.Background(), reportResultId).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetSodViolationReportRunStatusV1(context.Background(), reportResultId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetSodViolationReportStatusV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.GetSodViolationReportStatusV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.ListSodPoliciesV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.ListSodPoliciesV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.PatchSodPolicyV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.PatchSodPolicyV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.PutPolicyScheduleV1(context.Background(), id).Sodpolicyschedule(sodpolicyschedule).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.PutPolicyScheduleV1(context.Background(), id).Sodpolicyschedule(sodpolicyschedule).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.PutSodPolicyV1(context.Background(), id).Sodpolicy(sodpolicy).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.PutSodPolicyV1(context.Background(), id).Sodpolicy(sodpolicy).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.StartEvaluateSodPolicyV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.StartEvaluateSodPolicyV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.StartSodAllPoliciesForOrgV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.StartSodAllPoliciesForOrgV1(context.Background()).Multipolicyrequest(multipolicyrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.StartSodPolicyV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SodPoliciesV1.SODPoliciesAPI.StartSodPolicyV1(context.Background(), id).Execute()
    if err != nil {
