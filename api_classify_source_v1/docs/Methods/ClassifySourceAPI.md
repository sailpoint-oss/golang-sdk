...
slug: /tools/sdk/go/classifysourcev1/methods/classify-source
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_classify_source_v1"
)
...
func main() {
    ...
    r, err := apiClient.ClassifySourceV1.ClassifySourceAPI.DeleteClassifyMachineAccountFromSourceV1(context.Background(), sourceId).Execute()
	  //r, err := apiClient.ClassifySourceV1.ClassifySourceAPI.DeleteClassifyMachineAccountFromSourceV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ClassifySourceV1.ClassifySourceAPI.GetClassifyMachineAccountFromSourceStatusV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.ClassifySourceV1.ClassifySourceAPI.GetClassifyMachineAccountFromSourceStatusV1(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ClassifySourceV1.ClassifySourceAPI.SendClassifyMachineAccountFromSourceV1(context.Background(), sourceId).Execute()
	  //resp, r, err := apiClient.ClassifySourceV1.ClassifySourceAPI.SendClassifyMachineAccountFromSourceV1(context.Background(), sourceId).Execute()
    if err != nil {
