...
slug: /tools/sdk/go/authprofilev1/methods/auth-profile
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_auth_profile_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.AuthProfileV1.AuthProfileAPI.GetProfileConfigListV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.AuthProfileV1.AuthProfileAPI.GetProfileConfigListV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.AuthProfileV1.AuthProfileAPI.GetProfileConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.AuthProfileV1.AuthProfileAPI.GetProfileConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_auth_profile_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_auth_profile_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.AuthProfileV1.AuthProfileAPI.PatchProfileConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.AuthProfileV1.AuthProfileAPI.PatchProfileConfigV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
