...
// APIClient manages communication with the Identity Security Cloud API - Public Machine Identities API vv1
...
type APIClient struct {
	...
	PublicMachineIdentitiesAPI *PublicMachineIdentitiesAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.PublicMachineIdentitiesAPI = (*PublicMachineIdentitiesAPIService)(&c.common)
...
func (c *APIClient) prepareRequest(
	...
	userAgent := "SailPoint-SDK-Go/1.0.0"
	if c.cfg.UserAgent != "" {
