...
// APIClient manages communication with the Identity Security Cloud API - SOD Controls API vv1
...
type APIClient struct {
	...
	SODControlsAPI *SODControlsAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.SODControlsAPI = (*SODControlsAPIService)(&c.common)
