...
slug: /tools/sdk/go/machineaccountclassifyv1/methods/machine-account-classify
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_machine_account_classify_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.MachineAccountClassifyV1.MachineAccountClassifyAPI.SendClassifyMachineAccountV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.MachineAccountClassifyV1.MachineAccountClassifyAPI.SendClassifyMachineAccountV1(context.Background(), id).ClassificationMode(classificationMode).Execute()
    if err != nil {
