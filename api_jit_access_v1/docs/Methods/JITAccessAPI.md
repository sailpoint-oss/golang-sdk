...
slug: /tools/sdk/go/jitaccessv1/methods/jit-access
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_jit_access_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.JitAccessV1.JITAccessAPI.GetJitActivationConfigV1(context.Background(), configType).Execute()
	  //resp, r, err := apiClient.JitAccessV1.JITAccessAPI.GetJitActivationConfigV1(context.Background(), configType).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_jit_access_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_jit_access_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.JitAccessV1.JITAccessAPI.PatchJitActivationConfigV1(context.Background(), configType).Jitaccessoperationrequest(jitaccessoperationrequest).Execute()
	  //resp, r, err := apiClient.JitAccessV1.JITAccessAPI.PatchJitActivationConfigV1(context.Background(), configType).Jitaccessoperationrequest(jitaccessoperationrequest).Execute()
    if err != nil {
