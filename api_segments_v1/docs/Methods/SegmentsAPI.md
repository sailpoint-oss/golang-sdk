...
slug: /tools/sdk/go/segmentsv1/methods/segments
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_segments_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_segments_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.SegmentsV1.SegmentsAPI.CreateSegmentV1(context.Background()).Segment(segment).Execute()
	  //resp, r, err := apiClient.SegmentsV1.SegmentsAPI.CreateSegmentV1(context.Background()).Segment(segment).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.SegmentsV1.SegmentsAPI.DeleteSegmentV1(context.Background(), id).Execute()
	  //r, err := apiClient.SegmentsV1.SegmentsAPI.DeleteSegmentV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SegmentsV1.SegmentsAPI.GetSegmentV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.SegmentsV1.SegmentsAPI.GetSegmentV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SegmentsV1.SegmentsAPI.ListSegmentsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SegmentsV1.SegmentsAPI.ListSegmentsV1(context.Background()).Limit(limit).Offset(offset).Count(count).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SegmentsV1.SegmentsAPI.PatchSegmentV1(context.Background(), id).RequestBody(requestBody).Execute()
	  //resp, r, err := apiClient.SegmentsV1.SegmentsAPI.PatchSegmentV1(context.Background(), id).RequestBody(requestBody).Execute()
    if err != nil {
