...
slug: /tools/sdk/go/sodviolationsv1/methods/sod-violations
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_sod_violations_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_sod_violations_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.SodViolationsV1.SODViolationsAPI.StartPredictSodViolationsV1(context.Background()).Identitywithnewaccess(identitywithnewaccess).Execute()
	  //resp, r, err := apiClient.SodViolationsV1.SODViolationsAPI.StartPredictSodViolationsV1(context.Background()).Identitywithnewaccess(identitywithnewaccess).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SodViolationsV1.SODViolationsAPI.StartViolationCheckV1(context.Background()).Identitywithnewaccess(identitywithnewaccess).Execute()
	  //resp, r, err := apiClient.SodViolationsV1.SODViolationsAPI.StartViolationCheckV1(context.Background()).Identitywithnewaccess(identitywithnewaccess).Execute()
    if err != nil {
