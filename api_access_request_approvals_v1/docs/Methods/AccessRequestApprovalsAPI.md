...
slug: /tools/sdk/go/accessrequestapprovalsv1/methods/access-request-approvals
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_access_request_approvals_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.ApproveAccessRequestV1(context.Background(), approvalId).Execute()
	  //resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.ApproveAccessRequestV1(context.Background(), approvalId).Commentdto(commentdto).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_access_request_approvals_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_access_request_approvals_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.ForwardAccessRequestV1(context.Background(), approvalId).Forwardapprovaldto(forwardapprovaldto).Execute()
	  //resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.ForwardAccessRequestV1(context.Background(), approvalId).Forwardapprovaldto(forwardapprovaldto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.GetAccessRequestApprovalSummaryV1(context.Background()).Execute()
	  //resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.GetAccessRequestApprovalSummaryV1(context.Background()).OwnerId(ownerId).FromDate(fromDate).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.ListAccessRequestApproversV1(context.Background(), accessRequestId).Execute()
	  //resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.ListAccessRequestApproversV1(context.Background(), accessRequestId).Limit(limit).Offset(offset).Count(count).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.ListCompletedApprovalsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.ListCompletedApprovalsV1(context.Background()).OwnerId(ownerId).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.ListPendingApprovalsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.ListPendingApprovalsV1(context.Background()).OwnerId(ownerId).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.RejectAccessRequestV1(context.Background(), approvalId).Commentdto(commentdto).Execute()
	  //resp, r, err := apiClient.AccessRequestApprovalsV1.AccessRequestApprovalsAPI.RejectAccessRequestV1(context.Background(), approvalId).Commentdto(commentdto).Execute()
    if err != nil {
