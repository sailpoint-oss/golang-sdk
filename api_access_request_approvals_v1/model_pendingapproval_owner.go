...
// checks if the PendingapprovalOwner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PendingapprovalOwner{}
...
type _PendingapprovalOwner PendingapprovalOwner
...
func (o *PendingapprovalOwner) UnmarshalJSON(data []byte) (err error) {
	varPendingapprovalOwner := _PendingapprovalOwner{}

	err = json.Unmarshal(data, &varPendingapprovalOwner)
...
type NullablePendingapprovalOwner struct {
	value *PendingapprovalOwner
	isSet bool
}

func (v NullablePendingapprovalOwner) Get() *PendingapprovalOwner {
	return v.value
}

func (v *NullablePendingapprovalOwner) Set(val *PendingapprovalOwner) {
	v.value = val
	v.isSet = true
}

func (v NullablePendingapprovalOwner) IsSet() bool {
	return v.isSet
}
...
func NewNullablePendingapprovalOwner(val *PendingapprovalOwner) *NullablePendingapprovalOwner {
	return &NullablePendingapprovalOwner{value: val, isSet: true}
}
