...
// checks if the Accessitemreviewedby type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Accessitemreviewedby{}
...
type _Accessitemreviewedby Accessitemreviewedby
...
func (o *Accessitemreviewedby) UnmarshalJSON(data []byte) (err error) {
	varAccessitemreviewedby := _Accessitemreviewedby{}

	err = json.Unmarshal(data, &varAccessitemreviewedby)

	if err != nil {
		return err
	}

	*o = Accessitemreviewedby(varAccessitemreviewedby)
...
type NullableAccessitemreviewedby struct {
	value *Accessitemreviewedby
	isSet bool
}

func (v NullableAccessitemreviewedby) Get() *Accessitemreviewedby {
	return v.value
}

func (v *NullableAccessitemreviewedby) Set(val *Accessitemreviewedby) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessitemreviewedby) IsSet() bool {
	return v.isSet
}
...
func NewNullableAccessitemreviewedby(val *Accessitemreviewedby) *NullableAccessitemreviewedby {
	return &NullableAccessitemreviewedby{value: val, isSet: true}
}
