...
// checks if the Requestableobjectreference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Requestableobjectreference{}
...
func (o *Requestableobjectreference) UnmarshalJSON(data []byte) (err error) {
	varRequestableobjectreference := _Requestableobjectreference{}

	err = json.Unmarshal(data, &varRequestableobjectreference)
