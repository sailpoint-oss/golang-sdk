...
// checks if the Sodpolicydto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Sodpolicydto{}
...
type _Sodpolicydto Sodpolicydto
...
func (o *Sodpolicydto) UnmarshalJSON(data []byte) (err error) {
	varSodpolicydto := _Sodpolicydto{}

	err = json.Unmarshal(data, &varSodpolicydto)

	if err != nil {
		return err
	}

	*o = Sodpolicydto(varSodpolicydto)
...
func (v NullableSodpolicydto) Get() *Sodpolicydto {
	return v.value
}
...
func NewNullableSodpolicydto(val *Sodpolicydto) *NullableSodpolicydto {
	return &NullableSodpolicydto{value: val, isSet: true}
}
