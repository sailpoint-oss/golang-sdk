...
slug: /tools/sdk/go/lifecyclestatesv1/methods/lifecycle-states
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_lifecycle_states_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_lifecycle_states_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.CreateLifecycleStateV1(context.Background(), identityProfileId).Lifecyclestate(lifecyclestate).Execute()
	  //resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.CreateLifecycleStateV1(context.Background(), identityProfileId).Lifecyclestate(lifecyclestate).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.DeleteLifecycleStateV1(context.Background(), identityProfileId, lifecycleStateId).Execute()
	  //resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.DeleteLifecycleStateV1(context.Background(), identityProfileId, lifecycleStateId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.GetLifecycleStateV1(context.Background(), identityProfileId, lifecycleStateId).Execute()
	  //resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.GetLifecycleStateV1(context.Background(), identityProfileId, lifecycleStateId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.GetLifecycleStatesV1(context.Background(), identityProfileId).Execute()
	  //resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.GetLifecycleStatesV1(context.Background(), identityProfileId).Limit(limit).Offset(offset).Count(count).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.SetLifecycleStateV1(context.Background(), identityId).SetLifecycleStateV1Request(setLifecycleStateV1Request).Execute()
	  //resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.SetLifecycleStateV1(context.Background(), identityId).SetLifecycleStateV1Request(setLifecycleStateV1Request).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.UpdateLifecycleStatesV1(context.Background(), identityProfileId, lifecycleStateId).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.LifecycleStatesV1.LifecycleStatesAPI.UpdateLifecycleStatesV1(context.Background(), identityProfileId, lifecycleStateId).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
