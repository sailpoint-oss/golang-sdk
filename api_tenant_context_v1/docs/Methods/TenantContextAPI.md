...
slug: /tools/sdk/go/tenantcontextv1/methods/tenant-context
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_tenant_context_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.TenantContextV1.TenantContextAPI.GetTenantContextV1(context.Background()).Execute()
	  //resp, r, err := apiClient.TenantContextV1.TenantContextAPI.GetTenantContextV1(context.Background()).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_tenant_context_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_tenant_context_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.TenantContextV1.TenantContextAPI.PatchTenantContextV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //r, err := apiClient.TenantContextV1.TenantContextAPI.PatchTenantContextV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
