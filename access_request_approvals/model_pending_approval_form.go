...
// checks if the PendingApprovalForm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PendingApprovalForm{}

// PendingApprovalForm struct for PendingApprovalForm
type PendingApprovalForm struct {
...
type _PendingApprovalForm PendingApprovalForm
...
func (o *PendingApprovalForm) SetFormDefinitionIdNil() {
...
func (o *PendingApprovalForm) SetFormInstanceIdNil() {
...
func (o PendingApprovalForm) MarshalJSON() ([]byte, error) {
...
func (o PendingApprovalForm) ToMap() (map[string]interface{}, error) {
...
func (o *PendingApprovalForm) UnmarshalJSON(data []byte) (err error) {
	varPendingApprovalForm := _PendingApprovalForm{}

	err = json.Unmarshal(data, &varPendingApprovalForm)

	if err != nil {
		return err
	}

	*o = PendingApprovalForm(varPendingApprovalForm)
...
type NullablePendingApprovalForm struct {
	value *PendingApprovalForm
	isSet bool
}

func (v NullablePendingApprovalForm) Get() *PendingApprovalForm {
	return v.value
}

func (v *NullablePendingApprovalForm) Set(val *PendingApprovalForm) {
	v.value = val
	v.isSet = true
}

func (v NullablePendingApprovalForm) IsSet() bool {
	return v.isSet
}

func (v *NullablePendingApprovalForm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePendingApprovalForm(val *PendingApprovalForm) *NullablePendingApprovalForm {
	return &NullablePendingApprovalForm{value: val, isSet: true}
}

func (v NullablePendingApprovalForm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePendingApprovalForm) UnmarshalJSON(src []byte) error {
	v.isSet = true
