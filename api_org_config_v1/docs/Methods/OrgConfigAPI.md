...
slug: /tools/sdk/go/orgconfigv1/methods/org-config
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_org_config_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.OrgConfigV1.OrgConfigAPI.GetOrgConfigV1(context.Background()).Execute()
	  //resp, r, err := apiClient.OrgConfigV1.OrgConfigAPI.GetOrgConfigV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.OrgConfigV1.OrgConfigAPI.GetValidTimeZonesV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.OrgConfigV1.OrgConfigAPI.GetValidTimeZonesV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Limit(limit).Offset(offset).Count(count).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_org_config_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_org_config_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.OrgConfigV1.OrgConfigAPI.PatchOrgConfigV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.OrgConfigV1.OrgConfigAPI.PatchOrgConfigV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
