...
func main() {
    ...
    resp, r, err := apiClient.ApiUsage.ApiUsageAPI.GetTotalCountV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.ApiUsage.ApiUsageAPI.GetTotalCountV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ApiUsage.ApiUsageAPI.ListApiSummaryV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.ApiUsage.ApiUsageAPI.ListApiSummaryV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Filters(filters).Limit(limit).Offset(offset).Execute()
    if err != nil {
