...
keywords: ['go', 'Golang', 'sdk', 'AccountAggregations', 'V1AccountAggregations'] 
slug: /tools/sdk/go/accountaggregationsv1/methods/account-aggregations
...
Other parameters are passed through a pointer to a apiGetAccountAggregationStatusV1Request struct via the builder pattern
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_account_aggregations_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.AccountAggregationsV1.AccountAggregationsAPI.GetAccountAggregationStatusV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.AccountAggregationsV1.AccountAggregationsAPI.GetAccountAggregationStatusV1(context.Background(), id).Execute()
    if err != nil {
