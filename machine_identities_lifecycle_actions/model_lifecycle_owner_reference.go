...
// checks if the LifecycleOwnerReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LifecycleOwnerReference{}

// LifecycleOwnerReference struct for LifecycleOwnerReference
...
type _LifecycleOwnerReference LifecycleOwnerReference
...
func (o LifecycleOwnerReference) MarshalJSON() ([]byte, error) {
...
func (o LifecycleOwnerReference) ToMap() (map[string]interface{}, error) {
...
func (o *LifecycleOwnerReference) UnmarshalJSON(data []byte) (err error) {
	varLifecycleOwnerReference := _LifecycleOwnerReference{}

	err = json.Unmarshal(data, &varLifecycleOwnerReference)

	if err != nil {
		return err
	}

	*o = LifecycleOwnerReference(varLifecycleOwnerReference)
...
type NullableLifecycleOwnerReference struct {
	value *LifecycleOwnerReference
	isSet bool
}

func (v NullableLifecycleOwnerReference) Get() *LifecycleOwnerReference {
	return v.value
}

func (v *NullableLifecycleOwnerReference) Set(val *LifecycleOwnerReference) {
	v.value = val
	v.isSet = true
}

func (v NullableLifecycleOwnerReference) IsSet() bool {
	return v.isSet
}

func (v *NullableLifecycleOwnerReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLifecycleOwnerReference(val *LifecycleOwnerReference) *NullableLifecycleOwnerReference {
	return &NullableLifecycleOwnerReference{value: val, isSet: true}
}

func (v NullableLifecycleOwnerReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLifecycleOwnerReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
