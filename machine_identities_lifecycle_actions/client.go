...
// APIClient manages communication with the Identity Security Cloud API - Machine Identity Lifecycle Actions API vv1
...
type APIClient struct {
	...
	MachineIdentityLifecycleActionsAPI *MachineIdentityLifecycleActionsAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.MachineIdentityLifecycleActionsAPI = (*MachineIdentityLifecycleActionsAPIService)(&c.common)
