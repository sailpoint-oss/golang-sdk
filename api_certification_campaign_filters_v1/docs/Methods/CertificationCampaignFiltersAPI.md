...
slug: /tools/sdk/go/certificationcampaignfiltersv1/methods/certification-campaign-filters
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_certification_campaign_filters_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_certification_campaign_filters_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.CertificationCampaignFiltersV1.CertificationCampaignFiltersAPI.CreateCampaignFilterV1(context.Background()).Campaignfilterdetails(campaignfilterdetails).Execute()
	  //resp, r, err := apiClient.CertificationCampaignFiltersV1.CertificationCampaignFiltersAPI.CreateCampaignFilterV1(context.Background()).Campaignfilterdetails(campaignfilterdetails).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.CertificationCampaignFiltersV1.CertificationCampaignFiltersAPI.DeleteCampaignFiltersV1(context.Background()).RequestBody(requestBody).Execute()
	  //r, err := apiClient.CertificationCampaignFiltersV1.CertificationCampaignFiltersAPI.DeleteCampaignFiltersV1(context.Background()).RequestBody(requestBody).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CertificationCampaignFiltersV1.CertificationCampaignFiltersAPI.GetCampaignFilterByIdV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.CertificationCampaignFiltersV1.CertificationCampaignFiltersAPI.GetCampaignFilterByIdV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CertificationCampaignFiltersV1.CertificationCampaignFiltersAPI.ListCampaignFiltersV1(context.Background()).Execute()
	  //resp, r, err := apiClient.CertificationCampaignFiltersV1.CertificationCampaignFiltersAPI.ListCampaignFiltersV1(context.Background()).Limit(limit).Start(start).IncludeSystemFilters(includeSystemFilters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CertificationCampaignFiltersV1.CertificationCampaignFiltersAPI.UpdateCampaignFilterV1(context.Background(), id).Campaignfilterdetails(campaignfilterdetails).Execute()
	  //resp, r, err := apiClient.CertificationCampaignFiltersV1.CertificationCampaignFiltersAPI.UpdateCampaignFilterV1(context.Background(), id).Campaignfilterdetails(campaignfilterdetails).Execute()
    if err != nil {
