...
slug: /tools/sdk/go/managedclustersv1/methods/managed-clusters
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_managed_clusters_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_managed_clusters_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.CreateManagedClusterV1(context.Background()).Managedclusterrequest(managedclusterrequest).Execute()
	  //resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.CreateManagedClusterV1(context.Background()).Managedclusterrequest(managedclusterrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.DeleteManagedClusterV1(context.Background(), id).Execute()
	  //r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.DeleteManagedClusterV1(context.Background(), id).RemoveClients(removeClients).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.GetClientLogConfigurationV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.GetClientLogConfigurationV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.GetManagedClusterV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.GetManagedClusterV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.GetManagedClustersV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.GetManagedClustersV1(context.Background()).Offset(offset).Limit(limit).Count(count).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.PutClientLogConfigurationV1(context.Background(), id).PutClientLogConfigurationV1Request(putClientLogConfigurationV1Request).Execute()
	  //resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.PutClientLogConfigurationV1(context.Background(), id).PutClientLogConfigurationV1Request(putClientLogConfigurationV1Request).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.UpdateManagedClusterV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.UpdateManagedClusterV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.UpdateV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ManagedClustersV1.ManagedClustersAPI.UpdateV1(context.Background(), id).Execute()
    if err != nil {
