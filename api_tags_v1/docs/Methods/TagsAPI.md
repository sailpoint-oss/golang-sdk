...
slug: /tools/sdk/go/tagsv1/methods/tags
...
func main() {
    ...
    resp, r, err := apiClient.TagsV1.TagsAPI.CreateTagV1(context.Background()).Tag2(tag2).Execute()
	  //resp, r, err := apiClient.TagsV1.TagsAPI.CreateTagV1(context.Background()).Tag2(tag2).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.TagsV1.TagsAPI.DeleteTagByIdV1(context.Background(), id).Execute()
	  //r, err := apiClient.TagsV1.TagsAPI.DeleteTagByIdV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TagsV1.TagsAPI.GetTagByIdV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.TagsV1.TagsAPI.GetTagByIdV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TagsV1.TagsAPI.ListTagsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.TagsV1.TagsAPI.ListTagsV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
