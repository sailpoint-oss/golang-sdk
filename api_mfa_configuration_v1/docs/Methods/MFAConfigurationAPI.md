...
slug: /tools/sdk/go/mfaconfigurationv1/methods/mfa-configuration
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_mfa_configuration_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.GetMFADuoConfigV1(context.Background()).Execute()
	  //resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.GetMFADuoConfigV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.GetMFAKbaConfigV1(context.Background()).Execute()
	  //resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.GetMFAKbaConfigV1(context.Background()).AllLanguages(allLanguages).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.GetMFAOktaConfigV1(context.Background()).Execute()
	  //resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.GetMFAOktaConfigV1(context.Background()).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_mfa_configuration_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_mfa_configuration_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.SetMFADuoConfigV1(context.Background()).Mfaduoconfig(mfaduoconfig).Execute()
	  //resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.SetMFADuoConfigV1(context.Background()).Mfaduoconfig(mfaduoconfig).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.SetMFAKBAConfigV1(context.Background()).Kbaanswerrequestitem(kbaanswerrequestitem).Execute()
	  //resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.SetMFAKBAConfigV1(context.Background()).Kbaanswerrequestitem(kbaanswerrequestitem).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.SetMFAOktaConfigV1(context.Background()).Mfaoktaconfig(mfaoktaconfig).Execute()
	  //resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.SetMFAOktaConfigV1(context.Background()).Mfaoktaconfig(mfaoktaconfig).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.TestMFAConfigV1(context.Background(), method).Execute()
	  //resp, r, err := apiClient.MfaConfigurationV1.MFAConfigurationAPI.TestMFAConfigV1(context.Background(), method).Execute()
    if err != nil {
