...
slug: /tools/sdk/go/parameterstoragev1/methods/parameter-storage
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_parameter_storage_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.CreateParameterV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.CreateParameterV1(context.Background()).Parameterstoragenewparameter(parameterstoragenewparameter).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.DeleteParameterV1(context.Background(), id).Execute()
	  //r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.DeleteParameterV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.GetAttestationDocumentV1(context.Background()).Key(key).Execute()
	  //resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.GetAttestationDocumentV1(context.Background()).Key(key).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.GetParameterReferencesV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.GetParameterReferencesV1(context.Background(), id).Sorters(sorters).Limit(limit).Offset(offset).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.GetParameterStorageSpecificationV1(context.Background()).Execute()
	  //r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.GetParameterStorageSpecificationV1(context.Background()).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.GetParameterV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.GetParameterV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.SearchParametersV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.SearchParametersV1(context.Background()).Filters(filters).Sorters(sorters).Offset(offset).Limit(limit).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.UpdateParameterV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ParameterStorageV1.ParameterStorageAPI.UpdateParameterV1(context.Background(), id).Parameterstorageupdateparameter(parameterstorageupdateparameter).Execute()
    if err != nil {
