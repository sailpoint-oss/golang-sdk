...
type ApiGetRolePropagationConfigRequest struct {
	ctx context.Context
	ApiService *RolePropagationAPIService
	xSailPointExperimental *string
}
...
// Use this header to enable this experimental API.
func (r ApiGetRolePropagationConfigRequest) XSailPointExperimental(xSailPointExperimental string) ApiGetRolePropagationConfigRequest {
	r.xSailPointExperimental = &xSailPointExperimental
	return r
}

func (r ApiGetRolePropagationConfigRequest) Execute() (*RolePropagationConfigResponse, *http.Response, error) {
	return r.ApiService.GetRolePropagationConfigExecute(r)
}

/*
GetRolePropagationConfig Get Role Change Propagation Configuration

This endpoint fetches the Role Change Propagation Configuration for the tenant

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetRolePropagationConfigRequest
*/
func (a *RolePropagationAPIService) GetRolePropagationConfig(ctx context.Context) ApiGetRolePropagationConfigRequest {
	return ApiGetRolePropagationConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *RolePropagationAPIService) GetRolePropagationConfigExecute(r ApiGetRolePropagationConfigRequest) (*RolePropagationConfigResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RolePropagationAPIService.GetRolePropagationConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/role-propagation-config"
...
type ApiSetRolePropagationConfigRequest struct {
	ctx context.Context
	ApiService *RolePropagationAPIService
	xSailPointExperimental *string
...
// Use this header to enable this experimental API.
func (r ApiSetRolePropagationConfigRequest) XSailPointExperimental(xSailPointExperimental string) ApiSetRolePropagationConfigRequest {
	r.xSailPointExperimental = &xSailPointExperimental
	return r
}

func (r ApiSetRolePropagationConfigRequest) RolePropagationConfigInput(rolePropagationConfigInput RolePropagationConfigInput) ApiSetRolePropagationConfigRequest {
	r.rolePropagationConfigInput = &rolePropagationConfigInput
	return r
}

func (r ApiSetRolePropagationConfigRequest) Execute() (*RolePropagationConfigResponse, *http.Response, error) {
	return r.ApiService.SetRolePropagationConfigExecute(r)
}

/*
SetRolePropagationConfig Update Role Change Propagation Configuration

This endpoint enables or disables the Role Change Propagation Process for the tenant

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSetRolePropagationConfigRequest
*/
func (a *RolePropagationAPIService) SetRolePropagationConfig(ctx context.Context) ApiSetRolePropagationConfigRequest {
	return ApiSetRolePropagationConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return RolePropagationConfigResponse
func (a *RolePropagationAPIService) SetRolePropagationConfigExecute(r ApiSetRolePropagationConfigRequest) (*RolePropagationConfigResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RolePropagationAPIService.SetRolePropagationConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
