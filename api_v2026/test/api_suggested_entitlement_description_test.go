...
func Test_api_v2026_SuggestedEntitlementDescriptionAPIService(t *testing.T) {
	...
	t.Run("Test SuggestedEntitlementDescriptionAPIService CreateAutoWriteSettings", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SuggestedEntitlementDescriptionAPI.CreateAutoWriteSettings(context.Background()).Execute()
	...
	t.Run("Test SuggestedEntitlementDescriptionAPIService GetAutoWriteSettings", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.SuggestedEntitlementDescriptionAPI.GetAutoWriteSettings(context.Background()).Execute()
	...
	t.Run("Test SuggestedEntitlementDescriptionAPIService UpdateAutoWriteSettings", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.SuggestedEntitlementDescriptionAPI.UpdateAutoWriteSettings(context.Background()).Execute()
