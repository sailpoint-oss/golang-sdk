...
*AccountDeletionRequestsAPI* | [**DeleteAccountRequest**](docs/AccountDeletionRequestsAPI.md#deleteaccountrequest) | **Post** /account-requests/account/{accountId}/delete | Delete account
...
*ApprovalsAPI* | [**CancelApprovalById**](docs/ApprovalsAPI.md#cancelapprovalbyid) | **Post** /generic-approvals/{id}/cancel | Post Approval Cancel
*ApprovalsAPI* | [**DeleteApprovalConfigRequest**](docs/ApprovalsAPI.md#deleteapprovalconfigrequest) | **Delete** /generic-approvals/config/{id}/{scope} | Delete Approval Configuration
...
*ApprovalsAPI* | [**PutApprovalsConfig**](docs/ApprovalsAPI.md#putapprovalsconfig) | **Put** /generic-approvals/config/{id}/{scope} | Put Approval Config
...
*EntitlementConnectionsAPI* | [**ListEntitlementConnections**](docs/EntitlementConnectionsAPI.md#listentitlementconnections) | **Get** /entitlement-connections | List entitlement connections
*EntitlementConnectionsAPI* | [**ListEntitlementConnectionsForCurrentIdentity**](docs/EntitlementConnectionsAPI.md#listentitlementconnectionsforcurrentidentity) | **Get** /entitlement-connections/current-identity | List my entitlement connections
*EntitlementConnectionsAPI* | [**PatchEntitlementConnectionById**](docs/EntitlementConnectionsAPI.md#patchentitlementconnectionbyid) | **Patch** /entitlement-connections/{connectionId} | Update entitlement connection
*EntitlementConnectionsAPI* | [**PatchEntitlementConnectionByQuery**](docs/EntitlementConnectionsAPI.md#patchentitlementconnectionbyquery) | **Patch** /entitlement-connections | Update connection by query
*EntitlementConnectionsAPI* | [**UpdateEntitlementConnectionsBulk**](docs/EntitlementConnectionsAPI.md#updateentitlementconnectionsbulk) | **Post** /entitlement-connections | Update connections in bulk
...
*EntitlementsAPI* | [**ListEntitlementsByAccount**](docs/EntitlementsAPI.md#listentitlementsbyaccount) | **Get** /entitlements/account/{accountId}/entitlements | Get entitlements for an account
...
*JITAccessAPI* | [**GetJitActivationConfig**](docs/JITAccessAPI.md#getjitactivationconfig) | **Get** /jit-activation-config/{configType} | Get JIT activation policy configuration
*JITAccessAPI* | [**PatchJitActivationConfig**](docs/JITAccessAPI.md#patchjitactivationconfig) | **Patch** /jit-activation-config/{configType} | Update JIT activation policy configuration
*JITActivationsAPI* | [**StartActivateWorkflow**](docs/JITActivationsAPI.md#startactivateworkflow) | **Post** /jit-activations/activate | Start JIT activation workflow
*JITActivationsAPI* | [**StartDeactivateWorkflow**](docs/JITActivationsAPI.md#startdeactivateworkflow) | **Post** /jit-activations/deactivate | Deactivate JIT activation workflow
*JITActivationsAPI* | [**StartExtendWorkflow**](docs/JITActivationsAPI.md#startextendworkflow) | **Post** /jit-activations/extend | Extend JIT activation workflow
...
*MachineAccountClassifyAPI* | [**SendClassifyMachineAccount**](docs/MachineAccountClassifyAPI.md#sendclassifymachineaccount) | **Post** /accounts/{id}/classify | Classify single machine account
*MachineAccountCreationRequestAPI* | [**CreateMachineAccountRequest**](docs/MachineAccountCreationRequestAPI.md#createmachineaccountrequest) | **Post** /account-requests/machine-account-create | Submit Machine Account Creation Request
*MachineAccountCreationRequestAPI* | [**GetCreateMachineAccountRequest**](docs/MachineAccountCreationRequestAPI.md#getcreatemachineaccountrequest) | **Get** /account-requests/machine-account-create/{accountRequestId} | Get Machine Account Creation Request
*MachineAccountCreationRequestAPI* | [**GetMachineAccountCreateAccessInfo**](docs/MachineAccountCreationRequestAPI.md#getmachineaccountcreateaccessinfo) | **Get** /source-subtypes/machine-account-create-access | Machine Account Create Access
...
*MachineAccountSubtypesAPI* | [**CreateSourceSubtype**](docs/MachineAccountSubtypesAPI.md#createsourcesubtype) | **Post** /source-subtypes | Create subtype
*MachineAccountSubtypesAPI* | [**DeleteMachineAccountSubtype**](docs/MachineAccountSubtypesAPI.md#deletemachineaccountsubtype) | **Delete** /source-subtypes/{subtypeId} | Delete subtype by ID
*MachineAccountSubtypesAPI* | [**GetMachineAccountSubtypeApprovalConfig**](docs/MachineAccountSubtypesAPI.md#getmachineaccountsubtypeapprovalconfig) | **Get** /source-subtypes/{subtypeId}/machine-config | Machine Subtype Approval Config
*MachineAccountSubtypesAPI* | [**GetSourceSubtypeById**](docs/MachineAccountSubtypesAPI.md#getsourcesubtypebyid) | **Get** /source-subtypes/{subtypeId} | Get subtype by ID
*MachineAccountSubtypesAPI* | [**ListSourceSubtypes**](docs/MachineAccountSubtypesAPI.md#listsourcesubtypes) | **Get** /source-subtypes | Retrieve all subtypes
*MachineAccountSubtypesAPI* | [**LoadBulkSourceSubtypes**](docs/MachineAccountSubtypesAPI.md#loadbulksourcesubtypes) | **Post** /source-subtypes/bulk-retrieve | Bulk Retrieve of Source Subtypes
*MachineAccountSubtypesAPI* | [**PatchMachineAccountSubtype**](docs/MachineAccountSubtypesAPI.md#patchmachineaccountsubtype) | **Patch** /source-subtypes/{subtypeId} | Patch subtype by ID
*MachineAccountSubtypesAPI* | [**UpdateMachineAccountSubtypeApprovalConfig**](docs/MachineAccountSubtypesAPI.md#updatemachineaccountsubtypeapprovalconfig) | **Patch** /source-subtypes/{subtypeId}/machine-config | Machine Subtype Approval Config
...
*MachineAccountsAPI* | [**DeleteMachineAccountSubtypeByTechnicalName**](docs/MachineAccountsAPI.md#deletemachineaccountsubtypebytechnicalname) | **Delete** /sources/{sourceId}/subtypes/{technicalName} | Delete subtype
*MachineAccountsAPI* | [**GetMachineAccount**](docs/MachineAccountsAPI.md#getmachineaccount) | **Get** /machine-accounts/{id} | Get machine account details
...
*MachineAccountsAPI* | [**ListMachineAccounts**](docs/MachineAccountsAPI.md#listmachineaccounts) | **Get** /machine-accounts | List machine accounts
*MachineAccountsAPI* | [**PatchMachineAccountSubtypeByTechnicalName**](docs/MachineAccountsAPI.md#patchmachineaccountsubtypebytechnicalname) | **Patch** /sources/{sourceId}/subtypes/{technicalName} | Patch subtype
*MachineAccountsAPI* | [**UpdateMachineAccount**](docs/MachineAccountsAPI.md#updatemachineaccount) | **Patch** /machine-accounts/{id} | Update machine account details
...
*MachineIdentitiesAPI* | [**CreateMachineIdentity**](docs/MachineIdentitiesAPI.md#createmachineidentity) | **Post** /machine-identities | Create machine identity
...
*MachineIdentitiesAPI* | [**GetMachineIdentity**](docs/MachineIdentitiesAPI.md#getmachineidentity) | **Get** /machine-identities/{id} | Get machine identity details
...
*MachineIdentitiesAPI* | [**StartMachineIdentityAggregation**](docs/MachineIdentitiesAPI.md#startmachineidentityaggregation) | **Post** /sources/{sourceId}/aggregate-agents | Start machine identity aggregation
*MachineIdentitiesAPI* | [**UpdateMachineIdentity**](docs/MachineIdentitiesAPI.md#updatemachineidentity) | **Patch** /machine-identities/{id} | Update machine identity details
...
*NotificationsAPI* | [**GetNotificationPreferences**](docs/NotificationsAPI.md#getnotificationpreferences) | **Get** /notification-preferences/{key} | List notification preferences for tenant.
...
*NotificationsAPI* | [**GetNotificationTemplateVariables**](docs/NotificationsAPI.md#getnotificationtemplatevariables) | **Get** /notification-template-variables/{key}/{medium} | Get notification template variables
...
*PrivilegeCriteriaAPI* | [**CreateCustomPrivilegeCriteria**](docs/PrivilegeCriteriaAPI.md#createcustomprivilegecriteria) | **Post** /criteria/privilege | Create custom privilege criteria
*PrivilegeCriteriaAPI* | [**DeleteCustomPrivilegeCriteria**](docs/PrivilegeCriteriaAPI.md#deletecustomprivilegecriteria) | **Delete** /criteria/privilege/{criteriaId} | Delete privilege criteria
*PrivilegeCriteriaAPI* | [**GetPrivilegeCriteria**](docs/PrivilegeCriteriaAPI.md#getprivilegecriteria) | **Get** /criteria/privilege/{criteriaId} | Get privilege criteria
*PrivilegeCriteriaAPI* | [**ListPrivilegeCriteria**](docs/PrivilegeCriteriaAPI.md#listprivilegecriteria) | **Get** /criteria/privilege | List privilege criteria
*PrivilegeCriteriaAPI* | [**PutCustomPrivilegeCriteriaValue**](docs/PrivilegeCriteriaAPI.md#putcustomprivilegecriteriavalue) | **Put** /criteria/privilege/{criteriaId} | Update privilege criteria
*PrivilegeCriteriaConfigurationAPI* | [**GetPrivilegeCriteriaConfig**](docs/PrivilegeCriteriaConfigurationAPI.md#getprivilegecriteriaconfig) | **Get** /criteria-config/privilege/{criteriaConfigId} | Get privilege criteria config
*PrivilegeCriteriaConfigurationAPI* | [**ListPrivilegeCriteriaConfig**](docs/PrivilegeCriteriaConfigurationAPI.md#listprivilegecriteriaconfig) | **Get** /criteria-config/privilege | List privilege criteria config
*PrivilegeCriteriaConfigurationAPI* | [**PatchPrivilegeCriteriaConfig**](docs/PrivilegeCriteriaConfigurationAPI.md#patchprivilegecriteriaconfig) | **Patch** /criteria-config/privilege/{criteriaConfigId} | Update privilege criteria configuration
*PromptInsightsAPI* | [**GetPromptInsightsMetrics**](docs/PromptInsightsAPI.md#getpromptinsightsmetrics) | **Get** /prompt-insights/metrics | Get prompt insights metrics
*PromptInsightsAPI* | [**ListPromptInsights**](docs/PromptInsightsAPI.md#listpromptinsights) | **Get** /prompt-insights | List prompt insights
...
*RolePropagationAPI* | [**GetRolePropagationConfig**](docs/RolePropagationAPI.md#getrolepropagationconfig) | **Get** /role-propagation-config | Get Role Change Propagation Configuration
...
*RolePropagationAPI* | [**SetRolePropagationConfig**](docs/RolePropagationAPI.md#setrolepropagationconfig) | **Put** /role-propagation-config | Update Role Change Propagation Configuration
...
*SharedSignalsFrameworkSSFAPI* | [**CreateStream**](docs/SharedSignalsFrameworkSSFAPI.md#createstream) | **Post** /ssf/streams | Create stream
*SharedSignalsFrameworkSSFAPI* | [**DeleteStream**](docs/SharedSignalsFrameworkSSFAPI.md#deletestream) | **Delete** /ssf/streams | Delete stream
*SharedSignalsFrameworkSSFAPI* | [**GetJWKSData**](docs/SharedSignalsFrameworkSSFAPI.md#getjwksdata) | **Get** /ssf/jwks | Get JWKS
*SharedSignalsFrameworkSSFAPI* | [**GetSSFConfiguration**](docs/SharedSignalsFrameworkSSFAPI.md#getssfconfiguration) | **Get** /.well-known/ssf-configuration | Get SSF configuration
*SharedSignalsFrameworkSSFAPI* | [**GetStream**](docs/SharedSignalsFrameworkSSFAPI.md#getstream) | **Get** /ssf/streams | Get stream(s)
*SharedSignalsFrameworkSSFAPI* | [**GetStreamStatus**](docs/SharedSignalsFrameworkSSFAPI.md#getstreamstatus) | **Get** /ssf/streams/status | Get stream status
*SharedSignalsFrameworkSSFAPI* | [**SendStreamVerification**](docs/SharedSignalsFrameworkSSFAPI.md#sendstreamverification) | **Post** /ssf/streams/verify | Verify stream
*SharedSignalsFrameworkSSFAPI* | [**SetStreamConfiguration**](docs/SharedSignalsFrameworkSSFAPI.md#setstreamconfiguration) | **Put** /ssf/streams | Replace stream configuration
*SharedSignalsFrameworkSSFAPI* | [**UpdateStreamConfiguration**](docs/SharedSignalsFrameworkSSFAPI.md#updatestreamconfiguration) | **Patch** /ssf/streams | Update stream configuration
*SharedSignalsFrameworkSSFAPI* | [**UpdateStreamStatus**](docs/SharedSignalsFrameworkSSFAPI.md#updatestreamstatus) | **Post** /ssf/streams/status | Update stream status
...
*SourcesAPI* | [**GetAccountDeleteApprovalConfig**](docs/SourcesAPI.md#getaccountdeleteapprovalconfig) | **Get** /sources/{sourceId}/approval-config/account-delete | Human Account Deletion Approval Config
...
*SourcesAPI* | [**GetMachineAccountDeletionApprovalConfigBySource**](docs/SourcesAPI.md#getmachineaccountdeletionapprovalconfigbysource) | **Get** /sources/{sourceId}/approval-config/machine-account-delete | Machine Account Deletion Approval Config
...
*SourcesAPI* | [**GetSourceDataset**](docs/SourcesAPI.md#getsourcedataset) | **Get** /sources/{sourceId}/datasets/{datasetId} | Get source dataset by id
*SourcesAPI* | [**GetSourceDatasets**](docs/SourcesAPI.md#getsourcedatasets) | **Get** /sources/{sourceId}/datasets | List datasets on source
...
*SourcesAPI* | [**GetSourceResource**](docs/SourcesAPI.md#getsourceresource) | **Get** /sources/{sourceId}/resources/{resourceId} | Get source resource by id
*SourcesAPI* | [**GetSourceResources**](docs/SourcesAPI.md#getsourceresources) | **Get** /sources/{sourceId}/resources | List resources for a source
...
*SourcesAPI* | [**UpdateAccountDeletionApprovalConfig**](docs/SourcesAPI.md#updateaccountdeletionapprovalconfig) | **Patch** /sources/{sourceId}/approval-config/account-delete | Human Account Deletion Approval Config
*SourcesAPI* | [**UpdateMachineAccountDeletionApprovalConfig**](docs/SourcesAPI.md#updatemachineaccountdeletionapprovalconfig) | **Patch** /sources/{sourceId}/approval-config/machine-account-delete | Machine Account Deletion Approval Config
...
*SuggestedEntitlementDescriptionAPI* | [**ApproveBulkEntitlementRecommendations**](docs/SuggestedEntitlementDescriptionAPI.md#approvebulkentitlementrecommendations) | **Post** /entitlement-recommendations/bulk-approve | Bulk approve entitlement recommendations
*SuggestedEntitlementDescriptionAPI* | [**CreateAutoWriteSettings**](docs/SuggestedEntitlementDescriptionAPI.md#createautowritesettings) | **Post** /suggested-entitlement-descriptions/auto-write-settings | Create auto-write settings for SED
*SuggestedEntitlementDescriptionAPI* | [**GetAutoWriteSettings**](docs/SuggestedEntitlementDescriptionAPI.md#getautowritesettings) | **Get** /suggested-entitlement-descriptions/auto-write-settings | Get auto-write settings for SED
...
*SuggestedEntitlementDescriptionAPI* | [**ListPendingEntitlementRecommendationApprovals**](docs/SuggestedEntitlementDescriptionAPI.md#listpendingentitlementrecommendationapprovals) | **Get** /entitlement-recommendations/pending-approvals | List pending entitlement recommendation approvals
*SuggestedEntitlementDescriptionAPI* | [**ListPrivilegedEntitlementRecommendations**](docs/SuggestedEntitlementDescriptionAPI.md#listprivilegedentitlementrecommendations) | **Get** /privileged-recommendations | List privileged entitlement recommendations
...
*SuggestedEntitlementDescriptionAPI* | [**PatchEntitlementRecommendation**](docs/SuggestedEntitlementDescriptionAPI.md#patchentitlementrecommendation) | **Patch** /entitlement-recommendations/{id} | Update an entitlement recommendation
...
*SuggestedEntitlementDescriptionAPI* | [**SubmitEntitlementRecommendationsAssignment**](docs/SuggestedEntitlementDescriptionAPI.md#submitentitlementrecommendationsassignment) | **Post** /entitlement-recommendations/assign | Assign entitlement recommendations for review
...
*SuggestedEntitlementDescriptionAPI* | [**UpdateAutoWriteSettings**](docs/SuggestedEntitlementDescriptionAPI.md#updateautowritesettings) | **Patch** /suggested-entitlement-descriptions/auto-write-settings | Update auto-write settings for SED
...
## Documentation For Models
 ...
 - [BackupResponse1](docs/BackupResponse1.md)
 ...
 - [CreateSourceSubtypeRequest](docs/CreateSourceSubtypeRequest.md)
 ...
 - [DimensionAttribute](docs/DimensionAttribute.md)
 ...
 - [DimensionSchema](docs/DimensionSchema.md)
 ...
 - [GetAccessRequestConfig401Response](docs/GetAccessRequestConfig401Response.md)
 - [GetAccessRequestConfig429Response](docs/GetAccessRequestConfig429Response.md)
 ...
 - [GetStream200Response](docs/GetStream200Response.md)
 ...
 - [ListEntitlementConnections412Response](docs/ListEntitlementConnections412Response.md)
 ...
 - [MisBulkRequest](docs/MisBulkRequest.md)
 - [MisBulkResponse](docs/MisBulkResponse.md)
 - [MisBulkUpdateRequest](docs/MisBulkUpdateRequest.md)
 ...
 - [PromptInsight](docs/PromptInsight.md)
 - [PromptInsightsMetrics](docs/PromptInsightsMetrics.md)
 ...
 - [SourceDatasetResourcesInner](docs/SourceDatasetResourcesInner.md)
 ...
 - [StartApplicationDiscovery403Response](docs/StartApplicationDiscovery403Response.md)
 - [StartApplicationDiscovery403ResponseOneOf](docs/StartApplicationDiscovery403ResponseOneOf.md)
