...
// checks if the ApprovalstatusdtoOriginalOwner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApprovalstatusdtoOriginalOwner{}
...
type _ApprovalstatusdtoOriginalOwner ApprovalstatusdtoOriginalOwner
...
func NewApprovalstatusdtoOriginalOwner() *ApprovalstatusdtoOriginalOwner {
	this := ApprovalstatusdtoOriginalOwner{}
	return &this
}
...
func (o *ApprovalstatusdtoOriginalOwner) UnmarshalJSON(data []byte) (err error) {
	varApprovalstatusdtoOriginalOwner := _ApprovalstatusdtoOriginalOwner{}

	err = json.Unmarshal(data, &varApprovalstatusdtoOriginalOwner)

	if err != nil {
		return err
	}

	*o = ApprovalstatusdtoOriginalOwner(varApprovalstatusdtoOriginalOwner)
...
type NullableApprovalstatusdtoOriginalOwner struct {
	value *ApprovalstatusdtoOriginalOwner
	isSet bool
}

func (v NullableApprovalstatusdtoOriginalOwner) Get() *ApprovalstatusdtoOriginalOwner {
	return v.value
}

func (v *NullableApprovalstatusdtoOriginalOwner) Set(val *ApprovalstatusdtoOriginalOwner) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalstatusdtoOriginalOwner) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalstatusdtoOriginalOwner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalstatusdtoOriginalOwner(val *ApprovalstatusdtoOriginalOwner) *NullableApprovalstatusdtoOriginalOwner {
	return &NullableApprovalstatusdtoOriginalOwner{value: val, isSet: true}
}
