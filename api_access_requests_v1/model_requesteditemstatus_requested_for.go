...
type _RequesteditemstatusRequestedFor RequesteditemstatusRequestedFor
...
func NewRequesteditemstatusRequestedFor() *RequesteditemstatusRequestedFor {
	this := RequesteditemstatusRequestedFor{}
	return &this
}
...
func (o RequesteditemstatusRequestedFor) MarshalJSON() ([]byte, error) {
...
func (o RequesteditemstatusRequestedFor) ToMap() (map[string]interface{}, error) {
...
func (o *RequesteditemstatusRequestedFor) UnmarshalJSON(data []byte) (err error) {
	varRequesteditemstatusRequestedFor := _RequesteditemstatusRequestedFor{}

	err = json.Unmarshal(data, &varRequesteditemstatusRequestedFor)

	if err != nil {
		return err
	}

	*o = RequesteditemstatusRequestedFor(varRequesteditemstatusRequestedFor)
...
type NullableRequesteditemstatusRequestedFor struct {
	value *RequesteditemstatusRequestedFor
	isSet bool
}

func (v NullableRequesteditemstatusRequestedFor) Get() *RequesteditemstatusRequestedFor {
	return v.value
}

func (v *NullableRequesteditemstatusRequestedFor) Set(val *RequesteditemstatusRequestedFor) {
	v.value = val
	v.isSet = true
}

func (v NullableRequesteditemstatusRequestedFor) IsSet() bool {
	return v.isSet
}

func (v *NullableRequesteditemstatusRequestedFor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequesteditemstatusRequestedFor(val *RequesteditemstatusRequestedFor) *NullableRequesteditemstatusRequestedFor {
	return &NullableRequesteditemstatusRequestedFor{value: val, isSet: true}
}

func (v NullableRequesteditemstatusRequestedFor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequesteditemstatusRequestedFor) UnmarshalJSON(src []byte) error {
	v.isSet = true
