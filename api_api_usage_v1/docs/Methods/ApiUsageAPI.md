...
slug: /tools/sdk/go/apiusagev1/methods/api-usage
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_api_usage_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.ApiUsageV1.ApiUsageAPI.GetTotalCountV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.ApiUsageV1.ApiUsageAPI.GetTotalCountV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ApiUsageV1.ApiUsageAPI.ListApiSummaryV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.ApiUsageV1.ApiUsageAPI.ListApiSummaryV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Filters(filters).Limit(limit).Offset(offset).Execute()
    if err != nil {
