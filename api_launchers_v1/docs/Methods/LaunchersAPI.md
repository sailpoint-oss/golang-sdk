...
slug: /tools/sdk/go/launchersv1/methods/launchers
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_launchers_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_launchers_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.LaunchersV1.LaunchersAPI.CreateLauncherV1(context.Background()).Launcherrequest(launcherrequest).Execute()
	  //resp, r, err := apiClient.LaunchersV1.LaunchersAPI.CreateLauncherV1(context.Background()).Launcherrequest(launcherrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.LaunchersV1.LaunchersAPI.DeleteLauncherV1(context.Background(), launcherID).Execute()
	  //r, err := apiClient.LaunchersV1.LaunchersAPI.DeleteLauncherV1(context.Background(), launcherID).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.LaunchersV1.LaunchersAPI.GetLauncherV1(context.Background(), launcherID).Execute()
	  //resp, r, err := apiClient.LaunchersV1.LaunchersAPI.GetLauncherV1(context.Background(), launcherID).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.LaunchersV1.LaunchersAPI.GetLaunchersV1(context.Background()).Execute()
	  //resp, r, err := apiClient.LaunchersV1.LaunchersAPI.GetLaunchersV1(context.Background()).Filters(filters).Next(next).Limit(limit).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.LaunchersV1.LaunchersAPI.PutLauncherV1(context.Background(), launcherID).Launcherrequest(launcherrequest).Execute()
	  //resp, r, err := apiClient.LaunchersV1.LaunchersAPI.PutLauncherV1(context.Background(), launcherID).Launcherrequest(launcherrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.LaunchersV1.LaunchersAPI.StartLauncherV1(context.Background(), launcherID).Execute()
	  //resp, r, err := apiClient.LaunchersV1.LaunchersAPI.StartLauncherV1(context.Background(), launcherID).Execute()
    if err != nil {
