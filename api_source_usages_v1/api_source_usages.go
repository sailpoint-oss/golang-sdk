...
type ApiGetStatusBySourceIdV1Request struct {
	ctx context.Context
...
/*
GetStatusBySourceIdV1 Finds status of source usage

This API returns the status of the source usage insights setup by IDN source ID.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param sourceId ID of IDN source
 @return ApiGetStatusBySourceIdV1Request
*/
func (a *SourceUsagesAPIService) GetStatusBySourceIdV1(ctx context.Context, sourceId string) ApiGetStatusBySourceIdV1Request {
	return ApiGetStatusBySourceIdV1Request{
		ApiService: a,
		ctx: ctx,
		sourceId: sourceId,
...
func (a *SourceUsagesAPIService) GetStatusBySourceIdV1Execute(r ApiGetStatusBySourceIdV1Request) (*Sourceusagestatus, *http.Response, error) {
	...
	localVarPath := localBasePath + "/source-usages/v1/{sourceId}/status"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 401 {
			var v GetStatusBySourceIdV1401Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 429 {
			var v GetStatusBySourceIdV1429Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
type ApiGetUsagesBySourceIdV1Request struct {
	ctx context.Context
	ApiService *SourceUsagesAPIService
	sourceId string
	limit *int32
...
func (r ApiGetUsagesBySourceIdV1Request) Limit(limit int32) ApiGetUsagesBySourceIdV1Request {
	r.limit = &limit
	return r
}

// Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
func (r ApiGetUsagesBySourceIdV1Request) Offset(offset int32) ApiGetUsagesBySourceIdV1Request {
	r.offset = &offset
	return r
}

// If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count&#x3D;true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
func (r ApiGetUsagesBySourceIdV1Request) Count(count bool) ApiGetUsagesBySourceIdV1Request {
	r.count = &count
	return r
}
...
func (r ApiGetUsagesBySourceIdV1Request) Sorters(sorters string) ApiGetUsagesBySourceIdV1Request {
	r.sorters = &sorters
	return r
}
...
/*
GetUsagesBySourceIdV1 Returns source usage insights

This API returns a summary of source usage insights for past 12 months.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param sourceId ID of IDN source
 @return ApiGetUsagesBySourceIdV1Request
*/
func (a *SourceUsagesAPIService) GetUsagesBySourceIdV1(ctx context.Context, sourceId string) ApiGetUsagesBySourceIdV1Request {
	return ApiGetUsagesBySourceIdV1Request{
		ApiService: a,
		ctx: ctx,
		sourceId: sourceId,
...
func (a *SourceUsagesAPIService) GetUsagesBySourceIdV1Execute(r ApiGetUsagesBySourceIdV1Request) ([]Sourceusage, *http.Response, error) {
	...
	localVarPath := localBasePath + "/source-usages/v1/{sourceId}/summaries"
	localVarPath = strings.Replace(localVarPath, "{"+"sourceId"+"}", url.PathEscape(parameterValueToString(r.sourceId, "sourceId")), -1)
