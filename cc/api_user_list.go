...
// ListUserListApiService SourcesAggregationApi service
type ListUserListApiService service

type ApiListUserListRequest struct {
	ctx        context.Context
	ApiService *ListUserListApiService
	limit      *int32
	offset     *int32
	count      *bool
	sorters    *[]QuerySort
...
*/
func (a *ListUserListApiService) ListUsers(ctx context.Context) ApiListUserListRequest {
	return ApiListUserListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ListUserListApiService) ListUsersExecute(r ApiListUserListRequest) (*UserList, *http.Response, error) {
	var (
