...
slug: /tools/sdk/go/globaltenantsecuritysettingsv1/methods/global-tenant-security-settings
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_global_tenant_security_settings_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_global_tenant_security_settings_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.CreateAuthOrgNetworkConfigV1(context.Background()).Networkconfiguration(networkconfiguration).Execute()
	  //resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.CreateAuthOrgNetworkConfigV1(context.Background()).Networkconfiguration(networkconfiguration).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.GetAuthOrgLockoutConfigV1(context.Background()).Execute()
	  //resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.GetAuthOrgLockoutConfigV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.GetAuthOrgNetworkConfigV1(context.Background()).Execute()
	  //resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.GetAuthOrgNetworkConfigV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.GetAuthOrgServiceProviderConfigV1(context.Background()).Execute()
	  //resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.GetAuthOrgServiceProviderConfigV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.GetAuthOrgSessionConfigV1(context.Background()).Execute()
	  //resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.GetAuthOrgSessionConfigV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.PatchAuthOrgLockoutConfigV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.PatchAuthOrgLockoutConfigV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.PatchAuthOrgNetworkConfigV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.PatchAuthOrgNetworkConfigV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.PatchAuthOrgServiceProviderConfigV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.PatchAuthOrgServiceProviderConfigV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.PatchAuthOrgSessionConfigV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.GlobalTenantSecuritySettingsV1.GlobalTenantSecuritySettingsAPI.PatchAuthOrgSessionConfigV1(context.Background()).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
