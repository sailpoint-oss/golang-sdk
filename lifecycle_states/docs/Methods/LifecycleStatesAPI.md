...
func main() {
    ...
    setlifecyclestatev1requestJson := []byte(``) // SetLifecycleStateV1Request | 

    var setLifecycleStateV1Request lifecycle_states.SetLifecycleStateV1Request
    if err := json.Unmarshal(setlifecyclestatev1requestJson, &setLifecycleStateV1Request); err != nil {
      fmt.Println("Error:", err)
      return
    }
