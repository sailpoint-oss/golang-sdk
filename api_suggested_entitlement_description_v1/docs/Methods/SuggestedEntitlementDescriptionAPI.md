...
slug: /tools/sdk/go/suggestedentitlementdescriptionv1/methods/suggested-entitlement-description
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_suggested_entitlement_description_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_suggested_entitlement_description_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.ApproveBulkEntitlementRecommendationsV1(context.Background()).Bulkapproveentitlementrecommendationrequest(bulkapproveentitlementrecommendationrequest).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.ApproveBulkEntitlementRecommendationsV1(context.Background()).Bulkapproveentitlementrecommendationrequest(bulkapproveentitlementrecommendationrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.CreateAutoWriteSettingsV1(context.Background()).Autowritesetting(autowritesetting).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.CreateAutoWriteSettingsV1(context.Background()).Autowritesetting(autowritesetting).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.GetAutoWriteSettingsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.GetAutoWriteSettingsV1(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.GetSedBatchStatsV1(context.Background(), batchId).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.GetSedBatchStatsV1(context.Background(), batchId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.GetSedBatchesV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.GetSedBatchesV1(context.Background()).Offset(offset).Limit(limit).Count(count).CountOnly(countOnly).Status(status).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.ListPendingEntitlementRecommendationApprovalsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.ListPendingEntitlementRecommendationApprovalsV1(context.Background()).Offset(offset).Limit(limit).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.ListPrivilegedEntitlementRecommendationsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.ListPrivilegedEntitlementRecommendationsV1(context.Background()).Offset(offset).Limit(limit).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.ListSedsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.ListSedsV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).CountOnly(countOnly).RequestedByAnyone(requestedByAnyone).ShowPendingStatusOnly(showPendingStatusOnly).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.PatchEntitlementRecommendationV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.PatchEntitlementRecommendationV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.PatchSedV1(context.Background(), id).Sedpatch(sedpatch).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.PatchSedV1(context.Background(), id).Sedpatch(sedpatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.SubmitEntitlementRecommendationsAssignmentV1(context.Background()).Entitlementrecommendationassignrequest(entitlementrecommendationassignrequest).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.SubmitEntitlementRecommendationsAssignmentV1(context.Background()).Entitlementrecommendationassignrequest(entitlementrecommendationassignrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.SubmitSedApprovalV1(context.Background()).Sedapproval(sedapproval).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.SubmitSedApprovalV1(context.Background()).Sedapproval(sedapproval).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.SubmitSedAssignmentV1(context.Background()).Sedassignment(sedassignment).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.SubmitSedAssignmentV1(context.Background()).Sedassignment(sedassignment).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.SubmitSedBatchRequestV1(context.Background()).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.SubmitSedBatchRequestV1(context.Background()).Sedbatchrequest(sedbatchrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.UpdateAutoWriteSettingsV1(context.Background()).Autowritesettingpatch(autowritesettingpatch).Execute()
	  //resp, r, err := apiClient.SuggestedEntitlementDescriptionV1.SuggestedEntitlementDescriptionAPI.UpdateAutoWriteSettingsV1(context.Background()).Autowritesettingpatch(autowritesettingpatch).Execute()
    if err != nil {
