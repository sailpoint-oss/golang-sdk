...
slug: /tools/sdk/go/connectorrulemanagementv1/methods/connector-rule-management
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_connector_rule_management_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_connector_rule_management_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.CreateConnectorRuleV1(context.Background()).Connectorrulecreaterequest(connectorrulecreaterequest).Execute()
	  //resp, r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.CreateConnectorRuleV1(context.Background()).Connectorrulecreaterequest(connectorrulecreaterequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.DeleteConnectorRuleV1(context.Background(), id).Execute()
	  //r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.DeleteConnectorRuleV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.GetConnectorRuleListV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.GetConnectorRuleListV1(context.Background()).Limit(limit).Offset(offset).Count(count).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.GetConnectorRuleV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.GetConnectorRuleV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.PutConnectorRuleV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.PutConnectorRuleV1(context.Background(), id).Connectorruleupdaterequest(connectorruleupdaterequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.TestConnectorRuleV1(context.Background()).Sourcecode(sourcecode).Execute()
	  //resp, r, err := apiClient.ConnectorRuleManagementV1.ConnectorRuleManagementAPI.TestConnectorRuleV1(context.Background()).Sourcecode(sourcecode).Execute()
    if err != nil {
