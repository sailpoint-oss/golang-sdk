...
slug: /tools/sdk/go/triggersv1/methods/triggers
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_triggers_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_triggers_v1"
)
...
func main() {
    ...
    r, err := apiClient.TriggersV1.TriggersAPI.CompleteTriggerInvocationV1(context.Background(), id).Completeinvocation(completeinvocation).Execute()
	  //r, err := apiClient.TriggersV1.TriggersAPI.CompleteTriggerInvocationV1(context.Background(), id).Completeinvocation(completeinvocation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TriggersV1.TriggersAPI.CreateSubscriptionV1(context.Background()).Subscriptionpostrequest(subscriptionpostrequest).Execute()
	  //resp, r, err := apiClient.TriggersV1.TriggersAPI.CreateSubscriptionV1(context.Background()).Subscriptionpostrequest(subscriptionpostrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.TriggersV1.TriggersAPI.DeleteSubscriptionV1(context.Background(), id).Execute()
	  //r, err := apiClient.TriggersV1.TriggersAPI.DeleteSubscriptionV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TriggersV1.TriggersAPI.ListSubscriptionsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.TriggersV1.TriggersAPI.ListSubscriptionsV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TriggersV1.TriggersAPI.ListTriggerInvocationStatusV1(context.Background()).Execute()
	  //resp, r, err := apiClient.TriggersV1.TriggersAPI.ListTriggerInvocationStatusV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TriggersV1.TriggersAPI.ListTriggersV1(context.Background()).Execute()
	  //resp, r, err := apiClient.TriggersV1.TriggersAPI.ListTriggersV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TriggersV1.TriggersAPI.PatchSubscriptionV1(context.Background(), id).SubscriptionpatchrequestInner(subscriptionpatchrequestInner).Execute()
	  //resp, r, err := apiClient.TriggersV1.TriggersAPI.PatchSubscriptionV1(context.Background(), id).SubscriptionpatchrequestInner(subscriptionpatchrequestInner).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TriggersV1.TriggersAPI.StartTestTriggerInvocationV1(context.Background()).Testinvocation(testinvocation).Execute()
	  //resp, r, err := apiClient.TriggersV1.TriggersAPI.StartTestTriggerInvocationV1(context.Background()).Testinvocation(testinvocation).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TriggersV1.TriggersAPI.TestSubscriptionFilterV1(context.Background()).Validatefilterinputdto(validatefilterinputdto).Execute()
	  //resp, r, err := apiClient.TriggersV1.TriggersAPI.TestSubscriptionFilterV1(context.Background()).Validatefilterinputdto(validatefilterinputdto).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TriggersV1.TriggersAPI.UpdateSubscriptionV1(context.Background(), id).Subscriptionputrequest(subscriptionputrequest).Execute()
	  //resp, r, err := apiClient.TriggersV1.TriggersAPI.UpdateSubscriptionV1(context.Background(), id).Subscriptionputrequest(subscriptionputrequest).Execute()
    if err != nil {
