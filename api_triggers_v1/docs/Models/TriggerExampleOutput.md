...
keywords: ['go', 'Golang', 'sdk', 'TriggerExampleOutput', 'V1TriggerExampleOutput'] 
slug: /tools/sdk/go/triggersv1/models/trigger-example-output
...
`func NewTriggerExampleOutput(id string, name string, type_ string, approved bool, comment string, approver string, ) *TriggerExampleOutput`
...
`func (o *TriggerExampleOutput) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *TriggerExampleOutput) GetTypeOk() (*string, bool)`
...
`func (o *TriggerExampleOutput) SetType(v string)`
