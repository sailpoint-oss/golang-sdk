...
slug: /tools/sdk/go/accountdeletionrequestsv1/methods/account-deletion-requests
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_account_deletion_requests_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.AccountDeletionRequestsV1.AccountDeletionRequestsAPI.DeleteAccountRequestV1(context.Background(), accountId).Execute()
	  //resp, r, err := apiClient.AccountDeletionRequestsV1.AccountDeletionRequestsAPI.DeleteAccountRequestV1(context.Background(), accountId).Accountdeleterequestinput(accountdeleterequestinput).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.AccountDeletionRequestsV1.AccountDeletionRequestsAPI.GetAccountDeletionRequestsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.AccountDeletionRequestsV1.AccountDeletionRequestsAPI.GetAccountDeletionRequestsV1(context.Background()).Limit(limit).Offset(offset).Count(count).Mine(mine).Execute()
    if err != nil {
