...
// checks if the RequestAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestAction{}

// RequestAction struct for RequestAction
...
type _RequestAction RequestAction
...
func (o RequestAction) MarshalJSON() ([]byte, error) {
...
func (o RequestAction) ToMap() (map[string]interface{}, error) {
...
func (o *RequestAction) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestAction := _RequestAction{}

	err = json.Unmarshal(data, &varRequestAction)

	if err != nil {
		return err
	}

	*o = RequestAction(varRequestAction)
