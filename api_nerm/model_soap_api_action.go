...
// checks if the SoapApiAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoapApiAction{}

// SoapApiAction struct for SoapApiAction
type SoapApiAction struct {
...
type _SoapApiAction SoapApiAction
...
func (o SoapApiAction) MarshalJSON() ([]byte, error) {
...
func (o SoapApiAction) ToMap() (map[string]interface{}, error) {
...
func (o *SoapApiAction) UnmarshalJSON(data []byte) (err error) {
	...
	varSoapApiAction := _SoapApiAction{}

	err = json.Unmarshal(data, &varSoapApiAction)

	if err != nil {
		return err
	}

	*o = SoapApiAction(varSoapApiAction)
...
type NullableSoapApiAction struct {
	value *SoapApiAction
	isSet bool
}

func (v NullableSoapApiAction) Get() *SoapApiAction {
	return v.value
}

func (v *NullableSoapApiAction) Set(val *SoapApiAction) {
	v.value = val
	v.isSet = true
}

func (v NullableSoapApiAction) IsSet() bool {
	return v.isSet
}

func (v *NullableSoapApiAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoapApiAction(val *SoapApiAction) *NullableSoapApiAction {
	return &NullableSoapApiAction{value: val, isSet: true}
}

func (v NullableSoapApiAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoapApiAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
