...
// checks if the RestApiAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestApiAction{}

// RestApiAction struct for RestApiAction
...
type _RestApiAction RestApiAction
...
func (o RestApiAction) MarshalJSON() ([]byte, error) {
...
func (o RestApiAction) ToMap() (map[string]interface{}, error) {
...
func (o *RestApiAction) UnmarshalJSON(data []byte) (err error) {
	...
	varRestApiAction := _RestApiAction{}

	err = json.Unmarshal(data, &varRestApiAction)

	if err != nil {
		return err
	}

	*o = RestApiAction(varRestApiAction)
...
type NullableRestApiAction struct {
	value *RestApiAction
	isSet bool
}

func (v NullableRestApiAction) Get() *RestApiAction {
	return v.value
}

func (v *NullableRestApiAction) Set(val *RestApiAction) {
	v.value = val
	v.isSet = true
}

func (v NullableRestApiAction) IsSet() bool {
	return v.isSet
}

func (v *NullableRestApiAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestApiAction(val *RestApiAction) *NullableRestApiAction {
	return &NullableRestApiAction{value: val, isSet: true}
}

func (v NullableRestApiAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestApiAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
