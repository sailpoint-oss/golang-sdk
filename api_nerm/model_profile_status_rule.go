...
// checks if the ProfileStatusRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProfileStatusRule{}

// ProfileStatusRule struct for ProfileStatusRule
type ProfileStatusRule struct {
...
type _ProfileStatusRule ProfileStatusRule
...
func (o ProfileStatusRule) MarshalJSON() ([]byte, error) {
...
func (o ProfileStatusRule) ToMap() (map[string]interface{}, error) {
...
func (o *ProfileStatusRule) UnmarshalJSON(data []byte) (err error) {
	...
	varProfileStatusRule := _ProfileStatusRule{}

	err = json.Unmarshal(data, &varProfileStatusRule)

	if err != nil {
		return err
	}

	*o = ProfileStatusRule(varProfileStatusRule)
...
type NullableProfileStatusRule struct {
	value *ProfileStatusRule
	isSet bool
}

func (v NullableProfileStatusRule) Get() *ProfileStatusRule {
	return v.value
}

func (v *NullableProfileStatusRule) Set(val *ProfileStatusRule) {
	v.value = val
	v.isSet = true
}

func (v NullableProfileStatusRule) IsSet() bool {
	return v.isSet
}

func (v *NullableProfileStatusRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProfileStatusRule(val *ProfileStatusRule) *NullableProfileStatusRule {
	return &NullableProfileStatusRule{value: val, isSet: true}
}

func (v NullableProfileStatusRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProfileStatusRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
