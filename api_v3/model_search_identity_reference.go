...
// checks if the SearchIdentityReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchIdentityReference{}

// SearchIdentityReference struct for SearchIdentityReference
type SearchIdentityReference struct {
...
type _SearchIdentityReference SearchIdentityReference
...
func (o SearchIdentityReference) MarshalJSON() ([]byte, error) {
...
func (o SearchIdentityReference) ToMap() (map[string]interface{}, error) {
...
func (o *SearchIdentityReference) UnmarshalJSON(bytes []byte) (err error) {
...
type NullableSearchIdentityReference struct {
	value *SearchIdentityReference
	isSet bool
}

func (v NullableSearchIdentityReference) Get() *SearchIdentityReference {
	return v.value
}

func (v *NullableSearchIdentityReference) Set(val *SearchIdentityReference) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchIdentityReference) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchIdentityReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchIdentityReference(val *SearchIdentityReference) *NullableSearchIdentityReference {
	return &NullableSearchIdentityReference{value: val, isSet: true}
}

func (v NullableSearchIdentityReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchIdentityReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
