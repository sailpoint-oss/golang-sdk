...
// checks if the RandomNumeric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RandomNumeric{}
...
func (o RandomNumeric) ToMap() (map[string]interface{}, error) {
