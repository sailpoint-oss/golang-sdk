...
// checks if the SodPolicyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SodPolicyRequest{}

// SodPolicyRequest struct for SodPolicyRequest
type SodPolicyRequest struct {
	// Policy id
	...
	ConflictingAccessCriteria *SodPolicyRequestAllOfConflictingAccessCriteria `json:"conflictingAccessCriteria,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SodPolicyRequest SodPolicyRequest
...
func (o *SodPolicyRequest) SetDescriptionNil() {
...
func (o *SodPolicyRequest) SetExternalPolicyReferenceNil() {
...
func (o *SodPolicyRequest) SetCompensatingControlsNil() {
...
func (o *SodPolicyRequest) SetCorrectionAdviceNil() {
...
func (o *SodPolicyRequest) SetModifierIdNil() {
...
func (o *SodPolicyRequest) GetConflictingAccessCriteria() SodPolicyRequestAllOfConflictingAccessCriteria {
	if o == nil || IsNil(o.ConflictingAccessCriteria) {
		var ret SodPolicyRequestAllOfConflictingAccessCriteria
		return ret
	}
...
// SetConflictingAccessCriteria gets a reference to the given SodPolicyRequestAllOfConflictingAccessCriteria and assigns it to the ConflictingAccessCriteria field.
...
func (o SodPolicyRequest) MarshalJSON() ([]byte, error) {
...
func (o SodPolicyRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SodPolicyRequest) UnmarshalJSON(data []byte) (err error) {
	varSodPolicyRequest := _SodPolicyRequest{}

	err = json.Unmarshal(data, &varSodPolicyRequest)

	if err != nil {
		return err
	}

	*o = SodPolicyRequest(varSodPolicyRequest)
...
type NullableSodPolicyRequest struct {
	value *SodPolicyRequest
	isSet bool
}

func (v NullableSodPolicyRequest) Get() *SodPolicyRequest {
	return v.value
}

func (v *NullableSodPolicyRequest) Set(val *SodPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSodPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSodPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSodPolicyRequest(val *SodPolicyRequest) *NullableSodPolicyRequest {
	return &NullableSodPolicyRequest{value: val, isSet: true}
}

func (v NullableSodPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSodPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
