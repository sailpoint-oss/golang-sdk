...
type _AccessProfileRole AccessProfileRole
...
func (o *AccessProfileRole) UnmarshalJSON(data []byte) (err error) {
	varAccessProfileRole := _AccessProfileRole{}

	err = json.Unmarshal(data, &varAccessProfileRole)
...
type NullableAccessProfileRole struct {
	value *AccessProfileRole
	isSet bool
}

func (v NullableAccessProfileRole) Get() *AccessProfileRole {
	return v.value
}

func (v *NullableAccessProfileRole) Set(val *AccessProfileRole) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAccessProfileRole(val *AccessProfileRole) *NullableAccessProfileRole {
	return &NullableAccessProfileRole{value: val, isSet: true}
}
