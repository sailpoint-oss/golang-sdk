...
slug: /tools/sdk/go/documentation/v3/models/role-document
...
**AccessProfiles** | Pointer to [**[]BaseAccessProfile**](BaseAccessProfile) | Access profiles included with the role. | [optional] 
...
**Segments** | Pointer to [**[]BaseSegment**](BaseSegment) | Segments with the role. | [optional] 
**SegmentCount** | Pointer to **int32** | Number of segments with the role. | [optional] 
**Entitlements** | Pointer to [**[]BaseEntitlement**](BaseEntitlement) | Entitlements included with the role. | [optional] 
