...
slug: /tools/sdk/go/connectorcustomizersv1/methods/connector-customizers
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_connector_customizers_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_connector_customizers_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.CreateConnectorCustomizerV1(context.Background()).Connectorcustomizercreaterequest(connectorcustomizercreaterequest).Execute()
	  //resp, r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.CreateConnectorCustomizerV1(context.Background()).Connectorcustomizercreaterequest(connectorcustomizercreaterequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.CreateConnectorCustomizerVersionV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.CreateConnectorCustomizerVersionV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.DeleteConnectorCustomizerV1(context.Background(), id).Execute()
	  //r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.DeleteConnectorCustomizerV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.GetConnectorCustomizerV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.GetConnectorCustomizerV1(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.ListConnectorCustomizersV1(context.Background()).Execute()
	  //resp, r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.ListConnectorCustomizersV1(context.Background()).Offset(offset).Limit(limit).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.PutConnectorCustomizerV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.ConnectorCustomizersV1.ConnectorCustomizersAPI.PutConnectorCustomizerV1(context.Background(), id).Connectorcustomizerupdaterequest(connectorcustomizerupdaterequest).Execute()
    if err != nil {
