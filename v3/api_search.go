...
func (r ApiSearchAggregateRequest) Search(search Search) ApiSearchAggregateRequest {
	r.search = &search
	return r
}
...
func (r ApiSearchCountRequest) Search(search Search) ApiSearchCountRequest {
	r.search = &search
	return r
}
