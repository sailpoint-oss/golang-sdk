...
// checks if the BaseAccessAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseAccessAllOf{}
...
type _BaseAccessAllOf BaseAccessAllOf
...
func (o BaseAccessAllOf) ToMap() (map[string]interface{}, error) {
...
func (o *BaseAccessAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBaseAccessAllOf := _BaseAccessAllOf{}

	if err = json.Unmarshal(bytes, &varBaseAccessAllOf); err == nil {
		*o = BaseAccessAllOf(varBaseAccessAllOf)
	}
...
type NullableBaseAccessAllOf struct {
	value *BaseAccessAllOf
	isSet bool
}

func (v NullableBaseAccessAllOf) Get() *BaseAccessAllOf {
	return v.value
}

func (v *NullableBaseAccessAllOf) Set(val *BaseAccessAllOf) {
	v.value = val
	v.isSet = true
}
...
func NewNullableBaseAccessAllOf(val *BaseAccessAllOf) *NullableBaseAccessAllOf {
	return &NullableBaseAccessAllOf{value: val, isSet: true}
}
