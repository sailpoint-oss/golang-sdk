...
// checks if the Trim type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Trim{}

// Trim struct for Trim
type Trim struct {
...
func (o Trim) MarshalJSON() ([]byte, error) {
...
func (o Trim) ToMap() (map[string]interface{}, error) {
...
func (o *Trim) UnmarshalJSON(bytes []byte) (err error) {
	varTrim := _Trim{}

	if err = json.Unmarshal(bytes, &varTrim); err == nil {
		*o = Trim(varTrim)
	}
...
type NullableTrim struct {
	value *Trim
	isSet bool
}

func (v NullableTrim) Get() *Trim {
	return v.value
}

func (v *NullableTrim) Set(val *Trim) {
	v.value = val
	v.isSet = true
}

func (v NullableTrim) IsSet() bool {
	return v.isSet
}

func (v *NullableTrim) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrim(val *Trim) *NullableTrim {
	return &NullableTrim{value: val, isSet: true}
}

func (v NullableTrim) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrim) UnmarshalJSON(src []byte) error {
	v.isSet = true
