...
type ApiGetArmPublicKeyRequest struct {
	ctx context.Context
	ApiService *SODPolicyApiService
	id KeyExchangeServiceTarget
}

func (r ApiGetArmPublicKeyRequest) Execute() (*PublicKey, *http.Response, error) {
	return r.ApiService.GetArmPublicKeyExecute(r)
}

/*
GetArmPublicKey Get ARM public key

This API returns public key to encrypt ARM auth blob.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id The target for public key
 @return ApiGetArmPublicKeyRequest
*/
func (a *SODPolicyApiService) GetArmPublicKey(ctx context.Context, id KeyExchangeServiceTarget) ApiGetArmPublicKeyRequest {
	return ApiGetArmPublicKeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return PublicKey
func (a *SODPolicyApiService) GetArmPublicKeyExecute(r ApiGetArmPublicKeyRequest) (*PublicKey, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SODPolicyApiService.GetArmPublicKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/sod-config/public-keys/target"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiGetArmRiskByIdRequest struct {
	ctx context.Context
	ApiService *SODPolicyApiService
	id string
}

func (r ApiGetArmRiskByIdRequest) Execute() (*ArmRisk, *http.Response, error) {
	return r.ApiService.GetArmRiskByIdExecute(r)
}

/*
GetArmRiskById Gets the specified ARM risk.
...
Any authenticated token can call this API.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id The composite ID of the ARM Risk. It should consist of a jobId, rulebookId, and a riskCode; each separated by a \"!\"
 @return ApiGetArmRiskByIdRequest
*/
func (a *SODPolicyApiService) GetArmRiskById(ctx context.Context, id string) ApiGetArmRiskByIdRequest {
	return ApiGetArmRiskByIdRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ArmRisk
func (a *SODPolicyApiService) GetArmRiskByIdExecute(r ApiGetArmRiskByIdRequest) (*ArmRisk, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ArmRisk
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SODPolicyApiService.GetArmRiskById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/sod-risks/risks/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
