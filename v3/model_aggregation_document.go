...
// checks if the AggregationDocument type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AggregationDocument{}
...
func (o AggregationDocument) ToMap() (map[string]interface{}, error) {
