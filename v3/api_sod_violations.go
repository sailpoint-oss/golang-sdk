...
type ApiGetArmConfigRequest struct {
	ctx context.Context
	ApiService *SODViolationsApiService
}

func (r ApiGetArmConfigRequest) Execute() (*PublicOrgConfigArmData, *http.Response, error) {
	return r.ApiService.GetArmConfigExecute(r)
}

/*
GetArmConfig Expose just the ARM config

This API expose just the ARM config from Tenaya (Org Config Service) for UI.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetArmConfigRequest
*/
func (a *SODViolationsApiService) GetArmConfig(ctx context.Context) ApiGetArmConfigRequest {
	return ApiGetArmConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return PublicOrgConfigArmData
func (a *SODViolationsApiService) GetArmConfigExecute(r ApiGetArmConfigRequest) (*PublicOrgConfigArmData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PublicOrgConfigArmData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SODViolationsApiService.GetArmConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/sod-violations/config"
