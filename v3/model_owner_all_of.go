...
// checks if the OwnerAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OwnerAllOf{}
...
func (o OwnerAllOf) ToMap() (map[string]interface{}, error) {
