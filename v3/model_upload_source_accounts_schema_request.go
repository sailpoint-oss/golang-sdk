...
// checks if the UploadSourceAccountsSchemaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UploadSourceAccountsSchemaRequest{}
...
func (o UploadSourceAccountsSchemaRequest) ToMap() (map[string]interface{}, error) {
