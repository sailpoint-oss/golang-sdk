...
// checks if the SearchArgumentsOwner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchArgumentsOwner{}
...
func (o SearchArgumentsOwner) ToMap() (map[string]interface{}, error) {
