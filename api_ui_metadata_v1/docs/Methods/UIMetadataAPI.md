...
slug: /tools/sdk/go/uimetadatav1/methods/ui-metadata
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_ui_metadata_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.UiMetadataV1.UIMetadataAPI.GetTenantUiMetadataV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.UiMetadataV1.UIMetadataAPI.GetTenantUiMetadataV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_ui_metadata_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_ui_metadata_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.UiMetadataV1.UIMetadataAPI.SetTenantUiMetadataV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Tenantuimetadataitemupdaterequest(tenantuimetadataitemupdaterequest).Execute()
	  //resp, r, err := apiClient.UiMetadataV1.UIMetadataAPI.SetTenantUiMetadataV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Tenantuimetadataitemupdaterequest(tenantuimetadataitemupdaterequest).Execute()
    if err != nil {
