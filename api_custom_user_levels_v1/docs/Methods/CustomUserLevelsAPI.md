...
slug: /tools/sdk/go/customuserlevelsv1/methods/custom-user-levels
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_custom_user_levels_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_custom_user_levels_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.CreateCustomUserLevelV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Userlevelrequest(userlevelrequest).Execute()
	  //resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.CreateCustomUserLevelV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Userlevelrequest(userlevelrequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.DeleteUserLevelV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
	  //r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.DeleteUserLevelV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.GetUserLevelV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.GetUserLevelV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.ListAllAuthorizationRightSetsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.ListAllAuthorizationRightSetsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Filters(filters).Sorters(sorters).Limit(limit).Offset(offset).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.ListUserLevelIdentitiesV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.ListUserLevelIdentitiesV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Count(count).Sorters(sorters).Limit(limit).Offset(offset).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.ListUserLevelsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.ListUserLevelsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).DetailLevel(detailLevel).Filters(filters).Sorters(sorters).Limit(limit).Offset(offset).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.PublishCustomUserLevelV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
	  //resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.PublishCustomUserLevelV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.ShowUserLevelCountsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).RequestBody(requestBody).Execute()
	  //resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.ShowUserLevelCountsV1(context.Background()).XSailPointExperimental(xSailPointExperimental).RequestBody(requestBody).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.UpdateUserLevelV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Jsonpatch(jsonpatch).Execute()
	  //resp, r, err := apiClient.CustomUserLevelsV1.CustomUserLevelsAPI.UpdateUserLevelV1(context.Background(), id).XSailPointExperimental(xSailPointExperimental).Jsonpatch(jsonpatch).Execute()
    if err != nil {
