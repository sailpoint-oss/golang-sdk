...
// checks if the FullDiscoveredApplicationsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FullDiscoveredApplicationsInner{}

// FullDiscoveredApplicationsInner struct for FullDiscoveredApplicationsInner
type FullDiscoveredApplicationsInner struct {
...
type _FullDiscoveredApplicationsInner FullDiscoveredApplicationsInner
...
func NewFullDiscoveredApplicationsInner() *FullDiscoveredApplicationsInner {
	this := FullDiscoveredApplicationsInner{}
	return &this
}
...
func (o FullDiscoveredApplicationsInner) MarshalJSON() ([]byte, error) {
...
func (o FullDiscoveredApplicationsInner) ToMap() (map[string]interface{}, error) {
...
func (o *FullDiscoveredApplicationsInner) UnmarshalJSON(bytes []byte) (err error) {
	varFullDiscoveredApplicationsInner := _FullDiscoveredApplicationsInner{}

	if err = json.Unmarshal(bytes, &varFullDiscoveredApplicationsInner); err == nil {
	*o = FullDiscoveredApplicationsInner(varFullDiscoveredApplicationsInner)
}
...
type NullableFullDiscoveredApplicationsInner struct {
	value *FullDiscoveredApplicationsInner
	isSet bool
}

func (v NullableFullDiscoveredApplicationsInner) Get() *FullDiscoveredApplicationsInner {
	return v.value
}

func (v *NullableFullDiscoveredApplicationsInner) Set(val *FullDiscoveredApplicationsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFullDiscoveredApplicationsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFullDiscoveredApplicationsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFullDiscoveredApplicationsInner(val *FullDiscoveredApplicationsInner) *NullableFullDiscoveredApplicationsInner {
	return &NullableFullDiscoveredApplicationsInner{value: val, isSet: true}
}

func (v NullableFullDiscoveredApplicationsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFullDiscoveredApplicationsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
