...
func NewAccountAttribute(sourceName string, attributeName string) *AccountAttribute {
	...
	var accountSortAttribute string = "created"
	this.AccountSortAttribute = &accountSortAttribute
	var accountSortDescending bool = false
	this.AccountSortDescending = &accountSortDescending
	var accountReturnFirstLink bool = false
	this.AccountReturnFirstLink = &accountReturnFirstLink
...
func (o *AccountAttribute) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAccountAttribute)
