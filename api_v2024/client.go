...
// APIClient manages communication with the Identity Security Cloud V2024 API API vv2024
...
type APIClient struct {
	...
	VendorConnectorMapppingAPI *VendorConnectorMapppingAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.VendorConnectorMapppingAPI = (*VendorConnectorMapppingAPIService)(&c.common)
...
localVarRequest.Header.Add("X-SailPoint-SDK", "2.1.14")
