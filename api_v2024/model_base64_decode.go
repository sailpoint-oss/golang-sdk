...
// checks if the Base64Decode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Base64Decode{}
...
func (o Base64Decode) ToMap() (map[string]interface{}, error) {
...
func (o *Base64Decode) UnmarshalJSON(data []byte) (err error) {
	varBase64Decode := _Base64Decode{}

	err = json.Unmarshal(data, &varBase64Decode)
