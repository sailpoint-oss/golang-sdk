...
> []AccessProfileUpdateItem UpdateAccessProfilesInBulk(ctx).XSailPointExperimental(xSailPointExperimental).AccessProfileBulkUpdateRequestInner(accessProfileBulkUpdateRequestInner).Execute()
