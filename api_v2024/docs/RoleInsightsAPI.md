...
> RoleInsightsResponse CreateRoleInsightRequests(ctx).XSailPointExperimental(xSailPointExperimental).Execute()
...
> string DownloadRoleInsightsEntitlementsChanges(ctx, insightId).XSailPointExperimental(xSailPointExperimental).Sorters(sorters).Filters(filters).Execute()
...
> []RoleInsightsIdentities GetEntitlementChangesIdentities(ctx, insightId, entitlementId).XSailPointExperimental(xSailPointExperimental).HasEntitlement(hasEntitlement).Offset(offset).Limit(limit).Count(count).Sorters(sorters).Filters(filters).Execute()
...
> RoleInsight GetRoleInsight(ctx, insightId).XSailPointExperimental(xSailPointExperimental).Execute()
...
> []RoleInsight GetRoleInsights(ctx).XSailPointExperimental(xSailPointExperimental).Offset(offset).Limit(limit).Count(count).Sorters(sorters).Filters(filters).Execute()
...
> []RoleInsightsEntitlement GetRoleInsightsCurrentEntitlements(ctx, insightId).XSailPointExperimental(xSailPointExperimental).Filters(filters).Execute()
...
> []RoleInsightsEntitlementChanges GetRoleInsightsEntitlementsChanges(ctx, insightId).XSailPointExperimental(xSailPointExperimental).Sorters(sorters).Filters(filters).Execute()
...
> RoleInsightsResponse GetRoleInsightsRequests(ctx, id).XSailPointExperimental(xSailPointExperimental).Execute()
...
> RoleInsightsSummary GetRoleInsightsSummary(ctx).XSailPointExperimental(xSailPointExperimental).Execute()
