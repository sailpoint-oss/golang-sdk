...
`func (o *AccountAllOfOwnerIdentity) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *AccountAllOfOwnerIdentity) GetTypeOk() (*string, bool)`
...
`func (o *AccountAllOfOwnerIdentity) SetType(v string)`
