...
// checks if the ReplaceAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplaceAll{}
...
func (o ReplaceAll) ToMap() (map[string]interface{}, error) {
...
func (o *ReplaceAll) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varReplaceAll)
