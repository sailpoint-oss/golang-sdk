...
func (r ApiGetServiceDeskIntegrationsRequest) Offset(offset int32) ApiGetServiceDeskIntegrationsRequest {
	r.offset = &offset
	return r
}

// Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
func (r ApiGetServiceDeskIntegrationsRequest) Limit(limit int32) ApiGetServiceDeskIntegrationsRequest {
	r.limit = &limit
	return r
}
...
func (r ApiGetServiceDeskIntegrationsRequest) Sorters(sorters string) ApiGetServiceDeskIntegrationsRequest {
	r.sorters = &sorters
	return r
}
...
func (r ApiGetServiceDeskIntegrationsRequest) Filters(filters string) ApiGetServiceDeskIntegrationsRequest {
	r.filters = &filters
	return r
}

// If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count&#x3D;true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
func (r ApiGetServiceDeskIntegrationsRequest) Count(count bool) ApiGetServiceDeskIntegrationsRequest {
	r.count = &count
	return r
}

func (r ApiGetServiceDeskIntegrationsRequest) Execute() ([]ServiceDeskIntegrationDto, *http.Response, error) {
	return r.ApiService.GetServiceDeskIntegrationsExecute(r)
}
...
*/
func (a *ServiceDeskIntegrationAPIService) GetServiceDeskIntegrations(ctx context.Context) ApiGetServiceDeskIntegrationsRequest {
	return ApiGetServiceDeskIntegrationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []ServiceDeskIntegrationDto
func (a *ServiceDeskIntegrationAPIService) GetServiceDeskIntegrationsExecute(r ApiGetServiceDeskIntegrationsRequest) ([]ServiceDeskIntegrationDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceDeskIntegrationAPIService.GetServiceDeskIntegrations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
