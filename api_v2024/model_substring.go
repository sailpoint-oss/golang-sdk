...
// checks if the Substring type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Substring{}
...
func (o Substring) ToMap() (map[string]interface{}, error) {
...
func (o *Substring) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSubstring)
