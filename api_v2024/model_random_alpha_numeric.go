...
// checks if the RandomAlphaNumeric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RandomAlphaNumeric{}
...
func (o RandomAlphaNumeric) ToMap() (map[string]interface{}, error) {
...
func (o *RandomAlphaNumeric) UnmarshalJSON(data []byte) (err error) {
	varRandomAlphaNumeric := _RandomAlphaNumeric{}

	err = json.Unmarshal(data, &varRandomAlphaNumeric)
