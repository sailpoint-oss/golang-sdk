...
// checks if the PutSourceTemplateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutSourceTemplateRequest{}
...
type _PutSourceTemplateRequest PutSourceTemplateRequest
...
func (o *PutSourceTemplateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPutSourceTemplateRequest := _PutSourceTemplateRequest{}

	err = json.Unmarshal(data, &varPutSourceTemplateRequest)

	if err != nil {
		return err
	}

	*o = PutSourceTemplateRequest(varPutSourceTemplateRequest)
...
type NullablePutSourceTemplateRequest struct {
	value *PutSourceTemplateRequest
	isSet bool
}

func (v NullablePutSourceTemplateRequest) Get() *PutSourceTemplateRequest {
	return v.value
}

func (v *NullablePutSourceTemplateRequest) Set(val *PutSourceTemplateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutSourceTemplateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutSourceTemplateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutSourceTemplateRequest(val *PutSourceTemplateRequest) *NullablePutSourceTemplateRequest {
	return &NullablePutSourceTemplateRequest{value: val, isSet: true}
}
