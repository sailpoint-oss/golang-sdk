...
// checks if the DateCompare type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DateCompare{}
...
func (o DateCompare) ToMap() (map[string]interface{}, error) {
...
func (o *DateCompare) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varDateCompare)
