...
// IdentityAttribute1AsTransformAttributes is a convenience function that returns IdentityAttribute1 wrapped in TransformAttributes
func IdentityAttribute1AsTransformAttributes(v *IdentityAttribute1) TransformAttributes {
	return TransformAttributes{
...
func (dst *TransformAttributes) UnmarshalJSON(data []byte) error {
	...
	if err == nil {
		...
		if string(jsonBase64Decode) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Base64Decode); err != nil {
				dst.Base64Decode = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonBase64Encode) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Base64Encode); err != nil {
				dst.Base64Encode = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonConcatenation) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Concatenation); err != nil {
				dst.Concatenation = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonConditional) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Conditional); err != nil {
				dst.Conditional = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonDateCompare) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.DateCompare); err != nil {
				dst.DateCompare = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonDateMath) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.DateMath); err != nil {
				dst.DateMath = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonDecomposeDiacriticalMarks) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.DecomposeDiacriticalMarks); err != nil {
				dst.DecomposeDiacriticalMarks = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonE164phone) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.E164phone); err != nil {
				dst.E164phone = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonFirstValid) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.FirstValid); err != nil {
				dst.FirstValid = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonISO3166) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.ISO3166); err != nil {
				dst.ISO3166 = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonIdentityAttribute1) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.IdentityAttribute1); err != nil {
				dst.IdentityAttribute1 = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonIndexOf) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.IndexOf); err != nil {
				dst.IndexOf = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonLeftPad) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.LeftPad); err != nil {
				dst.LeftPad = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonLookup) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Lookup); err != nil {
				dst.Lookup = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonLower) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Lower); err != nil {
				dst.Lower = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonNameNormalizer) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.NameNormalizer); err != nil {
				dst.NameNormalizer = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonRandomAlphaNumeric) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.RandomAlphaNumeric); err != nil {
				dst.RandomAlphaNumeric = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonRandomNumeric) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.RandomNumeric); err != nil {
				dst.RandomNumeric = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonReference) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Reference); err != nil {
				dst.Reference = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonReplace) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Replace); err != nil {
				dst.Replace = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonReplaceAll) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.ReplaceAll); err != nil {
				dst.ReplaceAll = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonRightPad) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.RightPad); err != nil {
				dst.RightPad = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonRule) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Rule); err != nil {
				dst.Rule = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonSplit) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Split); err != nil {
				dst.Split = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonStatic) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Static); err != nil {
				dst.Static = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonSubstring) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Substring); err != nil {
				dst.Substring = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonTrim) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Trim); err != nil {
				dst.Trim = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonUUIDGenerator) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.UUIDGenerator); err != nil {
				dst.UUIDGenerator = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonUpper) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.Upper); err != nil {
				dst.Upper = nil
			} else {
				match++
			}
