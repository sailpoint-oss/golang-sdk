...
slug: /tools/sdk/go/jitactivationsv1/methods/jit-activations
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_jit_activations_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_jit_activations_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.JitActivationsV1.JITActivationsAPI.StartActivateWorkflowV1(context.Background()).Jitactivationactivaterequest(jitactivationactivaterequest).Execute()
	  //resp, r, err := apiClient.JitActivationsV1.JITActivationsAPI.StartActivateWorkflowV1(context.Background()).Jitactivationactivaterequest(jitactivationactivaterequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.JitActivationsV1.JITActivationsAPI.StartDeactivateWorkflowV1(context.Background()).Jitactivationdeactivaterequest(jitactivationdeactivaterequest).Execute()
	  //resp, r, err := apiClient.JitActivationsV1.JITActivationsAPI.StartDeactivateWorkflowV1(context.Background()).Jitactivationdeactivaterequest(jitactivationdeactivaterequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.JitActivationsV1.JITActivationsAPI.StartExtendWorkflowV1(context.Background()).Jitactivationextendrequest(jitactivationextendrequest).Execute()
	  //resp, r, err := apiClient.JitActivationsV1.JITActivationsAPI.StartExtendWorkflowV1(context.Background()).Jitactivationextendrequest(jitactivationextendrequest).Execute()
    if err != nil {
