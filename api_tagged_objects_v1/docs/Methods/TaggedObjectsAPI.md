...
slug: /tools/sdk/go/taggedobjectsv1/methods/tagged-objects
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_tagged_objects_v1"
)
...
func main() {
    ...
    r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.DeleteTaggedObjectV1(context.Background(), type_, id).Execute()
	  //r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.DeleteTaggedObjectV1(context.Background(), type_, id).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_tagged_objects_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_tagged_objects_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.DeleteTagsToManyObjectV1(context.Background()).Bulkremovetaggedobject(bulkremovetaggedobject).Execute()
	  //r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.DeleteTagsToManyObjectV1(context.Background()).Bulkremovetaggedobject(bulkremovetaggedobject).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.GetTaggedObjectV1(context.Background(), type_, id).Execute()
	  //resp, r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.GetTaggedObjectV1(context.Background(), type_, id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.ListTaggedObjectsByTypeV1(context.Background(), type_).Execute()
	  //resp, r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.ListTaggedObjectsByTypeV1(context.Background(), type_).Limit(limit).Offset(offset).Count(count).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.ListTaggedObjectsV1(context.Background()).Execute()
	  //resp, r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.ListTaggedObjectsV1(context.Background()).Limit(limit).Offset(offset).Count(count).Filters(filters).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.PutTaggedObjectV1(context.Background(), type_, id).Taggedobject(taggedobject).Execute()
	  //resp, r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.PutTaggedObjectV1(context.Background(), type_, id).Taggedobject(taggedobject).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.SetTagToObjectV1(context.Background()).Taggedobject(taggedobject).Execute()
	  //r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.SetTagToObjectV1(context.Background()).Taggedobject(taggedobject).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.SetTagsToManyObjectsV1(context.Background()).Bulkaddtaggedobject(bulkaddtaggedobject).Execute()
	  //resp, r, err := apiClient.TaggedObjectsV1.TaggedObjectsAPI.SetTagsToManyObjectsV1(context.Background()).Bulkaddtaggedobject(bulkaddtaggedobject).Execute()
    if err != nil {
