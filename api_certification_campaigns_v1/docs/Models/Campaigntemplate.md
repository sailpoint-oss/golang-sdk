...
slug: /tools/sdk/go/certificationcampaignsv1/models/campaigntemplate
...
`func NewCampaigntemplate(name string, description string, created time.Time, modified NullableTime, campaign Campaign2, ) *Campaigntemplate`
