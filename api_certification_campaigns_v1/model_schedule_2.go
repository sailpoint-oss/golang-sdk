...
// Schedule2 struct for Schedule2
type Schedule2 struct {
	...
	Months NullableSchedule2Months `json:"months,omitempty"`
...
// SetMonths gets a reference to the given NullableSchedule2Months and assigns it to the Months field.
func (o *Schedule2) SetMonths(v Schedule2Months) {
	o.Months.Set(&v)
}
// SetMonthsNil sets the value for Months to be an explicit nil
func (o *Schedule2) SetMonthsNil() {
	o.Months.Set(nil)
}
