---
id: v1-sp-config-import-results
...
slug: /tools/sdk/go/spconfig/models/sp-config-import-results
...
------------ | ------------- | ------------- | -------------
**Results** | [**map[string]ObjectImportResult2**](object-import-result2) | The results of an object configuration import job. | 
