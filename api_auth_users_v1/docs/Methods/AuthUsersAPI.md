...
slug: /tools/sdk/go/authusersv1/methods/auth-users
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_auth_users_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.AuthUsersV1.AuthUsersAPI.GetAuthUserV1(context.Background(), id).Execute()
	  //resp, r, err := apiClient.AuthUsersV1.AuthUsersAPI.GetAuthUserV1(context.Background(), id).Execute()
    if err != nil {
...
import (
	...
	"os"
  "encoding/json"
    v1 "github.com/sailpoint-oss/golang-sdk/v2/api_auth_users_v1"
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_auth_users_v1"
)
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.AuthUsersV1.AuthUsersAPI.PatchAuthUserV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
	  //resp, r, err := apiClient.AuthUsersV1.AuthUsersAPI.PatchAuthUserV1(context.Background(), id).Jsonpatchoperation(jsonpatchoperation).Execute()
    if err != nil {
