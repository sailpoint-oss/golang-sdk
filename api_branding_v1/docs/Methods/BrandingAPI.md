...
keywords: ['go', 'Golang', 'sdk', 'Branding', 'V1Branding'] 
slug: /tools/sdk/go/brandingv1/methods/branding
...
Other parameters are passed through a pointer to a apiCreateBrandingItemV1Request struct via the builder pattern
...
import (
	...
	sailpoint "github.com/sailpoint-oss/golang-sdk/v2/api_branding_v1"
)
...
func main() {
    ...
    resp, r, err := apiClient.BrandingV1.BrandingAPI.CreateBrandingItemV1(context.Background()).Name(name).ProductName(productName).Execute()
	  //resp, r, err := apiClient.BrandingV1.BrandingAPI.CreateBrandingItemV1(context.Background()).Name(name).ProductName(productName).ActionButtonColor(actionButtonColor).ActiveLinkColor(activeLinkColor).NavigationColor(navigationColor).EmailFromAddress(emailFromAddress).LoginInformationalMessage(loginInformationalMessage).FileStandard(fileStandard).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiDeleteBrandingV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.BrandingV1.BrandingAPI.DeleteBrandingV1(context.Background(), name).Execute()
	  //r, err := apiClient.BrandingV1.BrandingAPI.DeleteBrandingV1(context.Background(), name).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiGetBrandingListV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.BrandingV1.BrandingAPI.GetBrandingListV1(context.Background()).Execute()
	  //resp, r, err := apiClient.BrandingV1.BrandingAPI.GetBrandingListV1(context.Background()).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiGetBrandingV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.BrandingV1.BrandingAPI.GetBrandingV1(context.Background(), name).Execute()
	  //resp, r, err := apiClient.BrandingV1.BrandingAPI.GetBrandingV1(context.Background(), name).Execute()
    if err != nil {
...
Other parameters are passed through a pointer to a apiSetBrandingItemV1Request struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.BrandingV1.BrandingAPI.SetBrandingItemV1(context.Background(), name).Name2(name2).ProductName(productName).Execute()
	  //resp, r, err := apiClient.BrandingV1.BrandingAPI.SetBrandingItemV1(context.Background(), name).Name2(name2).ProductName(productName).ActionButtonColor(actionButtonColor).ActiveLinkColor(activeLinkColor).NavigationColor(navigationColor).EmailFromAddress(emailFromAddress).LoginInformationalMessage(loginInformationalMessage).FileStandard(fileStandard).Execute()
    if err != nil {
